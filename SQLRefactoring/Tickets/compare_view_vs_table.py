"""
Create procedures using _C tables (faster) instead of views
...
# Create _C based procedure for LH_LOADING_CYCLE
...
print("=" * 70)
print(f"{'Source':<30} | {'Time (s)':>10} | {'Rows':>12} | {'Speedup':>10}")
print("-" * 70)
print(f"{'VIEW (PROD_WG.LOAD_HAUL)':<30} | {view_time:>10.2f} | {view_count:>12,} | {'1.0x':>10}")
print(f"{'TABLE (_C)':<30} | {table_time:>10.2f} | {table_count:>12,} | {view_time/table_time:>10.1f}x")
