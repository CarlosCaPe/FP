-- =============================================================================
-- BL_DW_BLAST_INCR - Incremental Table and Procedure
...
-- Business Key: ORIG_SRC_ID, SITE_CODE, ID (composite)
-- Timestamp for incremental: DW_MODIFY_TS
-- =============================================================================
...
-- TESTING
-- ============================================================================
-- CALL DEV_API_REF.FUSE.BL_DW_BLAST_INCR_P('30');  -- Initial load
-- CALL DEV_API_REF.FUSE.BL_DW_BLAST_INCR_P('3');   -- Regular refresh
-- SELECT COUNT(*) FROM DEV_API_REF.FUSE.BL_DW_BLAST_INCR;
