...
* INCREMENTAL COLUMN: PLAN_DATE (same as Snowflake dynamic table logic)
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Using PLAN_DATE to match Snowflake dynamic table logic
        DELETE FROM [dbo].[DRILL_BLAST__DRILL_PLAN_INCR]
        WHERE CAST([PLAN_DATE] AS DATE) < @CutoffDate;
