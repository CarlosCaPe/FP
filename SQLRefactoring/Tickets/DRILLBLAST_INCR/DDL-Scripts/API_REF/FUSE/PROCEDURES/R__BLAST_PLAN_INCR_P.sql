...
-- =============================================
CREATE OR REPLACE PROCEDURE {{ envi }}_API_REF.FUSE.BLAST_PLAN_INCR_P("NUMBER_OF_DAYS" VARCHAR(16777216) DEFAULT '3', "MAX_DAYS_TO_KEEP" VARCHAR(16777216) DEFAULT '90')
...
var sql_count_incr = `SELECT COUNT(*) AS cnt FROM {{ envi }}_API_REF.fuse.blast_plan_incr 
