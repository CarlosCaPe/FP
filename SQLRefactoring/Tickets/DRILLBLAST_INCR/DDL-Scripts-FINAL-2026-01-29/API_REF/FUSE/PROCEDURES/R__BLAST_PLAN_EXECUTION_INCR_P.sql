...
USING (
    SELECT 
        ORIG_SRC_ID, SITE_CODE, 
        COALESCE(BENCH, -999999) AS BENCH,
        COALESCE(PUSHBACK, ''N/A'') AS PUSHBACK,
        COALESCE(PATTERN_NAME, ''N/A'') AS PATTERN_NAME,
        BLAST_NAME, DRILLED_HOLE_ID,
