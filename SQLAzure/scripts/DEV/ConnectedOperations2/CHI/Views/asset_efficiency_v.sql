CREATE VIEW [CHI].[asset_efficiency_v] AS


--select * from [chi].[asset_efficiency_v]
CREATE VIEW [chi].[asset_efficiency_v]   
AS
...
EqmtHist AS (
	...
	AND [HOS].EQMT NOT IN ('897','898')
	OR [HOS].EQMT = 'CRUSHER-AUX' --Add Crusher
