CREATE VIEW [CHI].[CONOPS_CHI_SP_DELTA_C_V] AS
  
  
--- SELECT * FROM [chi].[CONOPS_CHI_SP_DELTA_C_V]  
  
CREATE VIEW [chi].[CONOPS_CHI_SP_DELTA_C_V]  
AS  
...
EmptyTravel,  
LoadedTravel  
FROM [CHI].[CONOPS_CHI_SP_DELTA_C_AVG_V]  
),  
...
stat.eqmtcurrstatus  
FROM DELTAC dc  
LEFT JOIN [CHI].[CONOPS_CHI_SHOVEL_POPUP] [pop] WITH (NOLOCK)
