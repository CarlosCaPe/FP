CREATE VIEW [CHI].[CONOPS_CHI_EQMT_HOURLY_PAYLOAD_V] AS
...
--SELECT * FROM [chi].[CONOPS_CHI_EQMT_HOURLY_PAYLOAD_V] WHERE shiftflag = 'prev' and equipment = '35'

CREATE VIEW [chi].[CONOPS_CHI_EQMT_HOURLY_PAYLOAD_V]
AS
