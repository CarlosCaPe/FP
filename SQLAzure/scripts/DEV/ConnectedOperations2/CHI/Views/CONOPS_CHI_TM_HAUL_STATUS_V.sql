CREATE VIEW [CHI].[CONOPS_CHI_TM_HAUL_STATUS_V] AS


-- SELECT * FROM [chi].[CONOPS_CHI_TM_HAUL_STATUS_V] WITH (NOLOCK)
CREATE VIEW [chi].[CONOPS_CHI_TM_HAUL_STATUS_V] 
AS
	...
	LEFT JOIN [chi].[CONOPS_CHI_DELTA_C_DETAIL_V] [dt]
