CREATE VIEW [CHI].[CONOPS_CHI_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS
  
     
--select * from [chi].[CONOPS_CHI_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq        
CREATE VIEW [chi].[CONOPS_CHI_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]        
AS        
...
ON a.shiftid = b.shiftid AND b.siteflag = 'CHN'        
--WHERE ShovelId = 'T220'        
