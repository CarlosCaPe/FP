CREATE VIEW [CHI].[CONOPS_CHI_DB_DRILL_SCORE_CARD_PER_HOUR_V] AS




--select * from [chi].[CONOPS_CHI_DB_DRILL_SCORE_CARD_PER_HOUR_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [chi].[CONOPS_CHI_DB_DRILL_SCORE_CARD_PER_HOUR_V]
AS
