CREATE VIEW [CHI].[CONOPS_CHI_SHOVEL_TO_WATCH_V] AS
  
  
 
  
--select * from [chi].[CONOPS_CHI_SHOVEL_TO_WATCH_V] where shiftflag = 'curr'  
CREATE VIEW [chi].[CONOPS_CHI_SHOVEL_TO_WATCH_V]  
AS  
