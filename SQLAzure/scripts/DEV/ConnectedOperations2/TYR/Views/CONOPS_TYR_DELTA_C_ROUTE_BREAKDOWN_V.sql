CREATE VIEW [TYR].[CONOPS_TYR_DELTA_C_ROUTE_BREAKDOWN_V] AS




--select * from [TYR].[CONOPS_TYR_DELTA_C_ROUTE_BREAKDOWN_V]
CREATE VIEW [TYR].[CONOPS_TYR_DELTA_C_ROUTE_BREAKDOWN_V]
AS
...
LEFT JOIN TYR.CONOPS_TYR_TRUCK_DETAIL_V t
