CREATE VIEW [TYR].[CONOPS_TYR_TRUCK_SHIFT_CHANGE_DIALOG_V] AS




-- SELECT * FROM [tyr].[CONOPS_TYR_TRUCK_SHIFT_CHANGE_DIALOG_V]
CREATE VIEW [TYR].[CONOPS_TYR_TRUCK_SHIFT_CHANGE_DIALOG_V] 
AS
...
FROM (
	...
	LEFT JOIN [tyr].[CONOPS_TYR_TRUCK_DETAIL_V] [TruckDetail] WITH (NOLOCK)
