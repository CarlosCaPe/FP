CREATE VIEW [TYR].[CONOPS_TYR_SP_AVG_LOAD_TIME_V] AS
...
--SELECT * FROM [tyr].[CONOPS_TYR_SP_AVG_LOAD_TIME_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [TYR].[CONOPS_TYR_SP_AVG_LOAD_TIME_V]
AS
...
stat.eqmtcurrstatus
FROM NL nl
LEFT JOIN [tyr].[CONOPS_TYR_SHOVEL_POPUP] [pop] 
