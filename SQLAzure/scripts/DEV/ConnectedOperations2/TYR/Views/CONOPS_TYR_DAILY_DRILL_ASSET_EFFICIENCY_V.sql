CREATE VIEW [TYR].[CONOPS_TYR_DAILY_DRILL_ASSET_EFFICIENCY_V] AS
...
--select * from [TYR].[CONOPS_TYR_DAILY_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_DRILL_ASSET_EFFICIENCY_V]
AS
...
(
	...
	from [TYR].[DRILL_ASSET_EFFICIENCY_V] [ae] (NOLOCK)
	RIGHT JOIN [TYR].[CONOPS_TYR_EOS_SHIFT_INFO_V] [shift] WITH (NOLOCK)
