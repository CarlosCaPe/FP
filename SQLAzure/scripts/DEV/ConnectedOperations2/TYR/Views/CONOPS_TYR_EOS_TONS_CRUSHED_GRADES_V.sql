CREATE VIEW [TYR].[CONOPS_TYR_EOS_TONS_CRUSHED_GRADES_V] AS




--SELECT * FROM [tyr].[CONOPS_TYR_EOS_TONS_CRUSHED_GRADES_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [TYR].[CONOPS_TYR_EOS_TONS_CRUSHED_GRADES_V]  
AS  
	...
	WITH CrLocShift AS (
   		SELECT a.SHIFTINDEX,
			   ...
			   NULL CrusherLoc
   		FROM --CrLoc, 
		[tyr].[CONOPS_TYR_SHIFT_INFO_V] a WITH (NOLOCK)
	),
