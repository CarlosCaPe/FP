CREATE VIEW [TYR].[CONOPS_TYR_DB_EQMT_STATUS_GANTTCHART_V] AS



  
  
--select * from [tyr].[CONOPS_TYR_DB_EQMT_STATUS_GANTTCHART_V] where shiftflag = 'prev'  
CREATE VIEW [TYR].[CONOPS_TYR_DB_EQMT_STATUS_GANTTCHART_V]  
AS  
