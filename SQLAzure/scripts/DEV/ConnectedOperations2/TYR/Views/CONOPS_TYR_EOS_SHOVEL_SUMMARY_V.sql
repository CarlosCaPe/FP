CREATE VIEW [TYR].[CONOPS_TYR_EOS_SHOVEL_SUMMARY_V] AS
...
--SELECT * FROM [TYR].[CONOPS_TYR_EOS_SHOVEL_SUMMARY_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [TYR].[CONOPS_TYR_EOS_SHOVEL_SUMMARY_V]  
AS
...
FROM ShovelLoad sl
RIGHT JOIN [TYR].[CONOPS_TYR_SHIFT_INFO_V] s
...
LEFT JOIN TYR.CONOPS_TYR_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V c
