CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS




--select * from [tyr].[CONOPS_TYR_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq    
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]    
AS    
