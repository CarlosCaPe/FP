CREATE VIEW [TYR].[CONOPS_TYR_EOS_EQUIPMENT_READINESS_V] AS



  
--select * from [tyr].[CONOPS_TYR_EOS_EQUIPMENT_READINESS_V] where shiftflag = 'prev'  
CREATE VIEW [TYR].[CONOPS_TYR_EOS_EQUIPMENT_READINESS_V]  
AS  
 /*
WITH EqReadinessTarget AS(  
 ...
 FROM [tyr].PLAN_VALUES_PROD_SUM WITH (NOLOCK)  
