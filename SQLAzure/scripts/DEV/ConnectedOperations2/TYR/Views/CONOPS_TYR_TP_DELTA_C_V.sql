CREATE VIEW [TYR].[CONOPS_TYR_TP_DELTA_C_V] AS





--select  shiftflag,siteflag,truck,deltac from [tyr].[CONOPS_TYR_TP_DELTA_C_V] where shiftflag = 'prev' and truck = 'T622'

CREATE VIEW [TYR].[CONOPS_TYR_TP_DELTA_C_V] 
AS
...
LoadedTravel,
EmptyTravel
FROM [tyr].[CONOPS_TYR_TP_DELTA_C_AVG_V] ),
...
LEFT JOIN [tyr].[CONOPS_TYR_TRUCK_POPUP_V] pop ON [shift].shiftflag = pop.shiftflag AND dc.truck = pop.TruckID
