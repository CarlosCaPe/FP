...
/******************************************************************              
* PROCEDURE : DBO.[UPSERT_CONOPS_PIT_TRUCK_C]            
* PURPOSE : UPSERT [UPSERT_CONOPS_PIT_TRUCK_C]            
* NOTES     :             
* CREATED : MFAHMI            
* SAMPLE    : EXEC DBO.[UPSERT_CONOPS_PIT_TRUCK_C]             
...
*******************************************************************/              
CREATE  PROCEDURE [dbo].[UPSERT_CONOPS_PIT_TRUCK_C]            
(            
@G_SITE  VARCHAR(5)            
