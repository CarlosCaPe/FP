CREATE VIEW [CLI].[CONOPS_CLI_DAILY_TP_TRUCK_ASSET_EFFICIENCY_V] AS
  
  
  
--select * from [dbo].[CONOPS_LH_SP_DELAY_V] where shiftflag = 'prev'  
CREATE VIEW [cli].[CONOPS_CLI_DAILY_TP_TRUCK_ASSET_EFFICIENCY_V]   
AS  
...
LEFT JOIN [cli].CONOPS_CLI_DAILY_TRUCK_POPUP_V b  
