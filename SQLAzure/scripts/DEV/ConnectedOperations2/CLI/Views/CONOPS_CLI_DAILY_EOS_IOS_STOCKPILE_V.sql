CREATE VIEW [CLI].[CONOPS_CLI_DAILY_EOS_IOS_STOCKPILE_V] AS
  
    
  
--SELECT * FROM [cli].[CONOPS_CLI_DAILY_EOS_IOS_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [cli].[CONOPS_CLI_DAILY_EOS_IOS_STOCKPILE_V]      
AS      
