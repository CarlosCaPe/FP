CREATE VIEW [CLI].[CONOPS_CLI_EOS_TRUCK_READY_V] AS
  
  
  
--SELECT * FROM [cli].[CONOPS_CLI_EOS_TRUCK_READY_V] WHERE shiftflag = 'curr' order by datetime  
CREATE VIEW [cli].[CONOPS_CLI_EOS_TRUCK_READY_V]  
AS  
