CREATE VIEW [CLI].[CONOPS_CLI_EOS_DRILLINPROD_V] AS


--select * from [dbo].[CONOPS_CLI_EOS_DRILLINPROD_V] where shiftflag = 'prev'
CREATE VIEW [cli].[CONOPS_CLI_EOS_DRILLINPROD_V]
AS
...
FROM [cli].[CONOPS_CLI_HOURLY_DRILL_ASSET_EFFICIENCY_V] a
