CREATE VIEW [CLI].[CONOPS_CLI_TM_TRAFFIC_LOADER_V] AS
...
--SELECT * FROM [cli].[CONOPS_CLI_TM_TRAFFIC_LOADER_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [cli].[CONOPS_CLI_TM_TRAFFIC_LOADER_V]      
AS      
