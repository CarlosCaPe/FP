CREATE VIEW [CLI].[CONOPS_CLI_DAILY_DRILL_ASSET_EFFICIENCY_V] AS
...
--select * from [cli].[CONOPS_CLI_DAILY_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [cli].[CONOPS_CLI_DAILY_DRILL_ASSET_EFFICIENCY_V] 
AS
...
(
	...
	from [CLI].[DRILL_ASSET_EFFICIENCY_V] [ae] (NOLOCK)
	RIGHT JOIN [CLI].[CONOPS_CLI_EOS_SHIFT_INFO_V] [shift] WITH (NOLOCK)
