CREATE VIEW [CLI].[CONOPS_CLI_TRUCK_TO_WATCH_V] AS




-- SELECT * FROM [cli].[CONOPS_CLI_TRUCK_TO_WATCH_V] WITH (NOLOCK) WHERE [TruckID] = 'T501'
CREATE VIEW [cli].[CONOPS_CLI_TRUCK_TO_WATCH_V]
AS
...
LEFT JOIN [cli].[CONOPS_CLI_TRUCK_SHIFT_OVERVIEW_V] [tm]
