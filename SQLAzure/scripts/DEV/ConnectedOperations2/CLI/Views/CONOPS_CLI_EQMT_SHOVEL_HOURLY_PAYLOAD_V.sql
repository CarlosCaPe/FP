CREATE VIEW [CLI].[CONOPS_CLI_EQMT_SHOVEL_HOURLY_PAYLOAD_V] AS
...
--SELECT * FROM [cli].[CONOPS_CLI_EQMT_SHOVEL_HOURLY_PAYLOAD_V] WHERE shiftflag = 'curr'  
  
CREATE VIEW [cli].[CONOPS_CLI_EQMT_SHOVEL_HOURLY_PAYLOAD_V]  
AS  
...
LEFT JOIN [cli].[SHIFT_INFO] b WITH (NOLOCK) ON a.shiftid = b.shiftid   
