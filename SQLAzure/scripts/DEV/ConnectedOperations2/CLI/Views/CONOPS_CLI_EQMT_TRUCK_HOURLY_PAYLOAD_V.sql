CREATE VIEW [CLI].[CONOPS_CLI_EQMT_TRUCK_HOURLY_PAYLOAD_V] AS
...
--SELECT * FROM [cli].[CONOPS_CLI_EQMT_TRUCK_HOURLY_PAYLOAD_V] WHERE shiftflag = 'curr'  
  
CREATE VIEW [cli].[CONOPS_CLI_EQMT_TRUCK_HOURLY_PAYLOAD_V]  
AS  
