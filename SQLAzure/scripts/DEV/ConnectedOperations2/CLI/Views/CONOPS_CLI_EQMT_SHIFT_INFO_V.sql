CREATE VIEW [CLI].[CONOPS_CLI_EQMT_SHIFT_INFO_V] AS





--select * from [cli].[CONOPS_CLI_EQMT_SHIFT_INFO_V] order by shiftflag

CREATE VIEW [cli].[CONOPS_CLI_EQMT_SHIFT_INFO_V] 
AS
