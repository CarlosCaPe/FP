CREATE VIEW [BAG].[CONOPS_BAG_EQMT_SHOVEL_HOURLY_DELTAC_V] AS



--select * from [bag].[CONOPS_BAG_EQMT_SHOVEL_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = 's08'
CREATE VIEW [bag].[CONOPS_BAG_EQMT_SHOVEL_HOURLY_DELTAC_V]
AS
