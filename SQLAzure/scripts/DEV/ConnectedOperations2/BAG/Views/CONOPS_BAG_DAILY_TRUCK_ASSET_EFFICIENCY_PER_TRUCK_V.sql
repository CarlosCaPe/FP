CREATE VIEW [BAG].[CONOPS_BAG_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] AS
  
  
--select * from [bag].[CONOPS_BAG_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] WITH (NOLOCK)  
CREATE VIEW [bag].[CONOPS_BAG_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]  
AS  
