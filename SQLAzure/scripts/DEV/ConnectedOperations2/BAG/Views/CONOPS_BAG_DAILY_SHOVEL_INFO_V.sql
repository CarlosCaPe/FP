CREATE VIEW [BAG].[CONOPS_BAG_DAILY_SHOVEL_INFO_V] AS


-- SELECT * FROM [bag].[CONOPS_bag_DAILY_SHOVEL_INFO_V] WITH (NOLOCK)
CREATE VIEW [bag].[CONOPS_BAG_DAILY_SHOVEL_INFO_V] 
AS
...
WHERE p.EquipmentCategory IN ('Shovel Classes', 'Loader Classes')
