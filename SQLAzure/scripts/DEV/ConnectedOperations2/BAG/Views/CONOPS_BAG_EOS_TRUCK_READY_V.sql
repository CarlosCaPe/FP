CREATE VIEW [BAG].[CONOPS_BAG_EOS_TRUCK_READY_V] AS


  
  
  
--SELECT * FROM [bag].[CONOPS_BAG_EOS_TRUCK_READY_V] WHERE shiftflag = 'curr' order by datetime  
CREATE VIEW [bag].[CONOPS_BAG_EOS_TRUCK_READY_V]  
AS  
