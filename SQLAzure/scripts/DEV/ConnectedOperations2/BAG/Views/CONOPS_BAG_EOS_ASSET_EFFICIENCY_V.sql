CREATE VIEW [BAG].[CONOPS_BAG_EOS_ASSET_EFFICIENCY_V] AS



--SELECT * FROM [BAG].[CONOPS_BAG_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [BAG].[CONOPS_BAG_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [BAG].[CONOPS_BAG_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [BAG].[CONOPS_BAG_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [BAG].[CONOPS_BAG_DRILL_ASSET_EFFICIENCY_V]
)
