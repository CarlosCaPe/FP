CREATE VIEW [BAG].[CONOPS_BAG_DAILY_EOS_DRILLED_HOLES_V] AS
  
  
  
--SELECT * FROM [BAG].[CONOPS_BAG_DAILY_EOS_DRILLED_HOLES_V] WHERE SHIFTFLAG = 'PREV'  
CREATE VIEW [BAG].[CONOPS_BAG_DAILY_EOS_DRILLED_HOLES_V]  
AS  
...
(  
 ...
 FROM [bag].[CONOPS_BAG_DAILY_DB_DRILL_PLAN_V] (NOLOCK)  
