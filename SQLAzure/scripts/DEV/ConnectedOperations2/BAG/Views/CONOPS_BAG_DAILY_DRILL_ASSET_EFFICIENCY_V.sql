CREATE VIEW [BAG].[CONOPS_BAG_DAILY_DRILL_ASSET_EFFICIENCY_V] AS
...
--select * from [bag].[CONOPS_BAG_DAILY_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [bag].[CONOPS_BAG_DAILY_DRILL_ASSET_EFFICIENCY_V] 
AS
...
(
	...
	from [BAG].[DRILL_ASSET_EFFICIENCY_V] [ae] (NOLOCK)
	RIGHT JOIN [BAG].[CONOPS_BAG_EOS_SHIFT_INFO_V] [shift] WITH (NOLOCK)
