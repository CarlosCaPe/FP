CREATE VIEW [BAG].[CONOPS_BAG_EQMT_HOURLY_PAYLOAD_V] AS


--SELECT * FROM [bag].[CONOPS_BAG_EQMT_HOURLY_PAYLOAD_V] WHERE shiftflag = 'prev'
CREATE VIEW [bag].[CONOPS_BAG_EQMT_HOURLY_PAYLOAD_V]
AS
