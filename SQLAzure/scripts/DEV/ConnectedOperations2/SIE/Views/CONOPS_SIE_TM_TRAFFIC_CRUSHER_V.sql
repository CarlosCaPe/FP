CREATE VIEW [SIE].[CONOPS_SIE_TM_TRAFFIC_CRUSHER_V] AS
...
--SELECT * FROM [sie].[CONOPS_SIE_TM_TRAFFIC_CRUSHER_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [sie].[CONOPS_SIE_TM_TRAFFIC_CRUSHER_V]      
AS      
 ...
 WITH CRUSHER AS (    
  ...
  WHERE loc.FieldId IN ('CR13909O', 'A-SIDE', 'B-SIDE')    
 )    
