CREATE VIEW [SIE].[CONOPS_SIE_EQMT_PAYLOAD_CATEGORY_V] AS
  
 
-- SELECT * FROM [sie].[CONOPS_SIE_EQMT_PAYLOAD_CATEGORY_V] WHERE shiftindex = '38820'  
CREATE VIEW [sie].[CONOPS_SIE_EQMT_PAYLOAD_CATEGORY_V]  
AS  
