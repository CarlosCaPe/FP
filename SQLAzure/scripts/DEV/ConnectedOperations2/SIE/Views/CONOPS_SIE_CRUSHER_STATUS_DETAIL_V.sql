CREATE VIEW [SIE].[CONOPS_SIE_CRUSHER_STATUS_DETAIL_V] AS




--SELECT * FROM [SIE].[CONOPS_SIE_CRUSHER_STATUS_DETAIL_V]
CREATE VIEW [SIE].[CONOPS_SIE_CRUSHER_STATUS_DETAIL_V]
AS
...
SELECT
	...
	CASE PLANT_AREA_NAME
		WHEN 'Pri Cr A Side' THEN 'A-SIDE'
		WHEN 'Pri Cr B Side' THEN 'B-SIDE'
