CREATE VIEW [SIE].[CONOPS_SIE_DAILY_DB_DRILL_SCORE_V] AS
  
  
  
  
--select * from [sie].[CONOPS_SIE_DAILY_DB_DRILL_SCORE_V] WITH (NOLOCK) where shiftflag = 'prev'  
CREATE VIEW [sie].[CONOPS_SIE_DAILY_DB_DRILL_SCORE_V]  
AS  
