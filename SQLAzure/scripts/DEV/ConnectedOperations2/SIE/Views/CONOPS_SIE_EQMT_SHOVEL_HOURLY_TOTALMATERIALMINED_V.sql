CREATE VIEW [SIE].[CONOPS_SIE_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS
  
    
     
--select * from [sie].[CONOPS_SIE_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq        
CREATE VIEW [sie].[CONOPS_SIE_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]        
AS        
