CREATE VIEW [SIE].[CONOPS_SIE_DAILY_EOS_LINEUP_TRUCK_V] AS




-- SELECT * FROM [sie].[CONOPS_SIE_DAILY_EOS_LINEUP_TRUCK_V]  WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [sie].[CONOPS_SIE_DAILY_EOS_LINEUP_TRUCK_V] 
AS
