CREATE VIEW [CER].[CONOPS_CER_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V] AS
...
--select * from [cer].[CONOPS_CER_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]  
CREATE VIEW [cer].[CONOPS_CER_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]  
AS  
