CREATE VIEW [CER].[CONOPS_CER_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] AS
  
  
  
--select * from [cer].[CONOPS_CER_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]  
CREATE VIEW [cer].[CONOPS_CER_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]  
AS  
