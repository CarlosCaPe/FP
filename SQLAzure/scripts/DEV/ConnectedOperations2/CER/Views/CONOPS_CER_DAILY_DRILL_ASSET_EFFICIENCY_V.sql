CREATE VIEW [CER].[CONOPS_CER_DAILY_DRILL_ASSET_EFFICIENCY_V] AS
...
--select * from [cer].[CONOPS_CER_DAILY_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [cer].[CONOPS_CER_DAILY_DRILL_ASSET_EFFICIENCY_V]
AS
...
(
	...
	from [CER].[DRILL_ASSET_EFFICIENCY_V] [ae] (NOLOCK)
	RIGHT JOIN [CER].[CONOPS_CER_EOS_SHIFT_INFO_V] [shift] WITH (NOLOCK)
