CREATE VIEW [CER].[CONOPS_CER_EQMT_TIME_CATEGORY_V] AS


--select * from [CER].[CONOPS_CER_EQMT_TIME_CATEGORY_V] WITH(NOLOCK)
CREATE VIEW [CER].[CONOPS_CER_EQMT_TIME_CATEGORY_V] 
AS
