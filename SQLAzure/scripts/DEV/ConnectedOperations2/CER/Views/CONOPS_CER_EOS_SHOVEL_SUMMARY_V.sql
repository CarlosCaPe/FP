CREATE VIEW [CER].[CONOPS_CER_EOS_SHOVEL_SUMMARY_V] AS
...
--SELECT * FROM [CER].[CONOPS_CER_EOS_SHOVEL_SUMMARY_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [CER].[CONOPS_CER_EOS_SHOVEL_SUMMARY_V]  
AS
...
FROM ShovelLoad sl
RIGHT JOIN [CER].[CONOPS_CER_SHIFT_INFO_V] s
