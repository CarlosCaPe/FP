CREATE VIEW [CER].[CONOPS_CER_OPERATOR_EQMT_READY_HOURS_V] AS



--select * from [CER].[CONOPS_CER_OPERATOR_EQMT_READY_HOURS_V]
CREATE VIEW [CER].[CONOPS_CER_OPERATOR_EQMT_READY_HOURS_V]
AS
