CREATE VIEW [CER].[CONOPS_CER_EOS_CRUSHER_STATS_V] AS


--SELECT * FROM [cer].[CONOPS_CER_EOS_CRUSHER_STATS_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [cer].[CONOPS_CER_EOS_CRUSHER_STATS_V]
AS
