CREATE VIEW [SAF].[CONOPS_SAF_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V] AS
...
--select * from [saf].[CONOPS_SAF_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]  
CREATE VIEW [saf].[CONOPS_SAF_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]   
AS  
