CREATE VIEW [SAF].[CONOPS_SAF_DRILL_DETAIL_PER_HOUR_V] AS
  
    
    
    
-- SELECT * FROM [saf].[CONOPS_SAF_DRILL_DETAIL_PER_HOUR_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' ORDER BY [DRILL_ID]    
CREATE VIEW [saf].[CONOPS_SAF_DRILL_DETAIL_PER_HOUR_V]    
AS    
