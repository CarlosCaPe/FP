CREATE VIEW [SAF].[CONOPS_SAF_TM_TRAFFIC_SHOVEL_V] AS
  
   
--SELECT * FROM [saf].[CONOPS_SAF_TM_TRAFFIC_SHOVEL_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'        
CREATE VIEW [saf].[CONOPS_SAF_TM_TRAFFIC_SHOVEL_V]        
AS        
