CREATE VIEW [SAF].[CONOPS_SAF_EFH_V] AS


--SELECT * FROM [SAF].[CONOPS_SAF_EFH_V] where shiftflag = 'curr'
CREATE VIEW [SAF].[CONOPS_SAF_EFH_V]
AS
...
RIGHT JOIN [SAF].[CONOPS_SAF_SHIFT_INFO_V] b
