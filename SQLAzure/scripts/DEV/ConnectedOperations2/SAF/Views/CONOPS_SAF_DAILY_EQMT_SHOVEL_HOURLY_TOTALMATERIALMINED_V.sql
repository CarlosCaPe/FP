CREATE VIEW [SAF].[CONOPS_SAF_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS
...
--select * from [saf].[CONOPS_SAF_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq    
CREATE VIEW [saf].[CONOPS_SAF_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]    
AS    
