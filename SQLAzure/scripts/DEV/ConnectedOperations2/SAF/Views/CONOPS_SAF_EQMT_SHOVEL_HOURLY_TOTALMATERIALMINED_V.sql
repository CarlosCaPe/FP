CREATE VIEW [SAF].[CONOPS_SAF_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS
  
    
       
--select * from [saf].[CONOPS_SAF_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq        
CREATE VIEW [saf].[CONOPS_SAF_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]        
AS        
...
ON a.shiftid = b.shiftid AND b.siteflag = 'SAM'        
--WHERE ShovelId = 'T220'        
