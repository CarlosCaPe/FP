CREATE VIEW [SAF].[CONOPS_SAF_EOS_SHOVEL_SUMMARY_V] AS
...
--SELECT * FROM [SAF].[CONOPS_SAF_EOS_SHOVEL_SUMMARY_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [SAF].[CONOPS_SAF_EOS_SHOVEL_SUMMARY_V]  
AS
...
FROM ShovelLoad sl
RIGHT JOIN [SAF].[CONOPS_SAF_SHIFT_INFO_V] s
...
LEFT JOIN SAF.CONOPS_SAF_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V c
