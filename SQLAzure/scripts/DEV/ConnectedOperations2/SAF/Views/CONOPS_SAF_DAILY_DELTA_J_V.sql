CREATE VIEW [SAF].[CONOPS_SAF_DAILY_DELTA_J_V] AS
...
--select * from [saf].[CONOPS_SAF_DAILY_DELTA_J_V]       
CREATE VIEW [saf].[CONOPS_SAF_DAILY_DELTA_J_V]       
AS      
...
TimeInHour,      
Shiftseq      
FROM [saf].[CONOPS_SAF_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]      
...
shiftid,      
shiftTarget      
from [saf].[CONOPS_SAF_SHIFT_TARGET_V]),      
...
FROM [saf].[CONOPS_SAF_DAILY_EFH_V])      
