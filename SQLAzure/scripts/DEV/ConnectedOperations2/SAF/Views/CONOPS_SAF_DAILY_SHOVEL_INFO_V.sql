CREATE VIEW [SAF].[CONOPS_SAF_DAILY_SHOVEL_INFO_V] AS
  
  
  
  
-- SELECT * FROM [saf].[CONOPS_SAF_DAILY_SHOVEL_INFO_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'  
CREATE VIEW [saf].[CONOPS_SAF_DAILY_SHOVEL_INFO_V]   
AS  
