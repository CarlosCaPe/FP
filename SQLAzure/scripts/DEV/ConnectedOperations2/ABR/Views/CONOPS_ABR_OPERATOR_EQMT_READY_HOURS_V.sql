CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_EQMT_READY_HOURS_V] AS



--select * from [ABR].[CONOPS_ABR_OPERATOR_EQMT_READY_HOURS_V]
CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_EQMT_READY_HOURS_V]
AS
