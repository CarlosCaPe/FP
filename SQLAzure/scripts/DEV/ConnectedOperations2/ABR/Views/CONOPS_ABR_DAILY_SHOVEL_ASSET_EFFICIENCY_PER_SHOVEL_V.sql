CREATE VIEW [ABR].[CONOPS_ABR_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V] AS
...
--select * from [abr].[CONOPS_ABR_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]     
CREATE VIEW [abr].[CONOPS_ABR_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]     
AS    
