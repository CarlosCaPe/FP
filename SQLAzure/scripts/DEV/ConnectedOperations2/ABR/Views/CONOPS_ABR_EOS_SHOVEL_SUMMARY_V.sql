CREATE VIEW [ABR].[CONOPS_ABR_EOS_SHOVEL_SUMMARY_V] AS
...
--SELECT * FROM [ABR].[CONOPS_ABR_EOS_SHOVEL_SUMMARY_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [ABR].[CONOPS_ABR_EOS_SHOVEL_SUMMARY_V]  
AS
...
LEFT JOIN ABR.CONOPS_ABR_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V c
