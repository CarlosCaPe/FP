CREATE VIEW [ABR].[CONOPS_ABR_DAILY_ASSET_EFFICIENCY_V] AS
...
--select * from [ABR].[CONOPS_ABR_DAILY_ASSET_EFFICIENCY_V]
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_ASSET_EFFICIENCY_V] 
AS
