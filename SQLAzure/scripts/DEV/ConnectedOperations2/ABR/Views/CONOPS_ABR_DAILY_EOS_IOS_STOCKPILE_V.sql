CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_IOS_STOCKPILE_V] AS



--SELECT * FROM [abr].[CONOPS_ABR_DAILY_EOS_IOS_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_IOS_STOCKPILE_V]      
AS      
