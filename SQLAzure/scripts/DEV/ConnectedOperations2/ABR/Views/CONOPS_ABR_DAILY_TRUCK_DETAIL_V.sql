CREATE VIEW [ABR].[CONOPS_ABR_DAILY_TRUCK_DETAIL_V] AS




--SELECT * FROM [ABR].[CONOPS_ABR_DAILY_TRUCK_DETAIL_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_TRUCK_DETAIL_V] 
AS
