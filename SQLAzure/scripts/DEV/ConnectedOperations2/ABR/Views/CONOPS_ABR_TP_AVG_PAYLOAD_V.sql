CREATE VIEW [ABR].[CONOPS_ABR_TP_AVG_PAYLOAD_V] AS




  
--select * from [abr].[CONOPS_ABR_TP_AVG_PAYLOAD_V] WITH (NOLOCK) where shiftflag = 'curr'  ORDER BY shiftflag, siteflag, TRUCK    
CREATE VIEW [ABR].[CONOPS_ABR_TP_AVG_PAYLOAD_V]     
AS    
...
LEFT JOIN [abr].[CONOPS_ABR_TRUCK_DETAIL_V] [truck] WITH (NOLOCK)    
