CREATE VIEW [ABR].[CONOPS_ABR_TM_HAUL_STATUS_V] AS




-- SELECT * FROM [abr].[CONOPS_ABR_TM_HAUL_STATUS_V] WITH (NOLOCK)
CREATE VIEW [ABR].[CONOPS_ABR_TM_HAUL_STATUS_V] 
AS
	...
	ON a.SHIFTINDEX = h.SHIFTINDEX 
	LEFT JOIN [abr].[CONOPS_ABR_DELTA_C_DETAIL_V] [dt]
