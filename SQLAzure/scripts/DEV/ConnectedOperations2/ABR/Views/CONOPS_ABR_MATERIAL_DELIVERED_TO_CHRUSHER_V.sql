CREATE VIEW [ABR].[CONOPS_ABR_MATERIAL_DELIVERED_TO_CHRUSHER_V] AS
...
CREATE VIEW [ABR].[CONOPS_ABR_MATERIAL_DELIVERED_TO_CHRUSHER_V] 
AS
...
MillOreTarget,
MillOreShiftTarget,
SUM(NRDumps) AS TotalNrDumps
FROM [abr].[CONOPS_ABR_SHIFT_INFO_V] a
LEFT JOIN CrusherLoad b
ON a.shiftid = b.shiftid
LEFT JOIN [ABR].[CONOPS_ABR_MATERIAL_DELIVERED_TO_CHRUSHER_TARGET_V] [ct]
ON a.SHIFTFLAG = [ct].shiftflag
GROUP BY 
a.siteflag,
a.shiftflag,
a.shiftid,
