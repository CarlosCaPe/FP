CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_TRUCK_NON_UTILIZED_REASON_V] AS



--SELECT * FROM [abr].[CONOPS_ABR_DAILY_EOS_TRUCK_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_TRUCK_NON_UTILIZED_REASON_V]    
AS    
