CREATE VIEW [ABR].[CONOPS_ABR_TRUCK_TO_WATCH_V] AS



-- SELECT * FROM [abr].[CONOPS_ABR_TRUCK_TO_WATCH_V] WITH (NOLOCK) WHERE [TruckID] = 'T501'  
CREATE VIEW [ABR].[CONOPS_ABR_TRUCK_TO_WATCH_V]  
AS  
...
LEFT JOIN [ABR].[CONOPS_ABR_TRUCK_SHIFT_OVERVIEW_V] [tm]
