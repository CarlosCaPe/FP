CREATE VIEW [MOR].[CONOPS_MOR_DAILY_EOS_ASSET_EFFICIENCY_V] AS
...
--SELECT * FROM [MOR].[CONOPS_MOR_DAILY_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [mor].[CONOPS_MOR_DAILY_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [MOR].[CONOPS_MOR_DAILY_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [MOR].[CONOPS_MOR_DAILY_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [MOR].[CONOPS_MOR_DAILY_DRILL_ASSET_EFFICIENCY_V]
)
...
FROM(
	...
	LEFT JOIN [MOR].[CONOPS_MOR_EQMT_ASSET_EFFICIENCY_TARGET_V] tg
