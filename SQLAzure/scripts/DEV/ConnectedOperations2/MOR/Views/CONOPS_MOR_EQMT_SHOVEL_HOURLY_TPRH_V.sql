CREATE VIEW [MOR].[CONOPS_MOR_EQMT_SHOVEL_HOURLY_TPRH_V] AS

--select * from [mor].[CONOPS_MOR_EQMT_SHOVEL_HOURLY_TPRH_V] where shiftflag = 'curr'
CREATE VIEW [mor].[CONOPS_MOR_EQMT_SHOVEL_HOURLY_TPRH_V]
AS
...
GROUP BY siteflag, shiftindex, excav, TimeFull_HOS 
)
