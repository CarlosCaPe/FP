CREATE VIEW [MOR].[CONOPS_MOR_OPERATOR_TRUCK_LIST_V] AS
...
-- SELECT * FROM [mor].[CONOPS_MOR_OPERATOR_TRUCK_LIST_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' 
CREATE VIEW [mor].[CONOPS_MOR_OPERATOR_TRUCK_LIST_V] 
AS
