CREATE VIEW [MOR].[CONOPS_MOR_DAILY_TP_AVG_PAYLOAD_V] AS


  
    
--select * from [mor].[CONOPS_MOR_DAILY_TP_AVG_PAYLOAD_V] WITH (NOLOCK) where shiftflag = 'curr'  ORDER BY shiftflag, siteflag, TRUCK      
CREATE VIEW [mor].[CONOPS_MOR_DAILY_TP_AVG_PAYLOAD_V]       
AS      
...
LEFT JOIN [mor].[CONOPS_MOR_DAILY_TRUCK_DETAIL_V] [truck] WITH (NOLOCK)
