CREATE VIEW [MOR].[CONOPS_MOR_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS
  
    
       
--select * from [mor].[CONOPS_MOR_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq        
CREATE VIEW [mor].[CONOPS_MOR_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]        
AS        
...
ON a.shiftid = b.shiftid AND b.siteflag = 'MOR'        
--WHERE ShovelId = 'S11'        
