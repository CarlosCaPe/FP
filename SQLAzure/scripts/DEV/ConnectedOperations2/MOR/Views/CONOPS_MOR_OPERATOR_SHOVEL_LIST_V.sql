CREATE VIEW [MOR].[CONOPS_MOR_OPERATOR_SHOVEL_LIST_V] AS
...
-- SELECT * FROM [MOR].[CONOPS_MOR_OPERATOR_SHOVEL_LIST_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [MOR].[CONOPS_MOR_OPERATOR_SHOVEL_LIST_V]
AS
