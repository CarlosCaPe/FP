CREATE VIEW [MOR].[CONOPS_MOR_EOS_ASSET_EFFICIENCY_V] AS
...
--SELECT * FROM [MOR].[CONOPS_MOR_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [mor].[CONOPS_MOR_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [MOR].[CONOPS_MOR_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [MOR].[CONOPS_MOR_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [MOR].[CONOPS_MOR_DRILL_ASSET_EFFICIENCY_V]
)
