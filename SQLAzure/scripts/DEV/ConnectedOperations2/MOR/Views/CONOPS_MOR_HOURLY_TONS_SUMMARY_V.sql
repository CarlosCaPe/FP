CREATE VIEW [MOR].[CONOPS_MOR_HOURLY_TONS_SUMMARY_V] AS
  
--select * from MOR.CONOPS_MOR_HOURLY_TONS_SUMMARY_V order by shiftseq      
CREATE VIEW MOR.CONOPS_MOR_HOURLY_TONS_SUMMARY_V   
AS
