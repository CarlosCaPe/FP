CREATE VIEW [MOR].[CONOPS_MOR_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] AS
...
--select * from [mor].[CONOPS_MOR_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] order by shiftseq  
CREATE VIEW [mor].[CONOPS_MOR_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V]  
AS  
