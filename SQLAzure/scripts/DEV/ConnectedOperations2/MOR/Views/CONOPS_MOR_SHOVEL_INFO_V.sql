CREATE VIEW [MOR].[CONOPS_MOR_SHOVEL_INFO_V] AS
  
  
  
-- SELECT * FROM [mor].[CONOPS_MOR_SHOVEL_INFO_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'  
CREATE VIEW [mor].[CONOPS_MOR_SHOVEL_INFO_V]   
AS  
