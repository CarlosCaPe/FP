CREATE VIEW [sie].[CONOPS_SIE_DAILY_EOS_KPI_SUMMARY_V] AS
...
-- SELECT * FROM [sie].[CONOPS_SIE_DAILY_EOS_KPI_SUMMARY_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [sie].[CONOPS_SIE_DAILY_EOS_KPI_SUMMARY_V]      
AS      
...
FROM [sie].[CONOPS_SIE_DAILY_DELTA_J_V]  
WHERE DeltaJ <> 0  
...
LEFT JOIN HaulageEff he   
 ON a.shiftid = he.shiftid  AND a.shiftflag = he.shiftflag
