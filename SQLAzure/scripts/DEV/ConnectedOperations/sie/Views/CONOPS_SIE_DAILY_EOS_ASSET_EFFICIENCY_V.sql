CREATE VIEW [sie].[CONOPS_SIE_DAILY_EOS_ASSET_EFFICIENCY_V] AS
...
--SELECT * FROM [SIE].[CONOPS_SIE_DAILY_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [sie].[CONOPS_SIE_DAILY_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [SIE].[CONOPS_SIE_DAILY_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [SIE].[CONOPS_SIE_DAILY_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [SIE].[CONOPS_SIE_DAILY_DRILL_ASSET_EFFICIENCY_V]
)
...
FROM(
	...
	LEFT JOIN [SIE].[CONOPS_SIE_EQMT_ASSET_EFFICIENCY_TARGET_V] tg
