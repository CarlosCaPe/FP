CREATE VIEW [sie].[CONOPS_SIE_EOS_LINEUP_TRUCK_V] AS





-- SELECT * FROM [sie].[CONOPS_SIE_EOS_LINEUP_TRUCK_V]  WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [sie].[CONOPS_SIE_EOS_LINEUP_TRUCK_V] 
AS
...
FROM (
	...
	LEFT JOIN [SIE].[CONOPS_SIE_SHIFT_INFO_V] [shift] WITH (NOLOCK)
