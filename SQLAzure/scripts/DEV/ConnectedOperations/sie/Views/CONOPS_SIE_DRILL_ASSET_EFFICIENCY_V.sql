CREATE VIEW [sie].[CONOPS_SIE_DRILL_ASSET_EFFICIENCY_V] AS





--select * from [sie].[CONOPS_SIE_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [SIE].[CONOPS_SIE_DRILL_ASSET_EFFICIENCY_V] 
AS
