CREATE VIEW [sie].[CONOPS_SIE_SP_EQMT_STATUS_V] AS




--select * from [sie].[CONOPS_SIE_SP_EQMT_STATUS_V] where shiftflag = 'curr'

CREATE VIEW [sie].[CONOPS_SIE_SP_EQMT_STATUS_V]
AS
...
eqmt,
tprh 
FROM [sie].[CONOPS_SIE_SHOVEL_TPRH_V] (NOLOCK)) e
