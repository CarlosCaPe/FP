CREATE VIEW [sie].[ZZZ_CONOPS_SIE_EFH_NEW_V] AS


--SELECT * FROM [SIE].[CONOPS_SIE_EFH_NEW_V] where shiftflag = 'curr'
CREATE VIEW [SIE].[CONOPS_SIE_EFH_NEW_V]
AS
...
LEFT JOIN [SIE].[CONOPS_SIE_SHIFT_INFO_V] b
	ON a.siteflag = 'SIE'
