CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_TRUCK_LOGIN_V] AS





-- SELECT * FROM [sie].[CONOPS_SIE_OPERATOR_TRUCK_LOGIN_V] WITH (NOLOCK) WHsieERE [shiftflag] = 'CURR'
CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_TRUCK_LOGIN_V] 
AS
