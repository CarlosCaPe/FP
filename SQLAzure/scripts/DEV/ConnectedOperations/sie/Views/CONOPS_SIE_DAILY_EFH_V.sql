CREATE VIEW [sie].[CONOPS_SIE_DAILY_EFH_V] AS

--SELECT * FROM [SIE].[CONOPS_SIE_DAILY_EFH_V] where shiftflag = 'curr'
CREATE VIEW [SIE].[CONOPS_SIE_DAILY_EFH_V]
AS
...
LEFT JOIN SIE.CONOPS_SIE_EOS_SHIFT_INFO_V b
...
RIGHT JOIN [SIE].[CONOPS_SIE_EOS_SHIFT_INFO_V] b
	ON a.SHIFTINDEX = b.SHIFTINDEX
