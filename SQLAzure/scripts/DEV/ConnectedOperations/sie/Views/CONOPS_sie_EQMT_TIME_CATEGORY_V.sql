CREATE VIEW [sie].[CONOPS_sie_EQMT_TIME_CATEGORY_V] AS


--select * from [sie].[CONOPS_sie_EQMT_TIME_CATEGORY_V] WITH(NOLOCK)
CREATE VIEW [sie].[CONOPS_sie_EQMT_TIME_CATEGORY_V] 
AS
