CREATE VIEW [sie].[CONOPS_SIE_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V] AS



  
 
--select * from [sie].[CONOPS_SIE_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]  
CREATE VIEW [sie].[CONOPS_SIE_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]   
AS  
