CREATE VIEW [sie].[CONOPS_SIE_DB_DRILL_SCORE_CARD_V] AS


--select * from [sie].[CONOPS_SIE_DB_DRILL_SCORE_CARD_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [sie].[CONOPS_SIE_DB_DRILL_SCORE_CARD_V]
AS
