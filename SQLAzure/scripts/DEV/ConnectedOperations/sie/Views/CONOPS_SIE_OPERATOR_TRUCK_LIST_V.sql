CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_TRUCK_LIST_V] AS
...
-- SELECT * FROM [sie].[CONOPS_SIE_OPERATOR_TRUCK_LIST_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' 
CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_TRUCK_LIST_V] 
AS
