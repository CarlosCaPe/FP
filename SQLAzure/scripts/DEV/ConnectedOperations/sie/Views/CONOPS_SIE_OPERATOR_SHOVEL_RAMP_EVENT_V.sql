CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_SHOVEL_RAMP_EVENT_V] AS




-- SELECT * FROM [SIE].[CONOPS_SIE_OPERATOR_SHOVEL_RAMP_EVENT_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [SIE].[CONOPS_SIE_OPERATOR_SHOVEL_RAMP_EVENT_V] 
AS
...
    	   ea.alarm_start_time,
    	   ea.alarm_end_time
	FROM [SIE].[CONOPS_SIE_OPERATOR_SHOVEL_LIST_V] [s] WITH (NOLOCK)
