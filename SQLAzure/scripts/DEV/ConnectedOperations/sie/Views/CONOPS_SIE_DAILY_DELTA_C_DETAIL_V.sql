CREATE VIEW [sie].[CONOPS_SIE_DAILY_DELTA_C_DETAIL_V] AS



--select * from [SIE].[CONOPS_SIE_DAILY_DELTA_C_DETAIL_V] 
CREATE VIEW [SIE].[CONOPS_SIE_DAILY_DELTA_C_DETAIL_V] 
AS
