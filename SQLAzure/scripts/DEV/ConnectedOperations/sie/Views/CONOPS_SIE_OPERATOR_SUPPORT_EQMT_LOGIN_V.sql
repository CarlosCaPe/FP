CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_SUPPORT_EQMT_LOGIN_V] AS



-- SELECT * FROM [sie].[CONOPS_SIE_OPERATOR_SUPPORT_EQMT_LOGIN_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_SUPPORT_EQMT_LOGIN_V]
AS
...
        ,[OperatorImageURL]
    FROM [sie].[CONOPS_SIE_EQMT_OTHER_V] WITH (NOLOCK)
    WHERE [Operator] != 'NONE'
),
