CREATE VIEW [sie].[ZZZ_CONOPS_SIE_TP_DELTA_C_AVG_V_OLD] AS
...
--SELECT * FROM [sie].[CONOPS_SIE_TP_DELTA_C_AVG_V]
CREATE VIEW [sie].[CONOPS_SIE_TP_DELTA_C_AVG_V_OLD] 
AS
