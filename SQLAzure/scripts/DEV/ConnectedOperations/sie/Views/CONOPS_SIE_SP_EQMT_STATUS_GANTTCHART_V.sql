CREATE VIEW [sie].[CONOPS_SIE_SP_EQMT_STATUS_GANTTCHART_V] AS



--select * from [sie].[CONOPS_SIE_SP_EQMT_STATUS_GANTTCHART_V] where shiftflag = 'prev'

CREATE VIEW [sie].[CONOPS_SIE_SP_EQMT_STATUS_GANTTCHART_V]
AS
...
eqmt,
tprh 
FROM [sie].[CONOPS_SIE_SHOVEL_TPRH_V] WITH (NOLOCK)
WHERE site_code = 'SIE')
