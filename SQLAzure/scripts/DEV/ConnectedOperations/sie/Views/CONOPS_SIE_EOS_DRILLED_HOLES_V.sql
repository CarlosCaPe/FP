CREATE VIEW [sie].[CONOPS_SIE_EOS_DRILLED_HOLES_V] AS


--SELECT * FROM [SIE].[CONOPS_SIE_EOS_DRILLED_HOLES_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [SIE].[CONOPS_SIE_EOS_DRILLED_HOLES_V]
AS
...
(
	...
	FROM [SIE].[CONOPS_SIE_DB_DRILL_PLAN_V] (NOLOCK)
