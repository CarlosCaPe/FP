CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_DRILL_LIST_V] AS



-- SELECT * FROM [sie].[CONOPS_SIE_OPERATOR_DRILL_LIST_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_DRILL_LIST_V] 
AS
	...
	WITH OperatorDetail AS (
		...
		FROM [sie].[CONOPS_SIE_DRILL_DETAIL_V] d WITH (NOLOCK)
