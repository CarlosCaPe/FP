CREATE VIEW [sie].[CONOPS_SIE_DB_DRILL_PLAN_LINE_GRAPH_V] AS
...
--SELECT * FROM [SIE].[CONOPS_SIE_DB_DRILL_PLAN_LINE_GRAPH_V] WHERE shiftflag = 'PREV'
CREATE VIEW [SIE].[CONOPS_SIE_DB_DRILL_PLAN_LINE_GRAPH_V]
AS
