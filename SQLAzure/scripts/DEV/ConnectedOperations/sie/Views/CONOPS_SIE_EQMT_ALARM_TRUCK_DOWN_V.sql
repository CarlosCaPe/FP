CREATE VIEW [sie].[CONOPS_SIE_EQMT_ALARM_TRUCK_DOWN_V] AS

-- SELECT * FROM [sie].[CONOPS_SIE_EQMT_ALARM_TRUCKL_DOWN_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [sie].[CONOPS_SIE_EQMT_ALARM_TRUCK_DOWN_V]
AS
