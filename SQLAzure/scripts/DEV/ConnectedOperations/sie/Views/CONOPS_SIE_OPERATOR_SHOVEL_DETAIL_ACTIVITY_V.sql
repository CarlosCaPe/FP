CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_SHOVEL_DETAIL_ACTIVITY_V] AS




-- SELECT * FROM [SIE].[CONOPS_SIE_OPERATOR_SHOVEL_DETAIL_ACTIVITY_V] WITH (NOLOCK) WHERE ShiftFlag = 'PREV' OperatorId = '60030149'
CREATE VIEW [SIE].[CONOPS_SIE_OPERATOR_SHOVEL_DETAIL_ACTIVITY_V] 
AS
...
SELECT [op].shiftflag
	...
	,[oa].Reasons
	,[oa].Generated
FROM [SIE].[CONOPS_SIE_OPERATOR_SHOVEL_LIST_V] [op] WITH (NOLOCK) 
