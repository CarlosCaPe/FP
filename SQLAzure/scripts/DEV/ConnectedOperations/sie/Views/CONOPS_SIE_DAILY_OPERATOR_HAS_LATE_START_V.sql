CREATE VIEW [sie].[CONOPS_SIE_DAILY_OPERATOR_HAS_LATE_START_V] AS

  
   
-- SELECT * FROM [sie].[CONOPS_SIE_DAILY_OPERATOR_HAS_LATE_START_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'    
CREATE VIEW [sie].[CONOPS_SIE_DAILY_OPERATOR_HAS_LATE_START_V]     
AS    
