CREATE VIEW [sie].[CONOPS_SIE_DAILY_TRUCK_DETAIL_V] AS
...
-- SELECT * FROM [sie].[CONOPS_SIE_DAILY_TRUCK_DETAIL_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' ORDER BY TruckID
CREATE VIEW [sie].[CONOPS_SIE_DAILY_TRUCK_DETAIL_V] 
AS
