CREATE VIEW [sie].[CONOPS_SIE_DAILY_DB_DRILL_PLAN_V] AS
  
  
  
--select * from [sie].[CONOPS_SIE_DAILY_DB_DRILL_PLAN_V] where shiftflag = 'prev'  
CREATE VIEW [sie].[CONOPS_SIE_DAILY_DB_DRILL_PLAN_V]  
AS  
...
        WHERE [ds].[SITE_CODE] = 'SIE' AND DRILL_ID IS NOT NULL  
