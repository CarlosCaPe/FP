CREATE VIEW [sie].[DRILL_ASSET_EFFICIENCY_V] AS


  
  
  
--SELECT * FROM [SIE].[DRILL_ASSET_EFFICIENCY_V] WITH (NOLOCK)  
CREATE VIEW [sie].[DRILL_ASSET_EFFICIENCY_V]     
AS        
 ...
 WITH EQMTHIST AS (  
  ...
  WHERE [D].[MACHINESTATUSCODE] IS NOT NULL  
 ),  
 ...
 SELECT SHIFTINDEX,  
     SITE_CODE,  
     CASE WHEN [EQUIPMENTMODEL] = 'ADS PV351' OR [EQUIPMENTMODEL] = 'ADS PV271' THEN 'DR' + LEFT(DRILL_ID, 2)  
       ELSE DRILL_ID  
     END AS DRILL_ID,  
