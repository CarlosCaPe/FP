CREATE VIEW [sie].[CONOPS_SIE_DB_FEETDRILL_SNAPSHOT_V] AS



--SELECT * FROM [SIE].[CONOPS_SIE_DB_FEETDRILL_SNAPSHOT_V]

CREATE VIEW [sie].[CONOPS_SIE_DB_FEETDRILL_SNAPSHOT_V]
AS
