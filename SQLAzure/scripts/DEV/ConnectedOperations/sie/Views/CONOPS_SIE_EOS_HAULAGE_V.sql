CREATE VIEW [sie].[CONOPS_SIE_EOS_HAULAGE_V] AS
...
--SELECT * FROM [SIE].[CONOPS_SIE_EOS_HAULAGE_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [sie].[CONOPS_SIE_EOS_HAULAGE_V]
AS
...
FROM(
	...
	FROM [SIE].[CONOPS_SIE_DELTA_C_DETAIL_V] [dc]
