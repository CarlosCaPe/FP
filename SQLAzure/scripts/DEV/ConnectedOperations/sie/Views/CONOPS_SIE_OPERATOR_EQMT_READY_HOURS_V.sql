CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_EQMT_READY_HOURS_V] AS


--select * from [SIE].[CONOPS_SIE_OPERATOR_EQMT_READY_HOURS_V]
CREATE VIEW [SIE].[CONOPS_SIE_OPERATOR_EQMT_READY_HOURS_V]
AS
