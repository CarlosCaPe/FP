CREATE VIEW [sie].[CONOPS_SIE_DAILY_EOS_LINEUP_DRILL_V] AS
...
--select * from [sie].[CONOPS_SIE_DAILY_EOS_LINEUP_DRILL_V] where shiftflag = 'curr'    
CREATE VIEW [sie].[CONOPS_SIE_DAILY_EOS_LINEUP_DRILL_V]    
AS    
