CREATE VIEW [sie].[CONOPS_SIE_TM_HAUL_STATUS_V] AS





-- SELECT * FROM [sie].[CONOPS_SIE_TM_HAUL_STATUS_V] WITH (NOLOCK)
CREATE VIEW [sie].[CONOPS_SIE_TM_HAUL_STATUS_V] 
AS
	...
	LEFT JOIN [sie].[CONOPS_SIE_DELTA_C_DETAIL_V] [dt]
