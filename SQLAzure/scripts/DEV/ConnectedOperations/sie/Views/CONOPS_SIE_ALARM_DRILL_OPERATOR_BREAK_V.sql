CREATE VIEW [sie].[CONOPS_SIE_ALARM_DRILL_OPERATOR_BREAK_V] AS

-- SELECT * FROM [sie].[CONOPS_SIE_ALARM_DRILL_OPERATOR_BREAK_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [sie].[CONOPS_SIE_ALARM_DRILL_OPERATOR_BREAK_V]
AS
...
          	   STATUS_DURATION,
          	   OPERATORID
   		FROM [sie].[DRILL_UTILIZATION] [D] WITH (NOLOCK)
