CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_SHOVEL_LOGIN_V] AS


-- SELECT * FROM [sie].[CONOPS_SIE_OPERATOR_SHOVEL_LOGIN_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_SHOVEL_LOGIN_V] 
AS
