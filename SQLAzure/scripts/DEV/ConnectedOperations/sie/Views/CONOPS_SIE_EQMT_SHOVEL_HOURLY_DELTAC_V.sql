CREATE VIEW [sie].[CONOPS_SIE_EQMT_SHOVEL_HOURLY_DELTAC_V] AS



--select * from [SIE].[CONOPS_SIE_EQMT_SHOVEL_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = 's08'
CREATE VIEW [sie].[CONOPS_SIE_EQMT_SHOVEL_HOURLY_DELTAC_V]
AS
