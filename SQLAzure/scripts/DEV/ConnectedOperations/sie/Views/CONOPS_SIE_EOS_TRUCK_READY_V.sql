CREATE VIEW [sie].[CONOPS_SIE_EOS_TRUCK_READY_V] AS
  
  
  
--SELECT * FROM [sie].[CONOPS_SIE_EOS_TRUCK_READY_V] WHERE shiftflag = 'curr' order by datetime  
CREATE VIEW [sie].[CONOPS_SIE_EOS_TRUCK_READY_V]  
AS  
