CREATE VIEW [sie].[CONOPS_SIE_EOS_TONS_CRUSHED_GRADES_V] AS




--SELECT * FROM [sie].[CONOPS_SIE_EOS_TONS_CRUSHED_GRADES_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [sie].[CONOPS_SIE_EOS_TONS_CRUSHED_GRADES_V]  
AS  
