CREATE VIEW [sie].[CONOPS_SIE_EOS_ASSET_EFFICIENCY_V] AS
...
--SELECT * FROM [SIE].[CONOPS_SIE_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [sie].[CONOPS_SIE_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [SIE].[CONOPS_SIE_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [SIE].[CONOPS_SIE_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [SIE].[CONOPS_SIE_DRILL_ASSET_EFFICIENCY_V]
)
