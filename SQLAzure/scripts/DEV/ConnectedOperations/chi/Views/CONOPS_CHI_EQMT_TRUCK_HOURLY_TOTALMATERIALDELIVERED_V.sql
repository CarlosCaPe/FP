CREATE VIEW [chi].[CONOPS_CHI_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] AS
...
--select * from [chi].[CONOPS_CHI_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] order by shiftseq  
CREATE VIEW [chi].[CONOPS_CHI_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V]  
AS  
