CREATE VIEW [chi].[CONOPS_CHI_DAILY_EOS_ASSET_EFFICIENCY_V] AS
...
--SELECT * FROM [CHI].[CONOPS_CHI_DAILY_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [chi].[CONOPS_CHI_DAILY_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [CHI].[CONOPS_CHI_DAILY_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [CHI].[CONOPS_CHI_DAILY_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [CHI].[CONOPS_CHI_DAILY_DRILL_ASSET_EFFICIENCY_V]
)
...
FROM(
	...
	LEFT JOIN [CHI].[CONOPS_CHI_EQMT_ASSET_EFFICIENCY_TARGET_V] tg
