CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_TRUCK_DETAIL_DELTA_C_V] AS



  
    
-- SELECT * FROM [chi].[CONOPS_CHI_OPERATOR_TRUCK_DETAIL_DELTA_C_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'      
CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_TRUCK_DETAIL_DELTA_C_V]       
AS      
