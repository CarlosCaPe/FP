CREATE VIEW [chi].[CONOPS_CHI_TM_TRAFFIC_STOCKPILE_V] AS
...
--SELECT * FROM [chi].[CONOPS_CHI_TM_TRAFFIC_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [chi].[CONOPS_CHI_TM_TRAFFIC_STOCKPILE_V]      
AS      
 ...
 WITH STOCKPILE AS (    
  ...
  LEFT JOIN [chi].ENUM enumUnit  WITH (NOLOCK)    
