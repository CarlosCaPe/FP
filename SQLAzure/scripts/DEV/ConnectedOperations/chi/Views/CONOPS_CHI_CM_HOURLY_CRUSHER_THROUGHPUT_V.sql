CREATE VIEW [chi].[CONOPS_CHI_CM_HOURLY_CRUSHER_THROUGHPUT_V] AS





-- SELECT * FROM [chi].[CONOPS_CHI_CM_HOURLY_CRUSHER_THROUGHPUT_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [chi].[CONOPS_CHI_CM_HOURLY_CRUSHER_THROUGHPUT_V]  
AS  
