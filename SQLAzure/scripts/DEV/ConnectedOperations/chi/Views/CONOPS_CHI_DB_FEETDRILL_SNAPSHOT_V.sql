CREATE VIEW [chi].[CONOPS_CHI_DB_FEETDRILL_SNAPSHOT_V] AS


--SELECT * FROM [CHI].[CONOPS_CHI_DB_FEETDRILL_SNAPSHOT_V]

CREATE VIEW [chi].[CONOPS_CHI_DB_FEETDRILL_SNAPSHOT_V]
AS
...
WHEN si.ShiftDuration = '43200' THEn tg.FeetShiftTarget ELSE 
CAST(tg.FeetShiftTarget/(si.ShiftDuration/3600.0) AS INT) END AS FeetTarget
FROM Final fn
