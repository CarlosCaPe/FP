CREATE VIEW [chi].[CONOPS_CHI_EQMT_ALARM_TRUCK_DOWN_V] AS

-- SELECT * FROM [chi].[CONOPS_CHI_EQMT_ALARM_TRUCKL_DOWN_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [chi].[CONOPS_CHI_EQMT_ALARM_TRUCK_DOWN_V]
AS
