CREATE VIEW [chi].[CONOPS_CHI_DB_HOLEDRILL_SNAPSHOT_V] AS




--SELECT * FROM [CHI].[CONOPS_CHI_DB_HOLEDRILL_SNAPSHOT_V] WHERE shiftflag = 'prev'

CREATE VIEW [chi].[CONOPS_CHI_DB_HOLEDRILL_SNAPSHOT_V]
AS
...
WHEN si.ShiftDuration = '43200' THEN tg.HoleShiftTarget ELSE 
CAST(tg.HoleShiftTarget/(si.ShiftDuration/3600.0) AS INT) END AS HoleTarget
FROM Final fn
