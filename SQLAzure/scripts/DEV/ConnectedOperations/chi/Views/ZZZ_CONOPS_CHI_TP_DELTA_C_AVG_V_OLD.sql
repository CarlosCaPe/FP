CREATE VIEW [chi].[ZZZ_CONOPS_CHI_TP_DELTA_C_AVG_V_OLD] AS





--SELECT * FROM [chi].[CONOPS_CHI_TP_DELTA_C_AVG_V] WITH (NOLOCK)
CREATE VIEW [chi].[CONOPS_CHI_TP_DELTA_C_AVG_V_OLD] 
AS
