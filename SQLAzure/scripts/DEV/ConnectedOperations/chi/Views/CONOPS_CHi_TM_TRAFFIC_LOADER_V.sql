CREATE VIEW [chi].[CONOPS_CHi_TM_TRAFFIC_LOADER_V] AS
  
    
    
    
    
--SELECT * FROM [chi].[CONOPS_CHi_TM_TRAFFIC_LOADER_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [chi].[CONOPS_CHi_TM_TRAFFIC_LOADER_V]      
AS      
