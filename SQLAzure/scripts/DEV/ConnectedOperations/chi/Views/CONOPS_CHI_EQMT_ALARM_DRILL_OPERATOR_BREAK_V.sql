CREATE VIEW [chi].[CONOPS_CHI_EQMT_ALARM_DRILL_OPERATOR_BREAK_V] AS



-- SELECT * FROM [chi].[CONOPS_CHI_EQMT_ALARM_DRILL_OPERATOR_BREAK_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [chi].[CONOPS_CHI_EQMT_ALARM_DRILL_OPERATOR_BREAK_V]
AS
