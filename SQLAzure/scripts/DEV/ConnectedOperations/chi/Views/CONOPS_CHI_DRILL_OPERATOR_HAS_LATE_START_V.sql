CREATE VIEW [chi].[CONOPS_CHI_DRILL_OPERATOR_HAS_LATE_START_V] AS



-- SELECT * FROM [chi].[CONOPS_CHI_DRILL_OPERATOR_HAS_LATE_START_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [chi].[CONOPS_CHI_DRILL_OPERATOR_HAS_LATE_START_V] 
AS
