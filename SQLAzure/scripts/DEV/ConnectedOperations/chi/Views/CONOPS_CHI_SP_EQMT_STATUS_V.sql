CREATE VIEW [chi].[CONOPS_CHI_SP_EQMT_STATUS_V] AS



--select * from [chi].[CONOPS_CHI_SP_EQMT_STATUS_V] where shiftflag = 'curr'

CREATE VIEW [chi].[CONOPS_CHI_SP_EQMT_STATUS_V]
AS
...
LEFT JOIN (
	 SELECT shiftindex,
            ...
            eqmt,
            tprh
     FROM [chi].[CONOPS_CHI_SHOVEL_TPRH_V] (NOLOCK)
