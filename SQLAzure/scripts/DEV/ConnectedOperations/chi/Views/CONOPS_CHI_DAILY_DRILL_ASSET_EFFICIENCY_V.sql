CREATE VIEW [chi].[CONOPS_CHI_DAILY_DRILL_ASSET_EFFICIENCY_V] AS
...
--select * from [chi].[CONOPS_CHI_DAILY_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [chi].[CONOPS_CHI_DAILY_DRILL_ASSET_EFFICIENCY_V] 
AS
...
(
	...
	from [CHI].[DRILL_ASSET_EFFICIENCY_V] [ae] (NOLOCK)
	RIGHT JOIN [CHI].[CONOPS_CHI_EOS_SHIFT_INFO_V] [shift] WITH (NOLOCK)
