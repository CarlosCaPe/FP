CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_DRILL_LOGIN_V] AS


-- SELECT * FROM [CHI].[CONOPS_CHI_OPERATOR_DRILL_LOGIN_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_DRILL_LOGIN_V] 
AS
