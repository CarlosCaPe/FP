CREATE VIEW [chi].[CONOPS_CHI_EOS_LINEUP_DRILL_V] AS
  
  
  
--select * from [chi].[CONOPS_CHI_EOS_LINEUP_DRILL_V] where shiftflag = 'prev'  
CREATE VIEW [chi].[CONOPS_CHI_EOS_LINEUP_DRILL_V]  
AS  
