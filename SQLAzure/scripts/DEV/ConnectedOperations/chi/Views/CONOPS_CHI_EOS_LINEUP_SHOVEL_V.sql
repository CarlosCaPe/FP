CREATE VIEW [chi].[CONOPS_CHI_EOS_LINEUP_SHOVEL_V] AS



-- SELECT * FROM [chi].[CONOPS_CHI_EOS_LINEUP_SHOVEL_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [chi].[CONOPS_CHI_EOS_LINEUP_SHOVEL_V] 
AS
