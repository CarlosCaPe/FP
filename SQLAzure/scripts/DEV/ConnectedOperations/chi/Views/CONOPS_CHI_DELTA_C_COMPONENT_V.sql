CREATE VIEW [chi].[CONOPS_CHI_DELTA_C_COMPONENT_V] AS





--SELECT * FROM CHI.CONOPS_CHI_DELTA_C_COMPONENT_V WHERE SHIFTFLAG = 'CURR' ORDER BY MinsOverExpected DESC
CREATE VIEW CHI.CONOPS_CHI_DELTA_C_COMPONENT_V
AS
...
LEFT JOIN CHI.CONOPS_CHI_SHIFT_INFO_V si
	ON dc.shiftindex = si.shiftindex
WHERE dc.SITE_CODE = 'CHI'
