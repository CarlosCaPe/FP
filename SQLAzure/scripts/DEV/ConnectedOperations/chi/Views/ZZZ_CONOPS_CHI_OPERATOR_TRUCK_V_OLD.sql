CREATE VIEW [chi].[ZZZ_CONOPS_CHI_OPERATOR_TRUCK_V_OLD] AS



-- SELECT * FROM [chi].[CONOPS_CHI_OPERATOR_TRUCK_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' AND OperatorStatus != 'Active'
