CREATE VIEW [chi].[CONOPS_CHI_DAILY_EOS_CRUSHER_STATS_V] AS


--SELECT * FROM [chi].[CONOPS_CHI_DAILY_EOS_CRUSHER_STATS_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [chi].[CONOPS_CHI_DAILY_EOS_CRUSHER_STATS_V]
AS
