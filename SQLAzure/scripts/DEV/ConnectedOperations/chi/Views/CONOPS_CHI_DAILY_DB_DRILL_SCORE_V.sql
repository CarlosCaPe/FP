CREATE VIEW [chi].[CONOPS_CHI_DAILY_DB_DRILL_SCORE_V] AS
  
  
  
  
--select * from [chi].[CONOPS_CHI_DAILY_DB_DRILL_SCORE_V] WITH (NOLOCK) where shiftflag = 'prev'  
CREATE VIEW [chi].[CONOPS_CHI_DAILY_DB_DRILL_SCORE_V]  
AS  
