CREATE VIEW [chi].[CONOPS_CHI_TONS_LINE_GRAPH_V] AS

--select * from [chi].[CONOPS_CHI_TONS_LINE_GRAPH_V] where shiftflag = 'curr'
CREATE VIEW [chi].[CONOPS_CHI_TONS_LINE_GRAPH_V]
AS
