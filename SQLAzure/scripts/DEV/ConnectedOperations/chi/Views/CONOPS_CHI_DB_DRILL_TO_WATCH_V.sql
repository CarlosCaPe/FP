CREATE VIEW [chi].[CONOPS_CHI_DB_DRILL_TO_WATCH_V] AS
...
--select * from [chi].[CONOPS_CHI_DB_DRILL_TO_WATCH_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [chi].[CONOPS_CHI_DB_DRILL_TO_WATCH_V]
AS
