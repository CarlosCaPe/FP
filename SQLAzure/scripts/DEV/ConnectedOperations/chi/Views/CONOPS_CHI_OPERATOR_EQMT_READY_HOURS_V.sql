CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_EQMT_READY_HOURS_V] AS


--select * from [CHI].[CONOPS_CHI_OPERATOR_EQMT_READY_HOURS_V]
CREATE VIEW [CHI].[CONOPS_CHI_OPERATOR_EQMT_READY_HOURS_V]
AS
