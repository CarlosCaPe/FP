CREATE VIEW [chi].[CONOPS_CHI_CM_DISPATCH_SUMMARY_V] AS





-- SELECT * FROM [chi].[CONOPS_CHI_CM_DISPATCH_SUMMARY_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [chi].[CONOPS_CHI_CM_DISPATCH_SUMMARY_V]  
AS  
	...
	NrOfLoad AS (
		...
		WHERE site_code = 'CHI' AND DUMPASN = 'CRUSHER'
