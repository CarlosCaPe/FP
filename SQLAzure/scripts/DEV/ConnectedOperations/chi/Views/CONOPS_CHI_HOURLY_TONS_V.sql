CREATE VIEW [chi].[CONOPS_CHI_HOURLY_TONS_V] AS
  
  
  
  
CREATE VIEW [chi].[CONOPS_CHI_HOURLY_TONS_V]  
AS  
...
LEFT JOIN [chi].[CONOPS_CHI_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_DUMPTIME_V] c   
