CREATE VIEW [chi].[CONOPS_CHI_DAILY_EOS_LINEUP_EQMT_OTHER_V] AS
...
-- SELECT * FROM [chi].[CONOPS_CHI_DAILY_EOS_LINEUP_EQMT_OTHER_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'  ORDER BY shiftflag, siteflag, SupportEquipment
CREATE VIEW [chi].[CONOPS_CHI_DAILY_EOS_LINEUP_EQMT_OTHER_V]
AS
...
FROM( 
	...
	LEFT JOIN [CHI].[CONOPS_CHI_EOS_SHIFT_INFO_V] [shift]
