CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_TRUCK_LIST_V] AS
...
-- SELECT * FROM [chi].[CONOPS_CHI_OPERATOR_TRUCK_LIST_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' 
CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_TRUCK_LIST_V] 
AS
