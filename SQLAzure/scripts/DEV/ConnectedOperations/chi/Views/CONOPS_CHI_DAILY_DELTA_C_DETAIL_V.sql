CREATE VIEW [chi].[CONOPS_CHI_DAILY_DELTA_C_DETAIL_V] AS

  
 
--select * from [CHI].[CONOPS_CHI_DAILY_DELTA_C_DETAIL_V] 
CREATE VIEW [CHI].[CONOPS_CHI_DAILY_DELTA_C_DETAIL_V] 
AS
