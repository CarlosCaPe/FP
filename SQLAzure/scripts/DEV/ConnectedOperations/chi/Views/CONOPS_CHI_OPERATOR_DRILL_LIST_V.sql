CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_DRILL_LIST_V] AS



-- SELECT * FROM [chi].[CONOPS_CHI_OPERATOR_DRILL_LIST_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_DRILL_LIST_V] 
AS
	...
	WITH OperatorDetail AS (
		...
		FROM [chi].[CONOPS_CHI_DRILL_DETAIL_V] d WITH (NOLOCK)
