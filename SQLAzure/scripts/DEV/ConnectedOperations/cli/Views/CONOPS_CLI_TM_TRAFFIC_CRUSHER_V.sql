CREATE VIEW [cli].[CONOPS_CLI_TM_TRAFFIC_CRUSHER_V] AS
...
--SELECT * FROM [cli].[CONOPS_CLI_TM_TRAFFIC_CRUSHER_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [CLI].[CONOPS_CLI_TM_TRAFFIC_CRUSHER_V]      
AS      
 ...
 WITH CRUSHER AS (    
  ...
  WHERE loc.[FieldId] in ('CRUSHER 1')    
 )    
