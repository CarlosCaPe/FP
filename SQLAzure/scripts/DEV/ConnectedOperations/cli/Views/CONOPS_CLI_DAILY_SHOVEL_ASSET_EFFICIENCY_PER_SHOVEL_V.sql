CREATE VIEW [cli].[CONOPS_CLI_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V] AS





--select * from [cli].[CONOPS_CLI_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]  
CREATE VIEW [cli].[CONOPS_CLI_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]   
AS  
