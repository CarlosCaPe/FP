CREATE VIEW [cli].[CONOPS_CLI_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] AS
...
--select * from [cli].[CONOPS_CLI_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] order by shiftseq  
CREATE VIEW [cli].[CONOPS_CLI_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V]  
AS  
