CREATE VIEW [cli].[CONOPS_CLI_DELTA_C_COMPONENT_V] AS




--SELECT * FROM CLI.CONOPS_CLI_DELTA_C_COMPONENT_V WHERE SHIFTFLAG = 'CURR' ORDER BY MinsOverExpected DESC
CREATE VIEW CLI.CONOPS_CLI_DELTA_C_COMPONENT_V
AS
...
LEFT JOIN CLI.CONOPS_CLI_SHIFT_INFO_V si
	ON dc.shiftindex = si.shiftindex
WHERE dc.SITE_CODE = 'CLI'
