CREATE VIEW [cli].[CONOPS_CLI_DAILY_DELTA_J_V] AS
...
--select * from [cli].[CONOPS_CLI_DAILY_DELTA_J_V]       
CREATE VIEW [cli].[CONOPS_CLI_DAILY_DELTA_J_V]       
AS      
...
TimeInHour,      
Shiftseq      
FROM [cli].[CONOPS_CLI_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]      
...
shiftid,      
shiftTarget      
from [cli].[CONOPS_CLI_SHIFT_TARGET_V]),      
...
FROM [cli].[CONOPS_CLI_DAILY_EFH_V])      
