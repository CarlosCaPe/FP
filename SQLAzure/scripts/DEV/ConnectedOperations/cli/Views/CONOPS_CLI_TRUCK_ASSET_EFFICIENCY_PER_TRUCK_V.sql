CREATE VIEW [cli].[CONOPS_CLI_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] AS
...
--select * from [cli].[CONOPS_CLI_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] WITH (NOLOCK)
CREATE VIEW [cli].[CONOPS_CLI_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] 
AS
