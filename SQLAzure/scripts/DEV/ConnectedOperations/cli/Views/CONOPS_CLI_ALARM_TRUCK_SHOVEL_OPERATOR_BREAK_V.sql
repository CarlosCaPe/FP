CREATE VIEW [cli].[CONOPS_CLI_ALARM_TRUCK_SHOVEL_OPERATOR_BREAK_V] AS

-- SELECT * FROM [cli].[CONOPS_CLI_ALARM_TRUCK_SHOVEL_OPERATOR_BREAK_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [cli].[CONOPS_CLI_ALARM_TRUCK_SHOVEL_OPERATOR_BREAK_V]
AS
