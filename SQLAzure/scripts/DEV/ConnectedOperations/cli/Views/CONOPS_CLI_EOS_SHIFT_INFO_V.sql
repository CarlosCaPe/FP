CREATE VIEW [cli].[CONOPS_CLI_EOS_SHIFT_INFO_V] AS
...
--select * from [cli].[CONOPS_CLI_EOS_SHIFT_INFO_V] order by shiftflag  
  
CREATE VIEW [cli].[CONOPS_CLI_EOS_SHIFT_INFO_V]   
AS  
...
FROM [cli].[shift_info] WITH (nolock)) b  
