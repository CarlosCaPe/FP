CREATE VIEW [cli].[CONOPS_CLI_DAILY_EOS_ASSET_EFFICIENCY_V] AS
...
--SELECT * FROM [CLI].[CONOPS_CLI_DAILY_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [cli].[CONOPS_CLI_DAILY_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [CLI].[CONOPS_CLI_DAILY_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [CLI].[CONOPS_CLI_DAILY_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [CLI].[CONOPS_CLI_DAILY_DRILL_ASSET_EFFICIENCY_V]
)
...
FROM(
	...
	LEFT JOIN [CLI].[CONOPS_CLI_EQMT_ASSET_EFFICIENCY_TARGET_V] tg
