CREATE VIEW [cli].[CONOPS_CLI_EOS_LINEUP_SHOVEL_V] AS



-- SELECT * FROM [cli].[CONOPS_CLI_EOS_LINEUP_SHOVEL_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [cli].[CONOPS_CLI_EOS_LINEUP_SHOVEL_V] 
AS
...
FROM (
	...
	LEFT JOIN [CLI].[CONOPS_CLI_SHIFT_INFO_V] [shift] WITH (NOLOCK)
