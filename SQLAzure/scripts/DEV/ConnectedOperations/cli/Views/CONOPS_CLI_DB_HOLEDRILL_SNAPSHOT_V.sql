CREATE VIEW [cli].[CONOPS_CLI_DB_HOLEDRILL_SNAPSHOT_V] AS




--SELECT * FROM [CLI].[CONOPS_CLI_DB_HOLEDRILL_SNAPSHOT_V] WHERE shiftflag = 'prev'

CREATE VIEW [cli].[CONOPS_CLI_DB_HOLEDRILL_SNAPSHOT_V]
AS
