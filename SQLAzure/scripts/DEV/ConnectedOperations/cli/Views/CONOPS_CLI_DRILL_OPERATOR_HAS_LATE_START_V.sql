CREATE VIEW [cli].[CONOPS_CLI_DRILL_OPERATOR_HAS_LATE_START_V] AS



-- SELECT * FROM [cli].[CONOPS_CLI_DRILL_OPERATOR_HAS_LATE_START_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [cli].[CONOPS_CLI_DRILL_OPERATOR_HAS_LATE_START_V] 
AS
