CREATE VIEW [cli].[ZZZ_CONOPS_CLI_OPERATOR_TRUCK_V_OLD] AS
...
-- SELECT * FROM [cli].[CONOPS_CLI_OPERATOR_TRUCK_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' AND OperatorStatus = 'Active'
