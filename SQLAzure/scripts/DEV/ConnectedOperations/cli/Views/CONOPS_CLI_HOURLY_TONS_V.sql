CREATE VIEW [cli].[CONOPS_CLI_HOURLY_TONS_V] AS
  
 
CREATE VIEW [cli].[CONOPS_CLI_HOURLY_TONS_V]  
AS  
...
LEFT JOIN [cli].[CONOPS_CLI_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_DUMPTIME_V] c   
