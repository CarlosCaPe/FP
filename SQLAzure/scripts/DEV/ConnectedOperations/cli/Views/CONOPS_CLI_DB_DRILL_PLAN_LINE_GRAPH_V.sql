CREATE VIEW [cli].[CONOPS_CLI_DB_DRILL_PLAN_LINE_GRAPH_V] AS
...
--SELECT * FROM [CLI].[CONOPS_CLI_DB_DRILL_PLAN_LINE_GRAPH_V] WHERE shiftflag = 'PREV'
CREATE VIEW [CLI].[CONOPS_CLI_DB_DRILL_PLAN_LINE_GRAPH_V]
AS
