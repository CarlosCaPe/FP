CREATE VIEW [cli].[CONOPS_CLI_OPERATOR_TRUCK_DETAIL_DELTA_C_V] AS



  
     
-- SELECT * FROM [cli].[CONOPS_CLI_OPERATOR_TRUCK_DETAIL_DELTA_C_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'      
CREATE VIEW [cli].[CONOPS_CLI_OPERATOR_TRUCK_DETAIL_DELTA_C_V]       
AS      
