CREATE VIEW [cli].[CONOPS_CLI_HOURLY_TRUCK_ASSET_EFFICIENCY_V] AS
...
--select * from [cli].[CONOPS_CLI_HOURLY_TRUCK_ASSET_EFFICIENCY_V] WITH (NOLOCK)
CREATE VIEW [cli].[CONOPS_CLI_HOURLY_TRUCK_ASSET_EFFICIENCY_V] 
AS
