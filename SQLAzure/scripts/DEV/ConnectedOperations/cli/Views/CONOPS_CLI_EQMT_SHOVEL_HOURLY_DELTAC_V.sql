CREATE VIEW [cli].[CONOPS_CLI_EQMT_SHOVEL_HOURLY_DELTAC_V] AS




--select * from [CLI].[CONOPS_CLI_EQMT_SHOVEL_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = 's08'
CREATE VIEW [cli].[CONOPS_CLI_EQMT_SHOVEL_HOURLY_DELTAC_V]
AS
