CREATE VIEW [cli].[CONOPS_CLI_DAILY_EOS_TONS_CRUSHED_GRADES_V] AS
  
  
  
  
  
--SELECT * FROM [cli].[CONOPS_CLI_DAILY_EOS_TONS_CRUSHED_GRADES_V] WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [cli].[CONOPS_CLI_DAILY_EOS_TONS_CRUSHED_GRADES_V]    
AS    
