CREATE VIEW [cli].[CONOPS_CLI_TRUCK_DETAIL_V] AS
  
  
  
-- SELECT * FROM [cli].[CONOPS_CLI_TRUCK_DETAIL_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'  
CREATE VIEW [cli].[CONOPS_CLI_TRUCK_DETAIL_V]   
AS  
