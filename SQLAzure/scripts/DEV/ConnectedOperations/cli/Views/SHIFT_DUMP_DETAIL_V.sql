CREATE VIEW [cli].[SHIFT_DUMP_DETAIL_V] AS

--SELECT * FROM CLI.SHIFT_DUMP_DETAIL_V
CREATE VIEW [CLI].[SHIFT_DUMP_DETAIL_V]
AS
...
FROM CLI.SHIFT_DUMP WITH (NOLOCK)
)
