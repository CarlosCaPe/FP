CREATE VIEW [cli].[CONOPS_CLI_EQMT_ALARM_TRUCK_DOWN_V] AS

-- SELECT * FROM [cli].[CONOPS_CLI_EQMT_ALARM_TRUCKL_DOWN_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [cli].[CONOPS_CLI_EQMT_ALARM_TRUCK_DOWN_V]
AS
