CREATE VIEW [cli].[CONOPS_CLI_TRUCK_SHOP_LOCATION_V] AS





-- SELECT * FROM [cli].[CONOPS_CLI_TRUCK_SHOP_LOCATION_V] WITH (NOLOCK)
CREATE VIEW [cli].[CONOPS_CLI_TRUCK_SHOP_LOCATION_V] 
AS
...
FROM [cli].[pit_loc] [loc] WITH (NOLOCK)
