CREATE VIEW [cli].[CONOPS_CLI_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V] AS
  
  
  
--select * from [cli].[CONOPS_CLI_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
CREATE VIEW [cli].[CONOPS_CLI_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
AS  
