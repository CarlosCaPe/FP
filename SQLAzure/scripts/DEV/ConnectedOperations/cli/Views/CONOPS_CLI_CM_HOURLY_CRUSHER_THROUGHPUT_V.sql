CREATE VIEW [cli].[CONOPS_CLI_CM_HOURLY_CRUSHER_THROUGHPUT_V] AS




-- SELECT * FROM [cli].[CONOPS_CLI_CM_HOURLY_CRUSHER_THROUGHPUT_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [cli].[CONOPS_CLI_CM_HOURLY_CRUSHER_THROUGHPUT_V]  
AS  
