CREATE VIEW [cli].[CONOPS_CLI_OPERATOR_SUPPORT_EQMT_LOGIN_V] AS



-- SELECT * FROM [cli].[CONOPS_CLI_OPERATOR_SUPPORT_EQMT_LOGIN_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [cli].[CONOPS_CLI_OPERATOR_SUPPORT_EQMT_LOGIN_V]
AS
