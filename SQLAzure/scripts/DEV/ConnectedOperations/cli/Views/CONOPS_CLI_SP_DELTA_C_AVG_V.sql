CREATE VIEW [cli].[CONOPS_CLI_SP_DELTA_C_AVG_V] AS
  
  
--SELECT * FROM [cli].[CONOPS_CLI_SP_DELTA_C_AVG_V]  
CREATE VIEW [cli].[CONOPS_CLI_SP_DELTA_C_AVG_V]  
AS  
  
SELECT CASE WHEN a.site_code = 'CLI' THEN 'CMX' ELSE a.site_code END AS site_code,  
       a.shiftindex,  
       a.excav,  
