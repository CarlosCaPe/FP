CREATE VIEW [cli].[CONOPS_CLI_DB_FEETDRILL_SNAPSHOT_V] AS


--SELECT * FROM [CLI].[CONOPS_CLI_DB_FEETDRILL_SNAPSHOT_V]

CREATE VIEW [cli].[CONOPS_CLI_DB_FEETDRILL_SNAPSHOT_V]
AS
