CREATE VIEW [cli].[CONOPS_CLI_EOS_LINEUP_TRUCK_V] AS





-- SELECT * FROM [cli].[CONOPS_CLI_EOS_LINEUP_TRUCK_V]  WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [cli].[CONOPS_CLI_EOS_LINEUP_TRUCK_V] 
AS
