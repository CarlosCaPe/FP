CREATE VIEW [cli].[CONOPS_CLI_EOS_LINEUP_DRILL_V] AS
  
  
  
--select * from [cli].[CONOPS_CLI_EOS_LINEUP_DRILL_V] where shiftflag = 'curr'  
CREATE VIEW [cli].[CONOPS_CLI_EOS_LINEUP_DRILL_V]  
AS  
