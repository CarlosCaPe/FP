CREATE VIEW [TYR].[CONOPS_TYR_OPERATOR_HAS_LATE_START_V] AS
...
-- SELECT * FROM [tyr].[CONOPS_TYR_OPERATOR_HAS_LATE_START_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'      
CREATE VIEW [TYR].[CONOPS_TYR_OPERATOR_HAS_LATE_START_V]       
AS      
...
SELECT DISTINCT oper.shiftindex
    ...
    FROM TYR.CONOPS_TYR_SHIFT_INFO_V (nolock) AS eroot
