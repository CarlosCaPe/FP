CREATE VIEW [TYR].[CONOPS_TYR_DRILL_ASSET_EFFICIENCY_V] AS
...
--select * from [TYR].[CONOPS_TYR_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [TYR].[CONOPS_TYR_DRILL_ASSET_EFFICIENCY_V]
AS
