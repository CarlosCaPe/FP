CREATE VIEW [TYR].[CONOPS_TYR_DB_DRILL_SCORE_CARD_V] AS



--select * from [tyr].[CONOPS_TYR_DB_DRILL_SCORE_CARD_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [TYR].[CONOPS_TYR_DB_DRILL_SCORE_CARD_V]
AS
