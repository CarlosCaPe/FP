CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_SHOVEL_SUMMARY] AS

--SELECT * FROM [TYR].[CONOPS_TYR_DAILY_EOS_SHOVEL_SUMMARY] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_SHOVEL_SUMMARY]  
AS  
