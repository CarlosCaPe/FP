CREATE VIEW [TYR].[CONOPS_TYR_TM_TRAFFIC_STOCKPILE_V] AS

  
--SELECT * FROM [tyr].[CONOPS_TYR_TM_TRAFFIC_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [tyr].[CONOPS_TYR_TM_TRAFFIC_STOCKPILE_V]      
AS      
 ...
 WITH STOCKPILE AS (    
  ...
  LEFT JOIN [tyr].ENUM enumUnit  WITH (NOLOCK)    
