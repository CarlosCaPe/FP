CREATE VIEW [TYR].[CONOPS_TYR_TRUCK_DETAIL_V] AS
  
    
    
    
-- SELECT * FROM [tyr].[CONOPS_TYR_TRUCK_DETAIL_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'    
CREATE VIEW [tyr].[CONOPS_TYR_TRUCK_DETAIL_V]     
AS    
