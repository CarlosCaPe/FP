CREATE VIEW [TYR].[CONOPS_TYR_TM_TRAFFIC_LOADER_V] AS

  
--SELECT * FROM [tyr].[CONOPS_TYR_TM_TRAFFIC_LOADER_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [tyr].[CONOPS_TYR_TM_TRAFFIC_LOADER_V]      
AS      
