CREATE VIEW [TYR].[CONOPS_TYR_TRUCK_TO_WATCH_V] AS
...
-- SELECT * FROM [tyr].[CONOPS_TYR_TRUCK_TO_WATCH_V] WITH (NOLOCK) WHERE [TruckID] = 'T501'  
CREATE VIEW [tyr].[CONOPS_TYR_TRUCK_TO_WATCH_V]  
AS  
...
LEFT JOIN [TYR].[CONOPS_TYR_TRUCK_SHIFT_OVERVIEW_V] [tm]
