CREATE VIEW [TYR].[CONOPS_TYR_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V] AS



--select * from [tyr].[CONOPS_TYR_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]
CREATE VIEW [tyr].[CONOPS_TYR_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]
AS
