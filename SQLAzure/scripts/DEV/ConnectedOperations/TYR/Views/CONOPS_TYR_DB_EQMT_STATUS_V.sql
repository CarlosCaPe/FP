CREATE VIEW [TYR].[CONOPS_TYR_DB_EQMT_STATUS_V] AS



--SELECT * FROM [tyr].[CONOPS_TYR_DB_EQMT_STATUS_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [TYR].[CONOPS_TYR_DB_EQMT_STATUS_V]  
AS  
