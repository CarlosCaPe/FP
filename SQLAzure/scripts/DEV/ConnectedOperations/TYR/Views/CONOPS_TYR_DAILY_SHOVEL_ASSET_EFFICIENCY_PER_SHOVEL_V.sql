CREATE VIEW [TYR].[CONOPS_TYR_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V] AS
...
--select * from [tyr].[CONOPS_TYR_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]     
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]     
AS    
