CREATE VIEW [TYR].[CONOPS_TYR_OPERATOR_TRUCK_LIST_V] AS



-- SELECT * FROM [tyr].[CONOPS_TYR_OPERATOR_TRUCK_LIST_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' 
CREATE VIEW [tyr].[CONOPS_TYR_OPERATOR_TRUCK_LIST_V] 
AS
