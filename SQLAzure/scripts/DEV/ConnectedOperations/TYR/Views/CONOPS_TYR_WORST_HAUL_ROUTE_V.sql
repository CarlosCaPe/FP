CREATE VIEW [TYR].[CONOPS_TYR_WORST_HAUL_ROUTE_V] AS


-- SELECT * FROM [tyr].[CONOPS_TYR_WORST_HAUL_ROUTE_V] WITH (NOLOCK)
CREATE VIEW [tyr].[CONOPS_TYR_WORST_HAUL_ROUTE_V] 
AS
