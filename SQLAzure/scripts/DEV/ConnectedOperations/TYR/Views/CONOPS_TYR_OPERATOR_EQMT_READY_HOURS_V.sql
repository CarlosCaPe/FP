CREATE VIEW [TYR].[CONOPS_TYR_OPERATOR_EQMT_READY_HOURS_V] AS


--select * from [TYR].[CONOPS_TYR_OPERATOR_EQMT_READY_HOURS_V]
CREATE VIEW [TYR].[CONOPS_TYR_OPERATOR_EQMT_READY_HOURS_V]
AS
