CREATE VIEW [TYR].[CONOPS_TYR_SHOVEL_DOWN_V] AS





--select * from [tyr].[CONOPS_TYR_SHOVEL_DOWN_V] where shiftflag = 'curr'
CREATE VIEW [tyr].[CONOPS_TYR_SHOVEL_DOWN_V]
AS
...
from [tyr].[CONOPS_TYR_OVERVIEW_V] (NOLOCK)
