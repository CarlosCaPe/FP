CREATE VIEW [TYR].[CONOPS_TYR_EOS_LINEUP_SHOVEL_V] AS




-- SELECT * FROM [tyr].[CONOPS_TYR_EOS_LINEUP_SHOVEL_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [tyr].[CONOPS_TYR_EOS_LINEUP_SHOVEL_V] 
AS
