CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_TONS_CRUSHED_GRADES_V] AS

  
  
--SELECT * FROM [tyr].[CONOPS_TYR_DAILY_EOS_TONS_CRUSHED_GRADES_V] WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [tyr].[CONOPS_TYR_DAILY_EOS_TONS_CRUSHED_GRADES_V]    
AS    
...
     SELECT a.SHIFTINDEX,  
      ...
      NULL CrusherLoc  
     FROM --CrLoc, 
		[tyr].[CONOPS_TYR_EOS_SHIFT_INFO_V] a WITH (NOLOCK)  
 ),  
