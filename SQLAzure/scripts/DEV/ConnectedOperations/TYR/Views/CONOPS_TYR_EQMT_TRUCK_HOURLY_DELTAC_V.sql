CREATE VIEW [TYR].[CONOPS_TYR_EQMT_TRUCK_HOURLY_DELTAC_V] AS
...
--select * from [tyr].[CONOPS_TYR_EQMT_TRUCK_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = '708'
CREATE VIEW [TYR].[CONOPS_TYR_EQMT_TRUCK_HOURLY_DELTAC_V]
AS
