CREATE VIEW [mor].[CONOPS_MOR_DAILY_EOS_IOS_STOCKPILE_HOURLY_V] AS
...
--SELECT * FROM [MOR].[CONOPS_MOR_DAILY_EOS_IOS_STOCKPILE_HOURLY_V] WHERE shiftflag = 'PREV'  
CREATE VIEW [MOR].[CONOPS_MOR_DAILY_EOS_IOS_STOCKPILE_HOURLY_V]  
AS  
...
LEFT JOIN [MOR].[CONOPS_MOR_EOS_SHIFT_INFO_V] s WITH (NOLOCK)    
