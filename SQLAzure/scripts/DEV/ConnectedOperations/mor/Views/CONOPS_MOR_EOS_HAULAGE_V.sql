CREATE VIEW [mor].[CONOPS_MOR_EOS_HAULAGE_V] AS
...
--SELECT * FROM [MOR].[CONOPS_MOR_EOS_HAULAGE_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [mor].[CONOPS_MOR_EOS_HAULAGE_V]
AS
...
FROM(
	...
	FROM [MOR].[CONOPS_MOR_DELTA_C_DETAIL_V] [dc]
