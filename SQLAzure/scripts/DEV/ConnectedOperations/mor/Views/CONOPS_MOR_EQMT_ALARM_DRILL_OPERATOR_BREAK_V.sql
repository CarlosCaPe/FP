CREATE VIEW [mor].[CONOPS_MOR_EQMT_ALARM_DRILL_OPERATOR_BREAK_V] AS

-- SELECT * FROM [mor].[CONOPS_MOR_EQMT_ALARM_DRILL_OPERATOR_BREAK_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [mor].[CONOPS_MOR_EQMT_ALARM_DRILL_OPERATOR_BREAK_V]
AS
