CREATE VIEW [mor].[CONOPS_MOR_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V] AS

--select * from [mor].[CONOPS_MOR_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]
CREATE VIEW [mor].[CONOPS_MOR_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]
AS
