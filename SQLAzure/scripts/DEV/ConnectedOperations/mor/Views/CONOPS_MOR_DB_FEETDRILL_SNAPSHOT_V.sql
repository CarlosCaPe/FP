CREATE VIEW [mor].[CONOPS_MOR_DB_FEETDRILL_SNAPSHOT_V] AS


--SELECT * FROM [MOR].[CONOPS_MOR_DB_FEETDRILL_SNAPSHOT_V]

CREATE VIEW [mor].[CONOPS_MOR_DB_FEETDRILL_SNAPSHOT_V]
AS
