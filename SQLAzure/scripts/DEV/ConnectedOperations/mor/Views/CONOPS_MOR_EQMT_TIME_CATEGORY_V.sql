CREATE VIEW [mor].[CONOPS_MOR_EQMT_TIME_CATEGORY_V] AS


--select * from [MOR].[CONOPS_MOR_EQMT_TIME_CATEGORY_V] WITH(NOLOCK)
CREATE VIEW [MOR].[CONOPS_MOR_EQMT_TIME_CATEGORY_V] 
AS
