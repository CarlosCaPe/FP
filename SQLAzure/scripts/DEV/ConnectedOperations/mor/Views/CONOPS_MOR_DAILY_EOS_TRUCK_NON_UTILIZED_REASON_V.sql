CREATE VIEW [mor].[CONOPS_MOR_DAILY_EOS_TRUCK_NON_UTILIZED_REASON_V] AS
  
  
  
--SELECT * FROM [MOR].[CONOPS_MOR_DAILY_EOS_TRUCK_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [MOR].[CONOPS_MOR_DAILY_EOS_TRUCK_NON_UTILIZED_REASON_V]    
AS    
