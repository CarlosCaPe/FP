CREATE VIEW [mor].[CONOPS_MOR_DB_EQMT_STATUS_V] AS

  
  
--SELECT * FROM [MOR].[CONOPS_MOR_DB_EQMT_STATUS_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [MOR].[CONOPS_MOR_DB_EQMT_STATUS_V]  
AS  
