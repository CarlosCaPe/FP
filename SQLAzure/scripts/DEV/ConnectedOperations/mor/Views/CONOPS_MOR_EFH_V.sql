CREATE VIEW [mor].[CONOPS_MOR_EFH_V] AS

--SELECT * FROM [MOR].[CONOPS_MOR_EFH_V] where shiftflag = 'curr'
CREATE VIEW [MOR].[CONOPS_MOR_EFH_V]
AS
...
RIGHT JOIN [MOR].[CONOPS_MOR_SHIFT_INFO_V] b
