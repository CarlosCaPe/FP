CREATE VIEW [mor].[CONOPS_MOR_EQMT_SHOVEL_HOURLY_DELTAC_V] AS



--select * from [MOR].[CONOPS_MOR_EQMT_SHOVEL_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = 's08'
CREATE VIEW [mor].[CONOPS_MOR_EQMT_SHOVEL_HOURLY_DELTAC_V]
AS
