CREATE VIEW [mor].[CONOPS_MOR_OPERATOR_SHOVEL_LOGIN_V] AS


-- SELECT * FROM [mor].[CONOPS_MOR_OPERATOR_SHOVEL_LOGIN_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [mor].[CONOPS_MOR_OPERATOR_SHOVEL_LOGIN_V] 
AS
