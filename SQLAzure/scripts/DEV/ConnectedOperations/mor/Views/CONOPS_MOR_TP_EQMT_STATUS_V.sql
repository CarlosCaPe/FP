CREATE VIEW [mor].[CONOPS_MOR_TP_EQMT_STATUS_V] AS



--select * from [mor].[CONOPS_MOR_TP_EQMT_STATUS_V] where shiftflag = 'curr'

CREATE VIEW [mor].[CONOPS_MOR_TP_EQMT_STATUS_V] 
AS
...
FROM [mor].[CONOPS_MOR_TP_AVG_PAYLOAD_V] (NOLOCK)
) e
