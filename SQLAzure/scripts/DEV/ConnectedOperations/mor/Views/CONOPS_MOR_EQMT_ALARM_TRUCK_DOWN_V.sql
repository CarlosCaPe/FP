CREATE VIEW [mor].[CONOPS_MOR_EQMT_ALARM_TRUCK_DOWN_V] AS

-- SELECT * FROM [mor].[CONOPS_MOR_EQMT_ALARM_TRUCKL_DOWN_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [mor].[CONOPS_MOR_EQMT_ALARM_TRUCK_DOWN_V]
AS
