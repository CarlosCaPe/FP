CREATE VIEW [mor].[ZZZ_CONOPS_MOR_OPERATOR_TRUCK_V_OLD] AS




-- SELECT * FROM [mor].[CONOPS_MOR_OPERATOR_TRUCK_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' AND OperatorStatus != 'Active'
CREATE VIEW [mor].[CONOPS_MOR_OPERATOR_TRUCK_V] 
AS
