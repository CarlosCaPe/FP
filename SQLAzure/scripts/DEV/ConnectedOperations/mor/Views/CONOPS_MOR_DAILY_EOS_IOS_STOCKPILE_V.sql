CREATE VIEW [mor].[CONOPS_MOR_DAILY_EOS_IOS_STOCKPILE_V] AS
  
    
  
--SELECT * FROM [mor].[CONOPS_MOR_DAILY_EOS_IOS_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [mor].[CONOPS_MOR_DAILY_EOS_IOS_STOCKPILE_V]      
AS      
