CREATE VIEW [mor].[CONOPS_MOR_DAILY_EOS_LINEUP_TRUCK_V] AS





-- SELECT * FROM [mor].[CONOPS_MOR_DAILY_EOS_LINEUP_TRUCK_V]  WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [mor].[CONOPS_MOR_DAILY_EOS_LINEUP_TRUCK_V] 
AS
