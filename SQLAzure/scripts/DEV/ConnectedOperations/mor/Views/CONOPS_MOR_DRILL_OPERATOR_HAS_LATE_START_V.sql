CREATE VIEW [mor].[CONOPS_MOR_DRILL_OPERATOR_HAS_LATE_START_V] AS



-- SELECT * FROM [mor].[CONOPS_MOR_DRILL_OPERATOR_HAS_LATE_START_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [mor].[CONOPS_MOR_DRILL_OPERATOR_HAS_LATE_START_V] 
AS
