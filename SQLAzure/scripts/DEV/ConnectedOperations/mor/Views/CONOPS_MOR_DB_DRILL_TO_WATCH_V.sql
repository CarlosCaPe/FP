CREATE VIEW [mor].[CONOPS_MOR_DB_DRILL_TO_WATCH_V] AS
...
--select * from [mor].[CONOPS_MOR_DB_DRILL_TO_WATCH_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [mor].[CONOPS_MOR_DB_DRILL_TO_WATCH_V]
AS
