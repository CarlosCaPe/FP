CREATE VIEW [mor].[CONOPS_MOR_HOURLY_DRILL_ASSET_EFFICIENCY_V] AS


--select * from [mor].[CONOPS_MOR_HOURLY_DRILL_ASSET_EFFICIENCY_V] WITH (NOLOCK)
CREATE VIEW [mor].[CONOPS_MOR_HOURLY_DRILL_ASSET_EFFICIENCY_V]
AS
