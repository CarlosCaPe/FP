CREATE VIEW [mor].[CONOPS_MOR_DRILL_ASSET_EFFICIENCY_V] AS





--select * from [mor].[CONOPS_MOR_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [mor].[CONOPS_MOR_DRILL_ASSET_EFFICIENCY_V] 
AS
