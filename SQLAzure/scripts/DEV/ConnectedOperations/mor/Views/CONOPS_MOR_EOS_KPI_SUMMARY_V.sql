CREATE VIEW [mor].[CONOPS_MOR_EOS_KPI_SUMMARY_V] AS



  
  
-- SELECT * FROM [mor].[CONOPS_MOR_EOS_KPI_SUMMARY_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'PREV'    
