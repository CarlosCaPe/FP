CREATE VIEW [mor].[CONOPS_MOR_EQMT_PAYLOAD_CATEGORY_TARGET_V] AS
...
-- SELECT * FROM [mor].[CONOPS_MOR_EQMT_PAYLOAD_CATEGORY_TARGET_V] WHERE shiftindex = '38916'  
CREATE VIEW [mor].[CONOPS_MOR_EQMT_PAYLOAD_CATEGORY_TARGET_V]  
AS  
...
0.05 * 267 AS UnderLoadedTarget,  
FLOOR(267 - (0.05 * 267)) AS UnderLoaded,  
