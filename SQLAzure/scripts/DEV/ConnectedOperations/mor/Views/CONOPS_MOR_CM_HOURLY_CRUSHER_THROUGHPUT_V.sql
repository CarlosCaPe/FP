CREATE VIEW [mor].[CONOPS_MOR_CM_HOURLY_CRUSHER_THROUGHPUT_V] AS





-- SELECT * FROM [mor].[CONOPS_MOR_CM_HOURLY_CRUSHER_THROUGHPUT_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [mor].[CONOPS_MOR_CM_HOURLY_CRUSHER_THROUGHPUT_V]  
AS  
