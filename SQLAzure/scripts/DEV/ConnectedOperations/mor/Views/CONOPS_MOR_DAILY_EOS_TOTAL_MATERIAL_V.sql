CREATE VIEW [mor].[CONOPS_MOR_DAILY_EOS_TOTAL_MATERIAL_V] AS

  
  
  
  
--select * from [mor].[CONOPS_MOR_DAILY_EOS_TOTAL_MATERIAL_V]  
CREATE VIEW [mor].[CONOPS_MOR_DAILY_EOS_TOTAL_MATERIAL_V]  
AS  
