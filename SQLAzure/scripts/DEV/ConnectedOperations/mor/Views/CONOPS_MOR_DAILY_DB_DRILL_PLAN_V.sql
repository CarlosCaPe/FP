CREATE VIEW [mor].[CONOPS_MOR_DAILY_DB_DRILL_PLAN_V] AS
  
  
  
  
  
--select * from [mor].[CONOPS_MOR_DAILY_DB_DRILL_PLAN_V] where shiftflag = 'prev'  
CREATE VIEW [mor].[CONOPS_MOR_DAILY_DB_DRILL_PLAN_V]  
AS  
...
        WHERE [ds].[SITE_CODE] = 'MOR' AND DRILL_ID IS NOT NULL  
