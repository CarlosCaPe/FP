CREATE VIEW [mor].[CONOPS_MOR_TM_TRAFFIC_STOCKPILE_V] AS
...
--SELECT * FROM [mor].[CONOPS_MOR_TM_TRAFFIC_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [mor].[CONOPS_MOR_TM_TRAFFIC_STOCKPILE_V]      
AS      
 ...
 WITH STOCKPILE AS (    
  ...
  LEFT JOIN [mor].[PIT_LOC_C] loc WITH (NOLOCK)    
