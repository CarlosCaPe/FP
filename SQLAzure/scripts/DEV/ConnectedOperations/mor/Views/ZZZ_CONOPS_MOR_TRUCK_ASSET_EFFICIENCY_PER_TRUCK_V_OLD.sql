CREATE VIEW [mor].[ZZZ_CONOPS_MOR_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V_OLD] AS





--select * from [mor].[CONOPS_MOR_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]
CREATE VIEW [mor].[CONOPS_MOR_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V_OLD] 
AS
