CREATE VIEW [mor].[CONOPS_MOR_OPERATOR_HAS_LATE_START_V] AS
...
CREATE VIEW [mor].[CONOPS_MOR_OPERATOR_HAS_LATE_START_V]     
AS    
...
SELECT DISTINCT oper.shiftindex
    ...
    FROM MOR.CONOPS_MOR_SHIFT_INFO_V (nolock) AS eroot
