CREATE VIEW [mor].[CONOPS_MOR_DAILY_MATERIAL_DELIVERED_TO_CHRUSHER_V] AS


  
  
  
--select * from [mor].[CONOPS_MOR_DAILY_MATERIAL_DELIVERED_TO_CHRUSHER_V] WITH (NOLOCK)  
CREATE VIEW [mor].[CONOPS_MOR_DAILY_MATERIAL_DELIVERED_TO_CHRUSHER_V]   
AS  
