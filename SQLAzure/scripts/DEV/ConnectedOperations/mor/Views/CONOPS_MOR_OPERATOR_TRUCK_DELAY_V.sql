CREATE VIEW [mor].[CONOPS_MOR_OPERATOR_TRUCK_DELAY_V] AS



-- SELECT * FROM [mor].[CONOPS_MOR_OPERATOR_TRUCK_DELAY_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [mor].[CONOPS_MOR_OPERATOR_TRUCK_DELAY_V] 
AS
