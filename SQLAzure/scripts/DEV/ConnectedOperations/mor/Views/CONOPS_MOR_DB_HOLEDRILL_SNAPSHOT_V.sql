CREATE VIEW [mor].[CONOPS_MOR_DB_HOLEDRILL_SNAPSHOT_V] AS




--SELECT * FROM [MOR].[CONOPS_MOR_DB_HOLEDRILL_SNAPSHOT_V] WHERE shiftflag = 'prev'

CREATE VIEW [mor].[CONOPS_MOR_DB_HOLEDRILL_SNAPSHOT_V]
AS
