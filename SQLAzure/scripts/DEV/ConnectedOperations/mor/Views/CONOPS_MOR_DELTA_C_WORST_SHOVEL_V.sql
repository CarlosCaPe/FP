CREATE VIEW [mor].[CONOPS_MOR_DELTA_C_WORST_SHOVEL_V] AS


--select * from [mor].[CONOPS_MOR_DELTA_C_WORST_SHOVEL_V]
CREATE VIEW [mor].[CONOPS_MOR_DELTA_C_WORST_SHOVEL_V] 
AS
