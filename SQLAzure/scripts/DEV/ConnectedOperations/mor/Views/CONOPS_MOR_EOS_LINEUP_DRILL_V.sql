CREATE VIEW [mor].[CONOPS_MOR_EOS_LINEUP_DRILL_V] AS

  
  
  
--select * from [mor].[CONOPS_MOR_EOS_LINEUP_DRILL_V] WHERE shiftflag = 'curr'  
CREATE VIEW [mor].[CONOPS_MOR_EOS_LINEUP_DRILL_V]  
AS  
