CREATE VIEW [mor].[ZZZ_CONOPS_MOR_SP_WORST_LOAD_TIME_V_OLD] AS
...
CREATE VIEW [mor].[CONOPS_MOR_SP_WORST_LOAD_TIME_V_OLD]
AS
...
ON a.shiftid = d.shiftid and b.excav = d.excav AND a.siteflag = 'MOR'
...
(DumpingAtCrusher + DumpingatStockpile) as dumpingtarget,LoadingAssetEfficiency AS AssetEfficiencyTarget
