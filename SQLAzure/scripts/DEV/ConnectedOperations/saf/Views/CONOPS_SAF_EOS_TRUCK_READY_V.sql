CREATE VIEW [saf].[CONOPS_SAF_EOS_TRUCK_READY_V] AS
  
  
  
--SELECT * FROM [saf].[CONOPS_SAF_EOS_TRUCK_READY_V] WHERE shiftflag = 'curr' order by datetime  
CREATE VIEW [saf].[CONOPS_SAF_EOS_TRUCK_READY_V]  
AS  
