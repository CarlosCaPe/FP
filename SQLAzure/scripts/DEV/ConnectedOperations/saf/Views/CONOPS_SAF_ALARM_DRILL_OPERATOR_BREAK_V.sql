CREATE VIEW [saf].[CONOPS_SAF_ALARM_DRILL_OPERATOR_BREAK_V] AS

-- SELECT * FROM [saf].[CONOPS_SAF_ALARM_DRILL_OPERATOR_BREAK_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [saf].[CONOPS_SAF_ALARM_DRILL_OPERATOR_BREAK_V]
AS
...
          	   STATUS_DURATION,
          	   OPERATORID
   		FROM [saf].[DRILL_UTILIZATION] [D] WITH (NOLOCK)
