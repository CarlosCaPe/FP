CREATE VIEW [saf].[CONOPS_SAF_OPERATOR_TRUCK_DETAIL_DELTA_C_V] AS



  
     
-- SELECT * FROM [saf].[CONOPS_SAF_OPERATOR_TRUCK_DETAIL_DELTA_C_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'      
CREATE VIEW [saf].[CONOPS_SAF_OPERATOR_TRUCK_DETAIL_DELTA_C_V]       
AS      
