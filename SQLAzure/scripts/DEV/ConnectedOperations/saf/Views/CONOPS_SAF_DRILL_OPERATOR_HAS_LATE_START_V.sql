CREATE VIEW [saf].[CONOPS_SAF_DRILL_OPERATOR_HAS_LATE_START_V] AS



-- SELECT * FROM [saf].[CONOPS_SAF_DRILL_OPERATOR_HAS_LATE_START_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [saf].[CONOPS_SAF_DRILL_OPERATOR_HAS_LATE_START_V] 
AS
