CREATE VIEW [saf].[CONOPS_SAF_CM_DISPATCH_SUMMARY_V] AS




-- SELECT * FROM [saf].[CONOPS_SAF_CM_DISPATCH_SUMMARY_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'PREV'  
CREATE VIEW [saf].[CONOPS_SAF_CM_DISPATCH_SUMMARY_V]  
AS  
	...
	NrOfLoad AS (
		...
		WHERE site_code = 'SAF' AND DUMPASN = 'CRUSHER'
