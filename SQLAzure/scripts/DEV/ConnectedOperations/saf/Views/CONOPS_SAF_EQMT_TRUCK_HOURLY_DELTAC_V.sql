CREATE VIEW [saf].[CONOPS_SAF_EQMT_TRUCK_HOURLY_DELTAC_V] AS



--select * from [saf].[CONOPS_SAF_EQMT_TRUCK_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = '708'
CREATE VIEW [saf].[CONOPS_SAF_EQMT_TRUCK_HOURLY_DELTAC_V]
AS
