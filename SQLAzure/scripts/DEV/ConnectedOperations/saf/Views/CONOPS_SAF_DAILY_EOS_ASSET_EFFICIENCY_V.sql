CREATE VIEW [saf].[CONOPS_SAF_DAILY_EOS_ASSET_EFFICIENCY_V] AS
...
--SELECT * FROM [SAF].[CONOPS_SAF_DAILY_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [saf].[CONOPS_SAF_DAILY_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [SAF].[CONOPS_SAF_DAILY_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [SAF].[CONOPS_SAF_DAILY_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [SAF].[CONOPS_SAF_DAILY_DRILL_ASSET_EFFICIENCY_V]
)
...
FROM(
	...
	LEFT JOIN [SAF].[CONOPS_SAF_EQMT_ASSET_EFFICIENCY_TARGET_V] tg
