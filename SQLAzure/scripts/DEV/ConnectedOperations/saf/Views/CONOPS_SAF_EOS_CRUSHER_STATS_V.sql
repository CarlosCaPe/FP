CREATE VIEW [saf].[CONOPS_SAF_EOS_CRUSHER_STATS_V] AS



--SELECT * FROM [saf].[CONOPS_SAF_EOS_CRUSHER_STATS_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [saf].[CONOPS_SAF_EOS_CRUSHER_STATS_V]
AS
