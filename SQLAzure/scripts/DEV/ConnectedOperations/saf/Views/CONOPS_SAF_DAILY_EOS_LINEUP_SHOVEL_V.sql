CREATE VIEW [saf].[CONOPS_SAF_DAILY_EOS_LINEUP_SHOVEL_V] AS



-- SELECT * FROM [saf].[CONOPS_SAF_DAILY_EOS_LINEUP_SHOVEL_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [saf].[CONOPS_SAF_DAILY_EOS_LINEUP_SHOVEL_V] 
AS
