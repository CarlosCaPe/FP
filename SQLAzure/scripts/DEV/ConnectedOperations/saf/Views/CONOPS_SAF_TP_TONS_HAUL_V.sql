CREATE VIEW [saf].[CONOPS_SAF_TP_TONS_HAUL_V] AS

--select * from [SAF].[CONOPS_SAF_TP_TONS_HAUL_V]
CREATE VIEW [SAF].[CONOPS_SAF_TP_TONS_HAUL_V] 
AS
...
LEFT JOIN [SAF].[CONOPS_SAF_EQMT_TIME_CATEGORY_V] [tc]
