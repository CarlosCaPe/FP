CREATE VIEW [saf].[CONOPS_SAF_EQMT_PAYLOAD_CATEGORY_TARGET_V] AS
...
-- SELECT * FROM [saf].[CONOPS_SAF_EQMT_PAYLOAD_CATEGORY_TARGET_V] WHERE shiftindex = '38916'  
CREATE VIEW [saf].[CONOPS_SAF_EQMT_PAYLOAD_CATEGORY_TARGET_V]  
AS  
