CREATE VIEW [saf].[CONOPS_SAF_DELTA_C_WORST_SHOVEL_V] AS


--select * from [saf].[CONOPS_SAF_DELTA_C_WORST_SHOVEL_V]
CREATE VIEW [saf].[CONOPS_SAF_DELTA_C_WORST_SHOVEL_V] 
AS
