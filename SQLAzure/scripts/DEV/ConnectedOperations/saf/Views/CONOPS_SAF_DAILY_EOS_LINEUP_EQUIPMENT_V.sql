CREATE VIEW [saf].[CONOPS_SAF_DAILY_EOS_LINEUP_EQUIPMENT_V] AS
  
  
  
-- SELECT * FROM [saf].[CONOPS_SAF_DAILY_EOS_LINEUP_EQUIPMENT_V]  WHERE [shiftflag] = 'CURR'  
CREATE VIEW [saf].[CONOPS_SAF_DAILY_EOS_LINEUP_EQUIPMENT_V]   
AS  
...
FROM [saf].[CONOPS_SAF_DAILY_EOS_LINEUP_SHOVEL_V]   
...
FROM [saf].[CONOPS_SAF_EOS_SHIFT_INFO_V]  
...
FROM [saf].[CONOPS_SAF_DAILY_EOS_LINEUP_TRUCK_V]  
GROUP BY siteflag, shiftflag,shiftid  
...
FROM [saf].[CONOPS_SAF_DAILY_EOS_LINEUP_DRILL_V]  
GROUP BY siteflag, shiftflag, shiftid  
...
FROM [saf].[CONOPS_SAF_DAILY_EOS_LINEUP_EQMT_OTHER_V]  
