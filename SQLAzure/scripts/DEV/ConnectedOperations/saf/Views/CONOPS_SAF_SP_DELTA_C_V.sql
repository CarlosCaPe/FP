CREATE VIEW [saf].[CONOPS_SAF_SP_DELTA_C_V] AS
  
  
CREATE VIEW [saf].[CONOPS_SAF_SP_DELTA_C_V]  
AS  
...
EmptyTravel,  
LoadedTravel  
FROM [SAF].[CONOPS_SAF_SP_DELTA_C_AVG_V]  
),  
...
stat.eqmtcurrstatus  
FROM DELTAC dc  
LEFT JOIN [SAF].[CONOPS_SAF_SHOVEL_POPUP] [pop] WITH (NOLOCK)
