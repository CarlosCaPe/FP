CREATE VIEW [saf].[CONOPS_SAF_DAILY_EOS_TONS_CRUSHED_GRADES_V] AS
  
  
  
  
  
--SELECT * FROM [saf].[CONOPS_SAF_DAILY_EOS_TONS_CRUSHED_GRADES_V] WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [saf].[CONOPS_SAF_DAILY_EOS_TONS_CRUSHED_GRADES_V]    
AS    
