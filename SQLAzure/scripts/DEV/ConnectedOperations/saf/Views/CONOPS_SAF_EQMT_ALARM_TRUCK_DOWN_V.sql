CREATE VIEW [saf].[CONOPS_SAF_EQMT_ALARM_TRUCK_DOWN_V] AS

-- SELECT * FROM [saf].[CONOPS_SAF_EQMT_ALARM_TRUCKL_DOWN_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [saf].[CONOPS_SAF_EQMT_ALARM_TRUCK_DOWN_V]
AS
