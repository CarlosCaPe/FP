CREATE VIEW [saf].[CONOPS_SAF_DB_HOLEDRILL_SNAPSHOT_V] AS




--SELECT * FROM [SAF].[CONOPS_SAF_DB_HOLEDRILL_SNAPSHOT_V] WHERE shiftflag = 'prev'

CREATE VIEW [saf].[CONOPS_SAF_DB_HOLEDRILL_SNAPSHOT_V]
AS
