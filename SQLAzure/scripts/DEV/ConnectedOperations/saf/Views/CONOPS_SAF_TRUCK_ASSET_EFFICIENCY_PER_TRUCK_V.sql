CREATE VIEW [saf].[CONOPS_SAF_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] AS




--select * from [saf].[CONOPS_SAF_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]
CREATE VIEW [saf].[CONOPS_SAF_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] 
AS
