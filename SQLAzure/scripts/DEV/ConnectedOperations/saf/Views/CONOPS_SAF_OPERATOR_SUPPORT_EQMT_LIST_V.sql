CREATE VIEW [saf].[CONOPS_SAF_OPERATOR_SUPPORT_EQMT_LIST_V] AS
...
-- SELECT * FROM [SAF].[CONOPS_SAF_OPERATOR_SUPPORT_EQMT_LIST_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [SAF].[CONOPS_SAF_OPERATOR_SUPPORT_EQMT_LIST_V]
AS
