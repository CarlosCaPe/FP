CREATE VIEW [saf].[CONOPS_SAF_DB_EQMT_STATUS_V] AS


  
  
--SELECT * FROM [SAF].[CONOPS_SAF_DB_EQMT_STATUS_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [SAF].[CONOPS_SAF_DB_EQMT_STATUS_V]  
AS  
