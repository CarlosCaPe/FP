CREATE VIEW [saf].[CONOPS_SAF_ALARM_TRUCK_SHOVEL_OPERATOR_BREAK_V] AS

-- SELECT * FROM [saf].[CONOPS_SAF_ALARM_TRUCK_SHOVEL_OPERATOR_BREAK_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [saf].[CONOPS_SAF_ALARM_TRUCK_SHOVEL_OPERATOR_BREAK_V]
AS
