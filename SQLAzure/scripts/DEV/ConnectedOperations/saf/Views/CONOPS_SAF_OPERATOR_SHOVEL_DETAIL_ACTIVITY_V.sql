CREATE VIEW [saf].[CONOPS_SAF_OPERATOR_SHOVEL_DETAIL_ACTIVITY_V] AS




-- SELECT * FROM [SAF].[CONOPS_SAF_OPERATOR_SHOVEL_DETAIL_ACTIVITY_V] WITH (NOLOCK) WHERE ShiftFlag = 'PREV' OperatorId = '60030149'
CREATE VIEW [SAF].[CONOPS_SAF_OPERATOR_SHOVEL_DETAIL_ACTIVITY_V] 
AS
...
SELECT [op].shiftflag
	...
	,[oa].Reasons
	,[oa].Generated
FROM [SAF].[CONOPS_SAF_OPERATOR_SHOVEL_LIST_V] [op] WITH (NOLOCK) 
