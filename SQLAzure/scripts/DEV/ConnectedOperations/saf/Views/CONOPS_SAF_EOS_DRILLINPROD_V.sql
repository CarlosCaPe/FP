CREATE VIEW [saf].[CONOPS_SAF_EOS_DRILLINPROD_V] AS


--select * from [dbo].[CONOPS_SAF_EOS_DRILLINPROD_V] where shiftflag = 'prev'
CREATE VIEW [saf].[CONOPS_SAF_EOS_DRILLINPROD_V]
AS
...
FROM [saf].[CONOPS_SAF_HOURLY_DRILL_ASSET_EFFICIENCY_V] a
