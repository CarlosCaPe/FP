CREATE VIEW [saf].[CONOPS_SAF_TM_HAUL_STATUS_V] AS



-- SELECT * FROM [saf].[CONOPS_SAF_TM_HAUL_STATUS_V] WITH (NOLOCK)
CREATE VIEW [saf].[CONOPS_SAF_TM_HAUL_STATUS_V] 
AS
	...
	LEFT JOIN [saf].[CONOPS_SAF_DELTA_C_DETAIL_V] [dt]
