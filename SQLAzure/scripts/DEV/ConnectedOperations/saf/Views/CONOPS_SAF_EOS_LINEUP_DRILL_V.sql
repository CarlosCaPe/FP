CREATE VIEW [saf].[CONOPS_SAF_EOS_LINEUP_DRILL_V] AS
  
  
  
--select * from [saf].[CONOPS_SAF_EOS_LINEUP_DRILL_V] where shiftflag = 'curr'  
CREATE VIEW [saf].[CONOPS_SAF_EOS_LINEUP_DRILL_V]  
AS  
