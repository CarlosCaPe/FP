CREATE VIEW [saf].[CONOPS_SAF_EOS_IOS_STOCKPILE_HOURLY_V] AS





--SELECT * FROM [SAF].[CONOPS_SAF_EOS_IOS_STOCKPILE_HOURLY_V] WHERE shiftflag = 'PREV'
CREATE VIEW [SAF].[CONOPS_SAF_EOS_IOS_STOCKPILE_HOURLY_V]
AS
...
LEFT JOIN [SAF].[CONOPS_SAF_SHIFT_INFO_V] s WITH (NOLOCK)  
