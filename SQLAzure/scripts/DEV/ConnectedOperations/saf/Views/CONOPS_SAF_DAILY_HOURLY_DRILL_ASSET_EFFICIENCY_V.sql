CREATE VIEW [saf].[CONOPS_SAF_DAILY_HOURLY_DRILL_ASSET_EFFICIENCY_V] AS
  
  
  
--select * from [saf].[CONOPS_SAF_DAILY_HOURLY_DRILL_ASSET_EFFICIENCY_V] WITH (NOLOCK)  
CREATE VIEW [saf].[CONOPS_SAF_DAILY_HOURLY_DRILL_ASSET_EFFICIENCY_V]  
AS  
