CREATE VIEW [saf].[ZZZ_CONOPS_SAF_TP_DELTA_C_AVG_V_OLD] AS




--SELECT * FROM [saf].[CONOPS_SAF_TP_DELTA_C_AVG_V] WITH (NOLOCK)
CREATE VIEW [saf].[CONOPS_SAF_TP_DELTA_C_AVG_V_OLD] 
AS
