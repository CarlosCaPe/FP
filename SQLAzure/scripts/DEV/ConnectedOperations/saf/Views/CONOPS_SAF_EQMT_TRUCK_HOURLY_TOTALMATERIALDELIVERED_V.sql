CREATE VIEW [saf].[CONOPS_SAF_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] AS
...
--select * from [saf].[CONOPS_SAF_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] order by shiftseq  
CREATE VIEW [saf].[CONOPS_SAF_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V]  
AS  
