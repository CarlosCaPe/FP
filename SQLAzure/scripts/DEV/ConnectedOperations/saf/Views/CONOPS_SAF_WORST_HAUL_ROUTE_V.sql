CREATE VIEW [saf].[CONOPS_SAF_WORST_HAUL_ROUTE_V] AS




-- SELECT * FROM [saf].[CONOPS_SAF_WORST_HAUL_ROUTE_V] WITH (NOLOCK)
CREATE VIEW [saf].[CONOPS_SAF_WORST_HAUL_ROUTE_V] 
AS
