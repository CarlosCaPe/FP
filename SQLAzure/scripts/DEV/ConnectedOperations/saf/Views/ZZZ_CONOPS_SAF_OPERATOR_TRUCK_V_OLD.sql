CREATE VIEW [saf].[ZZZ_CONOPS_SAF_OPERATOR_TRUCK_V_OLD] AS
...
-- SELECT * FROM [saf].[CONOPS_SAF_OPERATOR_TRUCK_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' AND OperatorStatus != 'Active'
