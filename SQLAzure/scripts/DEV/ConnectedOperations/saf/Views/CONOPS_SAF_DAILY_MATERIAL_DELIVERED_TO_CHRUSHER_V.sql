CREATE VIEW [saf].[CONOPS_SAF_DAILY_MATERIAL_DELIVERED_TO_CHRUSHER_V] AS


  
  
  
--select * from [saf].[CONOPS_SAF_DAILY_MATERIAL_DELIVERED_TO_CHRUSHER_V]  
CREATE VIEW [saf].[CONOPS_SAF_DAILY_MATERIAL_DELIVERED_TO_CHRUSHER_V]   
AS  
 ...
 GROUP BY cl.siteflag, SHIFTFLAG, cl.CrusherLoc, [ct].[Target], cl.ShiftDuration, NrDumps,cl.shiftid  
