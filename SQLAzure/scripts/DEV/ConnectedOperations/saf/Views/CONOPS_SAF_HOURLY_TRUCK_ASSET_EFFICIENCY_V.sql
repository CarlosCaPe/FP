CREATE VIEW [saf].[CONOPS_SAF_HOURLY_TRUCK_ASSET_EFFICIENCY_V] AS




--select * from [saf].[CONOPS_SAF_HOURLY_TRUCK_ASSET_EFFICIENCY_V] WITH (NOLOCK)
CREATE VIEW [saf].[CONOPS_SAF_HOURLY_TRUCK_ASSET_EFFICIENCY_V] 
AS
