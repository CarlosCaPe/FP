CREATE VIEW [cer].[CONOPS_CER_CM_HOURLY_CRUSHER_THROUGHPUT_V] AS
...
-- SELECT * FROM [cer].[CONOPS_CER_CM_HOURLY_CRUSHER_THROUGHPUT_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [cer].[CONOPS_CER_CM_HOURLY_CRUSHER_THROUGHPUT_V]  
AS  
