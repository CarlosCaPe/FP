CREATE VIEW [cer].[CONOPS_CER_EOS_LINEUP_EQUIPMENT_V] AS



-- SELECT * FROM [cer].[CONOPS_CER_EOS_LINEUP_EQUIPMENT_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [cer].[CONOPS_CER_EOS_LINEUP_EQUIPMENT_V] 
AS
...
FROM [cer].[CONOPS_CER_EOS_LINEUP_SHOVEL_V] 
...
FROM [cer].[CONOPS_CER_EOS_LINEUP_TRUCK_V]
GROUP BY siteflag, shiftflag,shiftid
...
FROM [cer].[CONOPS_CER_EOS_LINEUP_DRILL_V]
GROUP BY siteflag, shiftflag, shiftid
...
FROM [cer].[CONOPS_CER_EOS_LINEUP_EQMT_OTHER_V]
