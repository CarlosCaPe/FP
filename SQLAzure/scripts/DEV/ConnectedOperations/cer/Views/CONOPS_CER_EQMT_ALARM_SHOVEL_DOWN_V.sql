CREATE VIEW [cer].[CONOPS_CER_EQMT_ALARM_SHOVEL_DOWN_V] AS

-- SELECT * FROM [cer].[CONOPS_CER_EQMT_ALARM_SHOVEL_DOWN_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [cer].[CONOPS_CER_EQMT_ALARM_SHOVEL_DOWN_V]
AS
