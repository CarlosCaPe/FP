CREATE VIEW [cer].[CONOPS_CER_DB_HOLEDRILL_SNAPSHOT_V] AS




--SELECT * FROM [cer].[CONOPS_CER_DB_HOLEDRILL_SNAPSHOT_V] WHERE shiftflag = 'prev'

CREATE VIEW [cer].[CONOPS_CER_DB_HOLEDRILL_SNAPSHOT_V]
AS
...
WHEN si.ShiftDuration = '43200' THEN 153 ELSE 
CAST(153/(si.ShiftDuration/3600.0) AS INT) END AS HoleTarget
FROM Final fn
