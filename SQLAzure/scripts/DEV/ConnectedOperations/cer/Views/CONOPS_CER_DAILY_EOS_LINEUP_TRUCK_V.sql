CREATE VIEW [cer].[CONOPS_CER_DAILY_EOS_LINEUP_TRUCK_V] AS
...
-- SELECT * FROM [cer].[CONOPS_CER_DAILY_EOS_LINEUP_TRUCK_V]  WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [cer].[CONOPS_CER_DAILY_EOS_LINEUP_TRUCK_V] 
AS
