CREATE VIEW [cer].[ZZZ_CONOPS_CER_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V_OLD] AS


--select * from [cer].[CONOPS_CER_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V_OLD]
CREATE VIEW [cer].[CONOPS_CER_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V_OLD]
AS
