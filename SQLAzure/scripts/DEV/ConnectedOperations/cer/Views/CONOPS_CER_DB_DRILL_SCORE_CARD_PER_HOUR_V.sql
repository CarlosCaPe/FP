CREATE VIEW [cer].[CONOPS_CER_DB_DRILL_SCORE_CARD_PER_HOUR_V] AS



--select * from [cer].[CONOPS_CER_DB_DRILL_SCORE_CARD_PER_HOUR_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [cer].[CONOPS_CER_DB_DRILL_SCORE_CARD_PER_HOUR_V]
AS
