CREATE VIEW [cer].[CONOPS_CER_DAILY_EOS_TRUCK_NON_UTILIZED_REASON_V] AS
  
  
  
--SELECT * FROM [CER].[CONOPS_CER_DAILY_EOS_TRUCK_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [CER].[CONOPS_CER_DAILY_EOS_TRUCK_NON_UTILIZED_REASON_V]    
AS    
