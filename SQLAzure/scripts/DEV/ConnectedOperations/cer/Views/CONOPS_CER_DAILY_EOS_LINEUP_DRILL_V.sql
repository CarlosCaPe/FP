CREATE VIEW [cer].[CONOPS_CER_DAILY_EOS_LINEUP_DRILL_V] AS
...
--select * from [cer].[CONOPS_CER_DAILY_EOS_LINEUP_DRILL_V] Where shiftflag = 'prev'    
CREATE VIEW [cer].[CONOPS_CER_DAILY_EOS_LINEUP_DRILL_V]    
AS    
...
FROM [cer].[DRILL_UTILIZATION] WITH (NOLOCK))    
