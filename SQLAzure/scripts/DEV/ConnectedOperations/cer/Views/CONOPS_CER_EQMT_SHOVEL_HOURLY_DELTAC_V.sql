CREATE VIEW [cer].[CONOPS_CER_EQMT_SHOVEL_HOURLY_DELTAC_V] AS




--select * from [CER].[CONOPS_CER_EQMT_SHOVEL_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = 's08'
CREATE VIEW [cer].[CONOPS_CER_EQMT_SHOVEL_HOURLY_DELTAC_V]
AS
