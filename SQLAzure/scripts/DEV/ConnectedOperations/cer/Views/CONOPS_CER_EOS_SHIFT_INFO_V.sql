CREATE VIEW [cer].[CONOPS_CER_EOS_SHIFT_INFO_V] AS
...
--select * from [cer].[CONOPS_CER_EOS_SHIFT_INFO_V] order by shiftflag  
CREATE VIEW [cer].[CONOPS_CER_EOS_SHIFT_INFO_V]  
AS  
