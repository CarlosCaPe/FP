CREATE VIEW [cer].[CONOPS_CER_DAILY_SHOVEL_SHIFT_TARGET_V] AS
  
  
  
--select * from [cer].[CONOPS_CER_DAILY_SHOVEL_SHIFT_TARGET_V] where shiftflag = 'curr'  
CREATE VIEW [cer].[CONOPS_CER_DAILY_SHOVEL_SHIFT_TARGET_V]  
AS  
