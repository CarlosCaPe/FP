CREATE VIEW [cer].[CONOPS_CER_DAILY_DELTA_C_DETAIL_V] AS
...
--select * from [CER].[CONOPS_CER_DAILY_DELTA_C_DETAIL_V] 
CREATE VIEW [CER].[CONOPS_CER_DAILY_DELTA_C_DETAIL_V] 
AS
