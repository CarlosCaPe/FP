CREATE VIEW [cer].[CONOPS_CER_EOS_DRILLINPROD_V] AS


--select * from [dbo].[CONOPS_CER_EOS_DRILLINPROD_V] where shiftflag = 'prev'
CREATE VIEW [cer].[CONOPS_CER_EOS_DRILLINPROD_V]
AS
...
FROM [cer].[CONOPS_CER_HOURLY_DRILL_ASSET_EFFICIENCY_V] a
