CREATE VIEW [cer].[CONOPS_CER_EQMT_TRUCK_HOURLY_NRDUMP_V] AS

--SELECT * FROM [cer].[CONOPS_CER_EQMT_TRUCK_HOURLY_NRDUMP_V] WHERE shiftflag = 'prev' and equipment = 'C101'
CREATE VIEW [cer].[CONOPS_CER_EQMT_TRUCK_HOURLY_NRDUMP_V]
AS
...
SELECT
	...
	DUMPTIME_HOS AS HOS
FROM CER.SHIFT_DUMP_DETAIL_V WITH (NOLOCK)
