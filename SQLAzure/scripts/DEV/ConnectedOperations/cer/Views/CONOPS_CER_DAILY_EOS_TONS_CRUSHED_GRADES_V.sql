CREATE VIEW [cer].[CONOPS_CER_DAILY_EOS_TONS_CRUSHED_GRADES_V] AS
...
--SELECT * FROM [cer].[CONOPS_CER_DAILY_EOS_TONS_CRUSHED_GRADES_V] WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [cer].[CONOPS_CER_DAILY_EOS_TONS_CRUSHED_GRADES_V]    
AS    
 ...
 CrLocShift AS (  
     SELECT a.SHIFTINDEX,  
      ...
      a.SITEFLAG,  
      CrusherLoc  
     FROM CrLoc, [cer].[CONOPS_CER_EOS_SHIFT_INFO_V] a WITH (NOLOCK)  
 ),  
