CREATE VIEW [cer].[CONOPS_CER_DB_EQMT_STATUS_V] AS


  
  
--SELECT * FROM [CER].[CONOPS_CER_DB_EQMT_STATUS_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [CER].[CONOPS_CER_DB_EQMT_STATUS_V]  
AS  
