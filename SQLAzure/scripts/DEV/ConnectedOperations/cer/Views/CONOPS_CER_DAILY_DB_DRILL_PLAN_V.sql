CREATE VIEW [cer].[CONOPS_CER_DAILY_DB_DRILL_PLAN_V] AS
...
--select * from [cer].[CONOPS_CER_DAILY_DB_DRILL_PLAN_V] where shiftflag = 'prev'  
CREATE VIEW [cer].[CONOPS_CER_DAILY_DB_DRILL_PLAN_V]  
AS  
...
        WHERE [ds].[SITE_CODE] = 'CER' AND DRILL_ID IS NOT NULL  
