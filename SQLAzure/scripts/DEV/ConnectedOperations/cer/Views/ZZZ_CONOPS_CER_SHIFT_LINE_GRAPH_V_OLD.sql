CREATE VIEW [cer].[ZZZ_CONOPS_CER_SHIFT_LINE_GRAPH_V_OLD] AS
...
--SELECT * FROM [cer].[CONOPS_CER_SHIFT_LINE_GRAPH_V] where shiftflag = 'curr' order by shiftseq asc

CREATE VIEW [cer].[CONOPS_CER_SHIFT_LINE_GRAPH_V_OLD]
AS
