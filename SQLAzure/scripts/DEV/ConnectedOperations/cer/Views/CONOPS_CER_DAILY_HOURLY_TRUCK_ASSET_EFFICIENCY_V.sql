CREATE VIEW [cer].[CONOPS_CER_DAILY_HOURLY_TRUCK_ASSET_EFFICIENCY_V] AS




--select * from [cer].[CONOPS_CER_DAILY_HOURLY_TRUCK_ASSET_EFFICIENCY_V] WITH (NOLOCK)
CREATE VIEW [cer].[CONOPS_CER_DAILY_HOURLY_TRUCK_ASSET_EFFICIENCY_V]
AS
