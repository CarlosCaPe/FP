CREATE VIEW [cer].[CONOPS_CER_TM_TRAFFIC_STOCKPILE_V] AS
...
--SELECT * FROM [cer].[CONOPS_CER_TM_TRAFFIC_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [cer].[CONOPS_CER_TM_TRAFFIC_STOCKPILE_V]      
AS      
 ...
 WITH STOCKPILE AS (    
  ...
  LEFT JOIN [cer].[PIT_LOC_C] loc WITH (NOLOCK)    
