CREATE VIEW [cer].[CONOPS_CER_OPERATOR_SUPPORT_EQMT_LIST_V] AS
...
-- SELECT * FROM [CER].[CONOPS_CER_OPERATOR_SUPPORT_EQMT_LIST_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [cer].[CONOPS_CER_OPERATOR_SUPPORT_EQMT_LIST_V]
AS
