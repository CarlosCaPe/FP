CREATE VIEW [cer].[CONOPS_CER_DAILY_EOS_ASSET_EFFICIENCY_V] AS
...
--SELECT * FROM [CER].[CONOPS_CER_DAILY_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [cer].[CONOPS_CER_DAILY_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [CER].[CONOPS_CER_DAILY_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [CER].[CONOPS_CER_DAILY_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [CER].[CONOPS_CER_DAILY_DRILL_ASSET_EFFICIENCY_V]
)
