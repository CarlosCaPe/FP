CREATE VIEW [cer].[CONOPS_CER_TM_TRAFFIC_CRUSHER_V] AS
  
    
    
    
    
--SELECT * FROM [cer].[CONOPS_CER_TM_TRAFFIC_CRUSHER_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [cer].[CONOPS_CER_TM_TRAFFIC_CRUSHER_V]      
AS      
 ...
 WITH CRUSHER AS (    
  ...
  WHERE loc.[FieldId] in ('MILLCHAN','HIDROCHAN','MILLCRUSH1','MILLCRUSH2')    
 )    
