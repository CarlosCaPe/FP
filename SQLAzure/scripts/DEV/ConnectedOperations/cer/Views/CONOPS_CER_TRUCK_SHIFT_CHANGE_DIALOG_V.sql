CREATE VIEW [cer].[CONOPS_CER_TRUCK_SHIFT_CHANGE_DIALOG_V] AS



-- SELECT * FROM [cer].[CONOPS_CER_TRUCK_SHIFT_CHANGE_DIALOG_V]
CREATE VIEW [cer].[CONOPS_CER_TRUCK_SHIFT_CHANGE_DIALOG_V]
AS
...
FROM (
	...
	LEFT JOIN [CER].[CONOPS_CER_TRUCK_DETAIL_V] [TruckDetail] WITH (NOLOCK)
