CREATE VIEW [cer].[CONOPS_CER_OPERATOR_SUPPORT_EQMT_LOGIN_V] AS



-- SELECT * FROM [cer].[CONOPS_CER_OPERATOR_SUPPORT_EQMT_LOGIN_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [cer].[CONOPS_CER_OPERATOR_SUPPORT_EQMT_LOGIN_V]
AS
...
        ,[OperatorImageURL]
    FROM [cer].[CONOPS_CER_EQMT_OTHER_V] WITH (NOLOCK)
    WHERE [Operator] != 'NONE'
),
