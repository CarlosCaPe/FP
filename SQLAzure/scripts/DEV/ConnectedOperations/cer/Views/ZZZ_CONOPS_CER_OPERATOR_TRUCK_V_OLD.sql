CREATE VIEW [cer].[ZZZ_CONOPS_CER_OPERATOR_TRUCK_V_OLD] AS
...
-- SELECT * FROM [cer].[CONOPS_CER_OPERATOR_TRUCK_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' AND OperatorStatus = 'Active'
