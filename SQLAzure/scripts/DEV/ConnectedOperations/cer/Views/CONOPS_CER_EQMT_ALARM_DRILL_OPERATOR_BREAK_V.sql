CREATE VIEW [cer].[CONOPS_CER_EQMT_ALARM_DRILL_OPERATOR_BREAK_V] AS


-- SELECT * FROM [cer].[CONOPS_CER_EQMT_ALARM_DRILL_OPERATOR_BREAK_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [cer].[CONOPS_CER_EQMT_ALARM_DRILL_OPERATOR_BREAK_V]
AS
