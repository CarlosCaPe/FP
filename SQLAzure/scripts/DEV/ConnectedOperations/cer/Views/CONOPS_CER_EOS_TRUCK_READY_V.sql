CREATE VIEW [cer].[CONOPS_CER_EOS_TRUCK_READY_V] AS
  
  
  
--SELECT * FROM [cer].[CONOPS_CER_EOS_TRUCK_READY_V] WHERE shiftflag = 'curr' order by datetime  
CREATE VIEW [cer].[CONOPS_CER_EOS_TRUCK_READY_V]  
AS  
