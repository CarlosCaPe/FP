CREATE VIEW [bag].[CONOPS_BAG_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] AS
...
--select * from [bag].[CONOPS_BAG_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] order by shiftseq  
CREATE VIEW [bag].[CONOPS_BAG_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V]  
AS  
