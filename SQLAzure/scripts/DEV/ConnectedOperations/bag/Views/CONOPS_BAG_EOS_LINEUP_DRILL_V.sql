CREATE VIEW [bag].[CONOPS_BAG_EOS_LINEUP_DRILL_V] AS



--select * from [bag].[CONOPS_BAG_EOS_LINEUP_DRILL_V] where shiftflag = 'prev'
CREATE VIEW [BAG].[CONOPS_BAG_EOS_LINEUP_DRILL_V]
AS
...
FROM [bag].[DRILL_UTILIZATION] WITH (NOLOCK)) x)
