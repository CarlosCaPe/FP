CREATE VIEW [bag].[CONOPS_BAG_DAILY_DB_DRILL_SCORE_V] AS
  
  
  
  
  
--select * from [bag].[CONOPS_BAG_DAILY_DB_DRILL_SCORE_V] WITH (NOLOCK) where shiftflag = 'prev'  
CREATE VIEW [bag].[CONOPS_BAG_DAILY_DB_DRILL_SCORE_V]  
AS  
