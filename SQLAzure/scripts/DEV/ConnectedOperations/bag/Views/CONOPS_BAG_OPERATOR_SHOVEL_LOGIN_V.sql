CREATE VIEW [bag].[CONOPS_BAG_OPERATOR_SHOVEL_LOGIN_V] AS


-- SELECT * FROM [BAG].[CONOPS_BAG_OPERATOR_SHOVEL_LOGIN_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [bag].[CONOPS_BAG_OPERATOR_SHOVEL_LOGIN_V] 
AS
