CREATE VIEW [bag].[CONOPS_BAG_DB_HOLEDRILL_SNAPSHOT_V] AS





--SELECT * FROM [bag].[CONOPS_BAG_DB_HOLEDRILL_SNAPSHOT_V] WHERE siteflag = 'bag' and shiftflag = 'prev'

CREATE VIEW [bag].[CONOPS_BAG_DB_HOLEDRILL_SNAPSHOT_V]
AS
...
ORDER BY EFFECTIVEDATE DESC) tg
--WHERE fn.siteflag = 'BAG'
--AND fn.shiftflag = 'prev'
GROUP BY 
fn.siteflag,
fn.shiftflag,
timeseq,
