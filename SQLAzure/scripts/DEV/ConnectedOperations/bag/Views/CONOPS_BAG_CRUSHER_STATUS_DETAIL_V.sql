CREATE VIEW [bag].[CONOPS_BAG_CRUSHER_STATUS_DETAIL_V] AS



--SELECT * FROM [BAG].[CONOPS_BAG_CRUSHER_STATUS_DETAIL_V]
CREATE VIEW [BAG].[CONOPS_BAG_CRUSHER_STATUS_DETAIL_V]
AS
...
SELECT
	...
	CASE PLANT_AREA_NAME
		WHEN 'CrushConvey' THEN 'CRUSHER 2'
