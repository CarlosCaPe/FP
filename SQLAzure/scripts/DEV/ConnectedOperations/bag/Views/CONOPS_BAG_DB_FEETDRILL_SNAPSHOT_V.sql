CREATE VIEW [bag].[CONOPS_BAG_DB_FEETDRILL_SNAPSHOT_V] AS





--SELECT * FROM [bag].[CONOPS_BAG_DB_FEETDRILL_SNAPSHOT_V]

CREATE VIEW [bag].[CONOPS_BAG_DB_FEETDRILL_SNAPSHOT_V]
AS
