CREATE VIEW [bag].[CONOPS_BAG_DRILL_OPERATOR_HAS_LATE_START_V] AS


-- SELECT * FROM [bag].[CONOPS_BAG_DRILL_OPERATOR_HAS_LATE_START_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [bag].[CONOPS_BAG_DRILL_OPERATOR_HAS_LATE_START_V] 
AS
