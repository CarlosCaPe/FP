CREATE VIEW [bag].[CONOPS_BAG_EQMT_ALARM_TRUCK_DOWN_V] AS

-- SELECT * FROM [bag].[CONOPS_BAG_EQMT_ALARM_TRUCKL_DOWN_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [bag].[CONOPS_BAG_EQMT_ALARM_TRUCK_DOWN_V]
AS
