CREATE VIEW [bag].[ZZZ_CONOPS_BAG_OPERATOR_TRUCK_V_OLD] AS
...
-- SELECT * FROM [bag].[CONOPS_BAG_OPERATOR_TRUCK_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' AND OperatorStatus != 'Active'
