CREATE VIEW [bag].[CONOPS_BAG_EQMT_ALARM_DRILL_OPERATOR_BREAK_V] AS


-- SELECT * FROM [bag].[CONOPS_BAG_EQMT_ALARM_DRILL_OPERATOR_BREAK_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [bag].[CONOPS_BAG_EQMT_ALARM_DRILL_OPERATOR_BREAK_V]
AS
