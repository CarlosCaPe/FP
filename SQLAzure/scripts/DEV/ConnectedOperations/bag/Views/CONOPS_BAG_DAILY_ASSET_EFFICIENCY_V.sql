CREATE VIEW [bag].[CONOPS_BAG_DAILY_ASSET_EFFICIENCY_V] AS
...
--select * from [bag].[CONOPS_BAG_DAILY_ASSET_EFFICIENCY_V]
CREATE VIEW [bag].[CONOPS_BAG_DAILY_ASSET_EFFICIENCY_V] 
AS
