CREATE VIEW [bag].[CONOPS_BAG_MATERIAL_DELIVERED_TO_CHRUSHER_V] AS
...
--select * from [bag].[CONOPS_BAG_MATERIAL_DELIVERED_TO_CHRUSHER_V] WITH (NOLOCK)
...
CrLocShift AS (
    SELECT a.siteflag,
           ...
           a.SHIFTDURATION,
           CrusherLoc
    FROM CrLoc, [bag].[CONOPS_BAG_SHIFT_INFO_V] a WITH (NOLOCK)
)
