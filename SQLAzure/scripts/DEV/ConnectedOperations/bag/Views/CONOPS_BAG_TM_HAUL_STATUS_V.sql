CREATE VIEW [bag].[CONOPS_BAG_TM_HAUL_STATUS_V] AS


-- SELECT * FROM [bag].[CONOPS_BAG_TM_HAUL_STATUS_V] WITH (NOLOCK)
CREATE VIEW [bag].[CONOPS_BAG_TM_HAUL_STATUS_V] 
AS
	...
	LEFT JOIN [bag].[CONOPS_BAG_DELTA_C_DETAIL_V] [dt]
