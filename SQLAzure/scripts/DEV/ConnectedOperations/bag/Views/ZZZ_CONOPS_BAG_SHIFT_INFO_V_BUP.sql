CREATE VIEW [bag].[ZZZ_CONOPS_BAG_SHIFT_INFO_V_BUP] AS
...
(CONVERT(int, (DATEDIFF(DD, '7/12/2007', CAST(ShiftStartDateTime as DATE))*2) + 27412 + (SELECT RIGHT(a.[ShiftId],1) - 1))) ShiftIndex
