CREATE VIEW [bag].[CONOPS_BAG_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS


  
    
    
--select * from [bag].[CONOPS_BAG_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq    
CREATE VIEW [bag].[CONOPS_BAG_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]    
AS    
