CREATE VIEW [bag].[CONOPS_BAG_OPERATOR_TRUCK_LIST_V] AS
...
-- SELECT * FROM [bag].[CONOPS_BAG_OPERATOR_TRUCK_LIST_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' 
CREATE VIEW [bag].[CONOPS_BAG_OPERATOR_TRUCK_LIST_V] 
AS
