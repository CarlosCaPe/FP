CREATE VIEW [bag].[CONOPS_BAG_DAILY_DELTA_J_V] AS

--select * from [bag].[CONOPS_BAG_DAILY_DELTA_J_V]
CREATE VIEW [bag].[CONOPS_BAG_DAILY_DELTA_J_V] 
AS
...
SELECT 
	...
	TimeInHour,
	Shiftseq
FROM [bag].[CONOPS_BAG_DAILY_HOURLY_TOTALMATERIALMINED_V]
