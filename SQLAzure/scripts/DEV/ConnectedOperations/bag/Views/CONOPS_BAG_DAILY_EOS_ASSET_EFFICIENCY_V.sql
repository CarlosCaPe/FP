CREATE VIEW [bag].[CONOPS_BAG_DAILY_EOS_ASSET_EFFICIENCY_V] AS



--SELECT * FROM [BAG].[CONOPS_BAG_DAILY_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [BAG].[CONOPS_BAG_DAILY_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [BAG].[CONOPS_BAG_DAILY_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [BAG].[CONOPS_BAG_DAILY_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [BAG].[CONOPS_BAG_DAILY_DRILL_ASSET_EFFICIENCY_V]
)
...
FROM(
	...
	LEFT JOIN [BAG].[CONOPS_BAG_EQMT_ASSET_EFFICIENCY_TARGET_V] tg
