CREATE VIEW [bag].[CONOPS_BAG_DAILY_EOS_IOS_STOCKPILE_HOURLY_V] AS
...
--SELECT * FROM [BAG].[CONOPS_BAG_DAILY_EOS_IOS_STOCKPILE_HOURLY_V] WHERE shiftflag = 'PREV'  
CREATE VIEW [BAG].[CONOPS_BAG_DAILY_EOS_IOS_STOCKPILE_HOURLY_V]  
AS  
...
LEFT JOIN [bag].[CONOPS_BAG_EOS_SHIFT_INFO_V] s WITH (NOLOCK)    
