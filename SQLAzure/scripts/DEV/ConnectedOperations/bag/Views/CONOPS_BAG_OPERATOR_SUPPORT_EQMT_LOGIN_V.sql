CREATE VIEW [bag].[CONOPS_BAG_OPERATOR_SUPPORT_EQMT_LOGIN_V] AS



-- SELECT * FROM [BAG].[CONOPS_BAG_OPERATOR_SUPPORT_EQMT_LOGIN_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [bag].[CONOPS_BAG_OPERATOR_SUPPORT_EQMT_LOGIN_V]
AS
...
        ,[OperatorImageURL]
    FROM [BAG].[CONOPS_BAG_EQMT_OTHER_V] WITH (NOLOCK)
    WHERE [Operator] != 'NONE'
),
