CREATE VIEW [bag].[CONOPS_BAG_DAILY_DB_EQMT_STATUS_V] AS
  
  
  
    
    
--SELECT * FROM [BAG].[CONOPS_BAG_DAILY_DB_EQMT_STATUS_V] WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [bag].[CONOPS_BAG_DAILY_DB_EQMT_STATUS_V]    
AS    
