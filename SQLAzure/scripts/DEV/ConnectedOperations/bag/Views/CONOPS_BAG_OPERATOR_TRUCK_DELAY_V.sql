CREATE VIEW [bag].[CONOPS_BAG_OPERATOR_TRUCK_DELAY_V] AS




-- SELECT * FROM [bag].[CONOPS_BAG_OPERATOR_TRUCK_DELAY_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [bag].[CONOPS_BAG_OPERATOR_TRUCK_DELAY_V] 
AS
