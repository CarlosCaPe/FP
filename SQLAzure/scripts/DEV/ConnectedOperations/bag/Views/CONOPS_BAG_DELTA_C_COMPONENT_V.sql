CREATE VIEW [bag].[CONOPS_BAG_DELTA_C_COMPONENT_V] AS





--SELECT * FROM BAG.CONOPS_BAG_DELTA_C_COMPONENT_V WHERE SHIFTFLAG = 'CURR' ORDER BY MinsOverExpected DESC
CREATE VIEW BAG.CONOPS_BAG_DELTA_C_COMPONENT_V
AS
