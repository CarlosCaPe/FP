CREATE VIEW [bag].[ZZZ_CONOPS_BAG_SP_AVG_LOAD_TIME_V_OLD] AS


--SELECT * FROM [bag].[CONOPS_BAG_SP_AVG_LOAD_TIME_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [bag].[CONOPS_BAG_SP_AVG_LOAD_TIME_V_OLD]
AS
...
ON a.shiftid = b.shiftid AND a.siteflag = 'BAG'
...
ON a.shiftindex = c.shiftindex and b.excav = c.excav AND a.siteflag = 'BAG'
...
ON a.shiftindex = d.shiftindex AND b.excav = d.excav AND a.siteflag = 'BAG'
...
LEFT JOIN DCTGT dctg on left(n