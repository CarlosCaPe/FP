CREATE VIEW [bag].[CONOPS_BAG_DAILY_TRUCK_DETAIL_V] AS

-- SELECT * FROM [bag].[CONOPS_BAG_DAILY_TRUCK_DETAIL_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' ORDER BY TruckID
CREATE VIEW [BAG].[CONOPS_BAG_DAILY_TRUCK_DETAIL_V] 
AS
