CREATE VIEW [bag].[CONOPS_BAG_DB_DRILL_SCORE_V] AS




--select * from [bag].[CONOPS_BAG_DB_DRILL_SCORE_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [bag].[CONOPS_BAG_DB_DRILL_SCORE_V]
AS
...
    	WHERE dt.NextStartDateTime IS NOT NULL
	...
	FROM [bag].[CONOPS_BAG_SHIFT_INFO