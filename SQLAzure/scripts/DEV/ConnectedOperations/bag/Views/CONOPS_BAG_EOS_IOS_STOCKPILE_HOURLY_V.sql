CREATE VIEW [bag].[CONOPS_BAG_EOS_IOS_STOCKPILE_HOURLY_V] AS





--SELECT * FROM [BAG].[CONOPS_BAG_EOS_IOS_STOCKPILE_HOURLY_V] WHERE shiftflag = 'PREV'
CREATE VIEW [BAG].[CONOPS_BAG_EOS_IOS_STOCKPILE_HOURLY_V]
AS
