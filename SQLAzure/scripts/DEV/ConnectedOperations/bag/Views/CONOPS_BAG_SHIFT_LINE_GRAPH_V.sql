CREATE VIEW [bag].[CONOPS_BAG_SHIFT_LINE_GRAPH_V] AS
...
--SELECT * FROM [bag].[CONOPS_BAG_SHIFT_LINE_GRAPH_V] where shiftflag = 'curr' order by shiftseq asc

CREATE VIEW [bag].[CONOPS_BAG_SHIFT_LINE_GRAPH_V]
AS
