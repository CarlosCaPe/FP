CREATE VIEW [bag].[CONOPS_BAG_EOS_HAULAGE_V] AS
...
--SELECT * FROM [BAG].[CONOPS_BAG_EOS_HAULAGE_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [bag].[CONOPS_BAG_EOS_HAULAGE_V]
AS
...
FROM(
	...
	FROM [BAG].[CONOPS_BAG_DELTA_C_DETAIL_V] [dc]
