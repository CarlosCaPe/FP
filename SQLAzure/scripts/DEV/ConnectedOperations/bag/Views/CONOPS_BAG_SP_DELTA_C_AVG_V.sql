CREATE VIEW [bag].[CONOPS_BAG_SP_DELTA_C_AVG_V] AS
  
  
  
--SELECT * FROM [bag].[CONOPS_BAG_SP_DELTA_C_AVG_V]  
CREATE VIEW [bag].[CONOPS_BAG_SP_DELTA_C_AVG_V]   
AS  
...
SELECT a.site_code,  
	   ...
	   (avg(a.hangtime)/60.0) AS hangtime,  
