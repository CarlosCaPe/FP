CREATE VIEW [bag].[CONOPS_BAG_DAILY_EOS_LINEUP_TRUCK_V] AS





-- SELECT * FROM [bag].[CONOPS_BAG_DAILY_EOS_LINEUP_TRUCK_V]  WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [bag].[CONOPS_BAG_DAILY_EOS_LINEUP_TRUCK_V] 
AS
...
FROM (
	...
	LEFT JOIN [bag].[CONOPS_BAG_EOS_SHIFT_INFO_V] [shift] WITH (NOLOCK)
