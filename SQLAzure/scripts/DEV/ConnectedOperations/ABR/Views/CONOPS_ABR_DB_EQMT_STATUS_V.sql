CREATE VIEW [ABR].[CONOPS_ABR_DB_EQMT_STATUS_V] AS


  
  
--SELECT * FROM [abr].[CONOPS_ABR_DB_EQMT_STATUS_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [abr].[CONOPS_ABR_DB_EQMT_STATUS_V]  
AS  
