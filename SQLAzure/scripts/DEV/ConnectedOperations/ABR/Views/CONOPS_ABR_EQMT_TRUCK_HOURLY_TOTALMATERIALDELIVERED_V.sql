CREATE VIEW [ABR].[CONOPS_ABR_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] AS
...
--select * from [abr].[CONOPS_ABR_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] order by shiftseq  
CREATE VIEW [abr].[CONOPS_ABR_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V]  
AS  
