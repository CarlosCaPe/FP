CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_LINEUP_DRILL_V] AS

  
--select * from [abr].[CONOPS_ABR_DAILY_EOS_LINEUP_DRILL_V] WHERE shiftflag = 'curr'    
CREATE VIEW [abr].[CONOPS_ABR_DAILY_EOS_LINEUP_DRILL_V]    
AS    
...
FROM [abr].[DRILL_UTILIZATION] WITH (NOLOCK))    
