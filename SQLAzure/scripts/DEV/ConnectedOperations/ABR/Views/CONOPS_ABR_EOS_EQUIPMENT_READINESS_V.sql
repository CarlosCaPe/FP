CREATE VIEW [ABR].[CONOPS_ABR_EOS_EQUIPMENT_READINESS_V] AS



  
--select * from [abr].[CONOPS_ABR_EOS_EQUIPMENT_READINESS_V] where shiftflag = 'prev'  
CREATE VIEW [ABR].[CONOPS_ABR_EOS_EQUIPMENT_READINESS_V]  
AS  
