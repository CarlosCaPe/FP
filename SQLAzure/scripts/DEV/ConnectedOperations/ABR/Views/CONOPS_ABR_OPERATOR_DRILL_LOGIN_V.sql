CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_DRILL_LOGIN_V] AS



-- SELECT * FROM [abr].[CONOPS_ABR_OPERATOR_DRILL_LOGIN_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [abr].[CONOPS_ABR_OPERATOR_DRILL_LOGIN_V] 
AS
