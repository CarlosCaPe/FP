CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DB_DRILL_PLAN_V] AS


  
--select * from [abr].[CONOPS_ABR_DAILY_DB_DRILL_PLAN_V] where shiftflag = 'prev'  
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DB_DRILL_PLAN_V]  
AS  
...
        WHERE [ds].[SITE_CODE] = 'ELA' AND DRILL_ID IS NOT NULL  
