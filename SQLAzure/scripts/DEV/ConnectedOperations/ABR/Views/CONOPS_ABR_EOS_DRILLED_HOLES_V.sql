CREATE VIEW [ABR].[CONOPS_ABR_EOS_DRILLED_HOLES_V] AS



--SELECT * FROM [abr].[CONOPS_ABR_EOS_DRILLED_HOLES_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [abr].[CONOPS_ABR_EOS_DRILLED_HOLES_V]
AS
...
(
	...
	FROM [abr].[CONOPS_ABR_DB_DRILL_PLAN_V] (NOLOCK)
