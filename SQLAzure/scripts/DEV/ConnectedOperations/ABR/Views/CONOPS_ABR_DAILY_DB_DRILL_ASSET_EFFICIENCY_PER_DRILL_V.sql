CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V] AS

  
  
  
--select * from [abr].[CONOPS_ABR_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
CREATE VIEW [abr].[CONOPS_ABR_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
AS  
