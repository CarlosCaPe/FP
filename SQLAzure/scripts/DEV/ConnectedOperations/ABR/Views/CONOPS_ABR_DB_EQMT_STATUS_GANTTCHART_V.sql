CREATE VIEW [ABR].[CONOPS_ABR_DB_EQMT_STATUS_GANTTCHART_V] AS

  
  
--select * from [abr].[CONOPS_ABR_DB_EQMT_STATUS_GANTTCHART_V] where shiftflag = 'prev'  
CREATE VIEW [abr].[CONOPS_ABR_DB_EQMT_STATUS_GANTTCHART_V]  
AS  
...
EVNTS AS (  
   SELECT SHIFTINDEX,  
    ...
    DRILL_ID AS eqmt,  
             ...
             reason AS reasons,  
             [status]  
      FROM [abr].[drill_asset_efficiency_v] (NOLOCK)  
),  
