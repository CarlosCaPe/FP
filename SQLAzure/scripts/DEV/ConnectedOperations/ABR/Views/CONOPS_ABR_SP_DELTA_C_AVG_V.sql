CREATE VIEW [ABR].[CONOPS_ABR_SP_DELTA_C_AVG_V] AS
...
--SELECT * FROM [saf].[CONOPS_ABR_SP_DELTA_C_AVG_V]    
CREATE VIEW [abr].[CONOPS_ABR_SP_DELTA_C_AVG_V]     
AS    
...
LEFT JOIN (    
  SELECT shiftindex,    
            excav,    
            CASE    
                WHEN unit = 'Stock' THEN COALESCE(avg([dumpdelta]), 0)    
