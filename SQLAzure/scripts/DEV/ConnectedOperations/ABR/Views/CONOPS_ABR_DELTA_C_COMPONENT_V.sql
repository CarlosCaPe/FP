CREATE VIEW [ABR].[CONOPS_ABR_DELTA_C_COMPONENT_V] AS




--SELECT * FROM ABR.CONOPS_ABR_DELTA_C_COMPONENT_V WHERE SHIFTFLAG = 'CURR' ORDER BY MinsOverExpected DESC
CREATE VIEW ABR.CONOPS_ABR_DELTA_C_COMPONENT_V
AS
...
LEFT JOIN ABR.CONOPS_ABR_SHIFT_INFO_V si
	ON dc.shiftindex = si.shiftindex
WHERE dc.SITE_CODE = 'ELA'
