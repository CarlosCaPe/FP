CREATE VIEW [ABR].[CONOPS_ABR_SHOVEL_DOWN_V] AS


--select * from [abr].[CONOPS_ABR_SHOVEL_DOWN_V] where shiftflag = 'curr'
CREATE VIEW [abr].[CONOPS_ABR_SHOVEL_DOWN_V]
AS
...
from [abr].[CONOPS_ABR_OVERVIEW_V] (NOLOCK)
