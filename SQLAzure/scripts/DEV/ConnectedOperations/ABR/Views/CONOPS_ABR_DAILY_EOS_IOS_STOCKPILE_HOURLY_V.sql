CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_IOS_STOCKPILE_HOURLY_V] AS

  
--SELECT * FROM [abr].[CONOPS_ABR_DAILY_EOS_IOS_STOCKPILE_HOURLY_V] WHERE shiftflag = 'PREV'  
CREATE VIEW [abr].[CONOPS_ABR_DAILY_EOS_IOS_STOCKPILE_HOURLY_V]  
AS  
...
LEFT JOIN [abr].[CONOPS_ABR_EOS_SHIFT_INFO_V] s WITH (NOLOCK)    
 ON a.SITEFLAG = s.siteflag  
WHERE a.siteflag = 'ELA'  
