CREATE VIEW [ABR].[CONOPS_ABR_EOS_CRUSHER_STATS_V] AS
  
--SELECT * FROM [abr].[CONOPS_ABR_EOS_CRUSHER_STATS_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [abr].[CONOPS_ABR_EOS_CRUSHER_STATS_V]    
AS    
