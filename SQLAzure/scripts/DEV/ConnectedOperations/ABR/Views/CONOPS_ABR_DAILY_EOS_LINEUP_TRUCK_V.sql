CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_LINEUP_TRUCK_V] AS
...
-- SELECT * FROM [abr].[CONOPS_ABR_DAILY_EOS_LINEUP_TRUCK_V]  WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [abr].[CONOPS_ABR_DAILY_EOS_LINEUP_TRUCK_V] 
AS
