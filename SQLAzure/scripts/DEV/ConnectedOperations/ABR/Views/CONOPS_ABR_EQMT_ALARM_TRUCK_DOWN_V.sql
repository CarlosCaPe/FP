CREATE VIEW [ABR].[CONOPS_ABR_EQMT_ALARM_TRUCK_DOWN_V] AS



-- SELECT * FROM [abr].[CONOPS_ABR_EQMT_ALARM_TRUCKL_DOWN_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [ABR].[CONOPS_ABR_EQMT_ALARM_TRUCK_DOWN_V]
AS
