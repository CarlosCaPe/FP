CREATE VIEW [ABR].[CONOPS_ABR_EOS_LINEUP_SHOVEL_V] AS




-- SELECT * FROM [abr].[CONOPS_ABR_EOS_LINEUP_SHOVEL_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [abr].[CONOPS_ABR_EOS_LINEUP_SHOVEL_V] 
AS
...
FROM (
	SELECT [shift].shiftflag,
		   ...
		   [s].FieldReason
	FROM [ABR].[pit_excav_c] [s] WITH (NOLOCK)
