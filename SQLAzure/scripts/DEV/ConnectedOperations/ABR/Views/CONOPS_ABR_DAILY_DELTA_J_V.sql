CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DELTA_J_V] AS


    
--select * from [abr].[CONOPS_ABR_DAILY_DELTA_J_V]       
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DELTA_J_V]       
AS      
...
TimeInHour,      
Shiftseq      
FROM [abr].[CONOPS_ABR_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]      
...
FROM [abr].[CONOPS_ABR_DAILY_EFH_V])      
