CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS


--select * from [abr].[CONOPS_ABR_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq    
CREATE VIEW [abr].[CONOPS_ABR_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]    
AS    
