CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_SUPPORT_EQMT_LOGIN_V] AS




-- SELECT * FROM [abr].[CONOPS_ABR_OPERATOR_SUPPORT_EQMT_LOGIN_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [abr].[CONOPS_ABR_OPERATOR_SUPPORT_EQMT_LOGIN_V]
AS
...
        ,[OperatorImageURL]
    FROM [abr].[CONOPS_ABR_EQMT_OTHER_V] WITH (NOLOCK)
    WHERE [Operator] != 'NONE'
),
