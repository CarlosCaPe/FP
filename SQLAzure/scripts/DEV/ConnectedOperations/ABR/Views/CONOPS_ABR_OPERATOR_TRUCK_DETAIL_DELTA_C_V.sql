CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_TRUCK_DETAIL_DELTA_C_V] AS
...
-- SELECT * FROM [abr].[CONOPS_ABR_OPERATOR_TRUCK_DETAIL_DELTA_C_V] WITH (NOLOCK) WHERE shiftflag = 'PREV'  
CREATE VIEW [abr].[CONOPS_ABR_OPERATOR_TRUCK_DETAIL_DELTA_C_V]   
AS  
...
LEFT JOIN [abr].[CONOPS_ABR_TRUCK_POPUP_V] [pop]
