CREATE VIEW [ABR].[CONOPS_ABR_EQMT_TRUCK_HOURLY_DELTAC_V] AS




--select * from [abr].[CONOPS_ABR_EQMT_TRUCK_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = '708'
CREATE VIEW [ABR].[CONOPS_ABR_EQMT_TRUCK_HOURLY_DELTAC_V]
AS
