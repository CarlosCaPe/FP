CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_SHOVEL_V] AS


-- SELECT * FROM [abr].[CONOPS_ABR_OPERATOR_SHOVEL_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_SHOVEL_V]
AS
