CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_TRUCK_ALERTS_V] AS


-- SELECT * FROM [abr].[CONOPS_ABR_OPERATOR_TRUCK_ALERTS_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [abr].[CONOPS_ABR_OPERATOR_TRUCK_ALERTS_V] 
AS
