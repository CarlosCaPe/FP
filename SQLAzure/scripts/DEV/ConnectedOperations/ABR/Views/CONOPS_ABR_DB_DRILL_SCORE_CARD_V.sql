CREATE VIEW [ABR].[CONOPS_ABR_DB_DRILL_SCORE_CARD_V] AS




--select * from [abr].[CONOPS_ABR_DB_DRILL_SCORE_CARD_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [abr].[CONOPS_ABR_DB_DRILL_SCORE_CARD_V]
AS
