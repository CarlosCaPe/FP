CREATE VIEW [ABR].[CONOPS_ABR_DB_DRILL_PLAN_V] AS


--select * from [abr].[CONOPS_ABR_DB_DRILL_PLAN_V] where shiftflag = 'prev'
CREATE VIEW [ABR].[CONOPS_ABR_DB_DRILL_PLAN_V]
AS
