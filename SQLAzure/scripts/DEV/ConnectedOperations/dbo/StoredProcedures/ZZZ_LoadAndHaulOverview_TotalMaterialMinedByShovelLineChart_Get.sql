...
* SAMPLE	: 
	1. EXEC dbo.LoadAndHaulOverview_TotalMaterialMinedByShovelLineChart_Get 'CURR', 'MOR'
...
*******************************************************************/ 
CREATE PROCEDURE [dbo].[ZZZ_LoadAndHaulOverview_TotalMaterialMinedByShovelLineChart_Get] 
(	
	@SHIFT VARCHAR(4),
	@SITE VARCHAR(4)
)
...
BEGIN          
	...
	BEGIN
		...
		SELECT 
			[DateTime],
			ROUND(actual/1000.0,1) AS [Value],
