...
/******************************************************************    
* PROCEDURE : dbo.[UPSERT_CONOPS_LH_DUMP]  
* PURPOSE : Upsert [UPSERT_CONOPS_LH_DUMP]  
* NOTES     :   
* CREATED : mfahmi  
* SAMPLE    : EXEC dbo.[UPSERT_CONOPS_LH_DUMP]  
* MODIFIED DATE  AUTHOR    DESCRIPTION    
*------------------------------------------------------------------    
* {10 JAN 2023}  {mfahmi}   {Initial Created}    
*******************************************************************/    
CREATE  PROCEDURE [dbo].UPSERT_CONOPS_LH_DUMP  
AS  
BEGIN  
  
MERGE dbo.LH_DUMP AS T   
USING (SELECT   
SHIFTINDEX
