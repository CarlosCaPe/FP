...
* SAMPLE	: 
	1. EXEC dbo.LoadAndHaulTP_Spare_Get 'CURR', 'CVE'
	
* MODIFIED DATE     AUTHOR			DESCRIPTION  
*------------------------------------------------------------------  
* {25 Oct 2022}		{lwasini}		{Initial Created}  
* {6 Dec 2022}		{sxavier}		{Rename field}
* {23 Jan 2022}		{mbote}		    {Implement SAF data}
* {27 Jan 2023}		{jrodulfa}		{Change SAF sitecode to SAM.}
* {31 Jan 2022}		{mbote}		    {Implement Cerro Verde data}
* {03 Feb 2023}		{jrodulfa}		{Implement Chino Data.}
*******************************************************************/ 
CREATE PROCEDURE [dbo].[LoadAndHaulTP_Spare_Get_OLD] 
(	
	@SHIFT VARCHAR(4),
	@SITE VARCHAR(4)
)
...
BEGIN          
	...
	FROM [dbo].[CONOPS_LH_TP_SPARE_V] (NOLOCK)
	WHERE 
		shiftflag = @SHIFT
		AND siteflag = @SITE		
