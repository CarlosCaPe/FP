CREATE VIEW [dbo].[CONOPS_EQMT_SHOVEL_HOURLY_ASSET_EFFICIENCY_V] AS





--select * from [dbo].[CONOPS_EQMT_SHOVEL_HOURLY_ASSET_EFFICIENCY_V]
CREATE VIEW [dbo].[CONOPS_EQMT_SHOVEL_HOURLY_ASSET_EFFICIENCY_V]
AS
