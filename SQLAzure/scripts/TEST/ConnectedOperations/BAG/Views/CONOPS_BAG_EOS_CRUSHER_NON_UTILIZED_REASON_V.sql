CREATE VIEW [BAG].[CONOPS_BAG_EOS_CRUSHER_NON_UTILIZED_REASON_V] AS

--SELECT * FROM [BAG].[CONOPS_BAG_EOS_CRUSHER_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [bag].[CONOPS_BAG_EOS_CRUSHER_NON_UTILIZED_REASON_V]  
AS
