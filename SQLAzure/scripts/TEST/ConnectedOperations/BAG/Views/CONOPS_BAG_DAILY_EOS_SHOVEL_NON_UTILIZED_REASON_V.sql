CREATE VIEW [BAG].[CONOPS_BAG_DAILY_EOS_SHOVEL_NON_UTILIZED_REASON_V] AS

--SELECT * FROM [BAG].[CONOPS_BAG_DAILY_EOS_SHOVEL_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [bag].[CONOPS_BAG_DAILY_EOS_SHOVEL_NON_UTILIZED_REASON_V]
AS
...
INNER JOIN BAG.CONOPS_BAG_EOS_SHIFT_INFO_V s WITH (NOLOCK)
