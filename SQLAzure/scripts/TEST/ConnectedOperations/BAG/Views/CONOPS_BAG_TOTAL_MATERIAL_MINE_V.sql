CREATE VIEW [BAG].[CONOPS_BAG_TOTAL_MATERIAL_MINE_V] AS

--SELECT * FROM [bag].[CONOPS_BAG_TOTAL_MATERIAL_MINE_V]
CREATE VIEW [bag].[CONOPS_BAG_TOTAL_MATERIAL_MINE_V]
AS
...
from [bag].[CONOPS_BAG_SHOVEL_SHIFT_TARGET_V] (NOLOCK)
WHERE siteflag = 'BAG'
...
LEFT JOIN TOTTGT tot on a.shiftid = tot.shiftid AND a.siteflag = 'BAG'
