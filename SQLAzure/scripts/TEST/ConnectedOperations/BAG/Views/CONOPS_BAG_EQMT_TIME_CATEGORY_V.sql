CREATE VIEW [BAG].[CONOPS_BAG_EQMT_TIME_CATEGORY_V] AS


--select * from [BAG].[CONOPS_BAG_EQMT_TIME_CATEGORY_V] WITH(NOLOCK)
CREATE VIEW [BAG].[CONOPS_BAG_EQMT_TIME_CATEGORY_V] 
AS
