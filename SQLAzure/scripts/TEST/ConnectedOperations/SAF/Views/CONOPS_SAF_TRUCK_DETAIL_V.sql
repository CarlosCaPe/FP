CREATE VIEW [SAF].[CONOPS_SAF_TRUCK_DETAIL_V] AS
  
  
  
-- SELECT * FROM [saf].[CONOPS_SAF_TRUCK_DETAIL_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'  
CREATE VIEW [saf].[CONOPS_SAF_TRUCK_DETAIL_V]  
AS  
