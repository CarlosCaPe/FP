CREATE VIEW [SAF].[CONOPS_SAF_DB_EQMT_STATUS_GANTTCHART_V] AS
  
  
  
  
--select * from [saf].[CONOPS_SAF_DB_EQMT_STATUS_GANTTCHART_V] where shiftflag = 'prev'  
CREATE VIEW [saf].[CONOPS_SAF_DB_EQMT_STATUS_GANTTCHART_V]  
AS  
