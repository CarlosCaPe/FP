CREATE VIEW [SAF].[CONOPS_SAF_DAILY_EOS_KPI_SUMMARY_V] AS
...
-- SELECT * FROM [saf].[CONOPS_SAF_DAILY_EOS_KPI_SUMMARY_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [saf].[CONOPS_SAF_DAILY_EOS_KPI_SUMMARY_V]      
AS      
...
FROM [saf].[CONOPS_SAF_DAILY_DELTA_J_V]  
WHERE DeltaJ <> 0  
