CREATE VIEW [SAF].[CONOPS_SAF_OPERATOR_TRUCK_LOGIN_V] AS
...
-- SELECT * FROM [saf].[CONOPS_SAF_OPERATOR_TRUCK_LOGIN_V] WITH (NOLOCK) WHsafERE [shiftflag] = 'CURR'
CREATE VIEW [saf].[CONOPS_SAF_OPERATOR_TRUCK_LOGIN_V] 
AS
