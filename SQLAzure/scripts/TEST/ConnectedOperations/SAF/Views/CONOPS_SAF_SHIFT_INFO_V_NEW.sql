CREATE VIEW [SAF].[CONOPS_SAF_SHIFT_INFO_V_NEW] AS

  
--SELECT * FROM [SAF].[CONOPS_SAF_SHIFT_INFO_V_NEW]  
CREATE VIEW [SAF].[CONOPS_SAF_SHIFT_INFO_V_NEW] WITH SCHEMABINDING   
AS  
