CREATE VIEW [SAF].[CONOPS_SAF_DB_DRILL_TO_WATCH_V] AS
...
--select * from [saf].[CONOPS_SAF_DB_DRILL_TO_WATCH_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [saf].[CONOPS_SAF_DB_DRILL_TO_WATCH_V]
AS
