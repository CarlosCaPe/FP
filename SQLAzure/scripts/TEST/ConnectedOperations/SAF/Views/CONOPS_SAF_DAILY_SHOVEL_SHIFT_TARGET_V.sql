CREATE VIEW [SAF].[CONOPS_SAF_DAILY_SHOVEL_SHIFT_TARGET_V] AS
  
  
  
--select * from [saf].[CONOPS_SAF_DAILY_SHOVEL_SHIFT_TARGET_V] where shiftflag = 'curr'  
CREATE VIEW [saf].[CONOPS_SAF_DAILY_SHOVEL_SHIFT_TARGET_V]  
AS  
