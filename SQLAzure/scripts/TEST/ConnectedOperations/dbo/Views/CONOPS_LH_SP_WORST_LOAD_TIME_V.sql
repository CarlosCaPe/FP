...
--SELECT * FROM [dbo].[CONOPS_LH_SP_WORST_LOAD_TIME_V] WHERE SHIFTFLAG = 'CURR'
...
reasons,
eqmtcurrstatus
FROM [saf].[CONOPS_SAF_SP_WORST_LOAD_TIME_V]
WHERE siteflag = 'SAF'
...
reasons,
eqmtcurrstatus
FROM [sie].[CONOPS_SIE_SP_WORST_LOAD_TIME_V]
WHERE siteflag = 'SIE'
...
reasons,
eqmtcurrstatus
FROM [cli].[CONOPS_CLI_SP_WORST_LOAD_TIME_V]
WHERE siteflag = 'CMX'
...
reasons,
eqmtcurrstatus
FROM [chi].[CONOPS_CHI_SP_WORST_LOAD_TIME_V]
WHERE siteflag = 'CHI'
