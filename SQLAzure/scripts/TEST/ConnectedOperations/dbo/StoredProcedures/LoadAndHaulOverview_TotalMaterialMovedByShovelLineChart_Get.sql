...
* SAMPLE	: 
	1. EXEC dbo.LoadAndHaulOverview_TotalMaterialMovedByShovelLineChart_Get 'CURR', 'MOR',NULL
...
* {30 Jan 2024}		{ggosal1}		{Add @MTRL, Bar Chart, Line Chart}
* {11 Sep 2024}		{ggosal1}		{Fix Total Material Moved (prev: mined)}
*******************************************************************/ 
CREATE PROCEDURE [dbo].[LoadAndHaulOverview_TotalMaterialMovedByShovelLineChart_Get] 
(	
	@SHIFT VARCHAR(4),
	@SITE VARCHAR(4),
	@MTRL VARCHAR(12)
