CREATE VIEW [SIE].[CONOPS_SIE_AVG_SHIFT_CHANGE_DELAY_V] AS



--select * from [sie].[CONOPS_SIE_AVG_SHIFT_CHANGE_DELAY_V] WITH (NOLOCK)
CREATE VIEW [sie].[CONOPS_SIE_AVG_SHIFT_CHANGE_DELAY_V]
AS
