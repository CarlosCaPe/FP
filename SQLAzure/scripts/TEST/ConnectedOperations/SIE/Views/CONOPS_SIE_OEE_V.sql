CREATE VIEW [SIE].[CONOPS_SIE_OEE_V] AS

--select * from [sie].[CONOPS_SIE_OEE_V]
CREATE VIEW [SIE].[CONOPS_SIE_OEE_V]
AS
...
LEFT JOIN SIE.CONOPS_SIE_ASSET_EFFICIENCY_V ae ON s.shiftflag = ae.shiftflag
