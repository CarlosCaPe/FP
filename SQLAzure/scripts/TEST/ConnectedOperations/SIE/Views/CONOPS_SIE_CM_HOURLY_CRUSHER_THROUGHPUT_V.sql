CREATE VIEW [SIE].[CONOPS_SIE_CM_HOURLY_CRUSHER_THROUGHPUT_V] AS
...
-- SELECT * FROM [sie].[CONOPS_SIE_CM_HOURLY_CRUSHER_THROUGHPUT_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [sie].[CONOPS_SIE_CM_HOURLY_CRUSHER_THROUGHPUT_V]  
AS  
