CREATE VIEW [SIE].[CONOPS_SIE_EOS_DRILL_NON_UTILIZED_REASON_V] AS

--SELECT * FROM [sie].[CONOPS_SIE_EOS_DRILL_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [sie].[CONOPS_SIE_EOS_DRILL_NON_UTILIZED_REASON_V]
AS
...
LEFT JOIN [SIE].[CONOPS_SIE_DB_EQMT_STATUS_V] [stats] (NOLOCK)
