CREATE VIEW [SIE].[CONOPS_SIE_SHIFT_INFO_V_NEW] AS

  
--SELECT * FROM [SIE].[CONOPS_SIE_SHIFT_INFO_V_NEW]  
CREATE VIEW [SIE].[CONOPS_SIE_SHIFT_INFO_V_NEW] WITH SCHEMABINDING   
AS  
