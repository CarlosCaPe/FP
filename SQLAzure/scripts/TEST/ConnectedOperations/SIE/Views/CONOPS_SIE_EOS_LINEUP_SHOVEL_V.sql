CREATE VIEW [SIE].[CONOPS_SIE_EOS_LINEUP_SHOVEL_V] AS



-- SELECT * FROM [sie].[CONOPS_SIE_EOS_LINEUP_SHOVEL_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [sie].[CONOPS_SIE_EOS_LINEUP_SHOVEL_V] 
AS
