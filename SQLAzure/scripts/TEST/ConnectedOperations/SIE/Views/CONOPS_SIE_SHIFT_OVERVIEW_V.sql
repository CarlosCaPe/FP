CREATE VIEW [SIE].[CONOPS_SIE_SHIFT_OVERVIEW_V] AS


--SELECT * FROM [sie].[CONOPS_SIE_SHIFT_OVERVIEW_V]
CREATE VIEW [sie].[CONOPS_SIE_SHIFT_OVERVIEW_V]
AS
...
GROUP BY sd.shiftid,s.FieldId,ssloc.FieldId,sl.FieldId)
...
FROM CTE AS sdps
GROUP BY sdps.shiftid, [ShovelId]
