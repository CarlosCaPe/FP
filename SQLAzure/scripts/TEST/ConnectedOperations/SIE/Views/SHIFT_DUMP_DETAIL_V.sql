CREATE VIEW [SIE].[SHIFT_DUMP_DETAIL_V] AS

--SELECT * FROM SIE.SHIFT_DUMP_DETAIL_V
CREATE VIEW [SIE].[SHIFT_DUMP_DETAIL_V]
AS
...
FROM SIE.SHIFT_DUMP WITH (NOLOCK)
)
