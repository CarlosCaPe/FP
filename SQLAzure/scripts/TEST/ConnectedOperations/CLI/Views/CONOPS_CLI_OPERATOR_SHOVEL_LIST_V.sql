CREATE VIEW [CLI].[CONOPS_CLI_OPERATOR_SHOVEL_LIST_V] AS
...
-- SELECT * FROM [CLI].[CONOPS_CLI_OPERATOR_SHOVEL_LIST_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [CLI].[CONOPS_CLI_OPERATOR_SHOVEL_LIST_V]
AS
