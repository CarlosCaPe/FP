CREATE VIEW [CLI].[CONOPS_CLI_EOS_CRUSHER_STATS_V] AS



--SELECT * FROM [cli].[CONOPS_CLI_EOS_CRUSHER_STATS_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [cli].[CONOPS_CLI_EOS_CRUSHER_STATS_V]
AS
