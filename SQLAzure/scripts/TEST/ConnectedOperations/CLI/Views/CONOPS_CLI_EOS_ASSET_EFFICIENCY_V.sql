CREATE VIEW [CLI].[CONOPS_CLI_EOS_ASSET_EFFICIENCY_V] AS
...
--SELECT * FROM [CLI].[CONOPS_CLI_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [cli].[CONOPS_CLI_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [CLI].[CONOPS_CLI_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [CLI].[CONOPS_CLI_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [CLI].[CONOPS_CLI_DRILL_ASSET_EFFICIENCY_V]
)
