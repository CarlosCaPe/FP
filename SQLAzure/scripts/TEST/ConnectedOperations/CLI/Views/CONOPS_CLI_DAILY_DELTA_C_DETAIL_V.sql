CREATE VIEW [CLI].[CONOPS_CLI_DAILY_DELTA_C_DETAIL_V] AS


  

   
--select * from [CLI].[CONOPS_CLI_DAILY_DELTA_C_DETAIL_V] 
CREATE VIEW [CLI].[CONOPS_CLI_DAILY_DELTA_C_DETAIL_V] 
AS
