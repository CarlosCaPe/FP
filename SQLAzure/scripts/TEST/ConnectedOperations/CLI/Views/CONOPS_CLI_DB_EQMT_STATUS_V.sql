CREATE VIEW [CLI].[CONOPS_CLI_DB_EQMT_STATUS_V] AS



  
  
--SELECT * FROM [CLI].[CONOPS_CLI_DB_EQMT_STATUS_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [CLI].[CONOPS_CLI_DB_EQMT_STATUS_V]  
AS  
