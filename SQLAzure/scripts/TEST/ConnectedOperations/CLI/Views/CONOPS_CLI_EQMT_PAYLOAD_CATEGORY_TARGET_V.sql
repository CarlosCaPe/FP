CREATE VIEW [CLI].[CONOPS_CLI_EQMT_PAYLOAD_CATEGORY_TARGET_V] AS
  
 
-- SELECT * FROM [cli].[CONOPS_CLI_EQMT_PAYLOAD_CATEGORY_TARGET_V] WHERE shiftindex = '38916'  
CREATE VIEW [cli].[CONOPS_CLI_EQMT_PAYLOAD_CATEGORY_TARGET_V]  
AS  
...
0.05 * 200 AS UnderLoadedTarget,  
FLOOR(200 - (0.05 * 200)) AS UnderLoaded,  
