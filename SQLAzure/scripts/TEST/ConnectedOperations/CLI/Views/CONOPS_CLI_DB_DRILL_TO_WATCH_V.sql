CREATE VIEW [CLI].[CONOPS_CLI_DB_DRILL_TO_WATCH_V] AS
...
--select * from [cli].[CONOPS_CLI_DB_DRILL_TO_WATCH_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [cli].[CONOPS_CLI_DB_DRILL_TO_WATCH_V]
AS
