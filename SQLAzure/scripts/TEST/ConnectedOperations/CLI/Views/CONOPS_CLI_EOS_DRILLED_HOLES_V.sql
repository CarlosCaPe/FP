CREATE VIEW [CLI].[CONOPS_CLI_EOS_DRILLED_HOLES_V] AS



--SELECT * FROM [CLI].[CONOPS_CLI_EOS_DRILLED_HOLES_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [CLI].[CONOPS_CLI_EOS_DRILLED_HOLES_V]
AS
...
(
	...
	FROM [CLI].[CONOPS_CLI_DB_DRILL_PLAN_V] (NOLOCK)
