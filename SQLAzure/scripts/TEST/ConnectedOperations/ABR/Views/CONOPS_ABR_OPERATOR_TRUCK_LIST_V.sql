CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_TRUCK_LIST_V] AS


-- SELECT * FROM [abr].[CONOPS_ABR_OPERATOR_TRUCK_LIST_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' 
CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_TRUCK_LIST_V] 
AS
