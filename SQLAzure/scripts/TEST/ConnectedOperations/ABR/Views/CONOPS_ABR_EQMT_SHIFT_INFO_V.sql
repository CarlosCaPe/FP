CREATE VIEW [ABR].[CONOPS_ABR_EQMT_SHIFT_INFO_V] AS

  
  
--select * from [abr].[CONOPS_ABR_EQMT_SHIFT_INFO_V] order by shiftflag  
  
CREATE VIEW [ABR].[CONOPS_ABR_EQMT_SHIFT_INFO_V]   
AS  
