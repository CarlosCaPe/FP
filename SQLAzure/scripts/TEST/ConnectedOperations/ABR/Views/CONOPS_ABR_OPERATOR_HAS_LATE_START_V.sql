CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_HAS_LATE_START_V] AS

  
     
      
-- SELECT * FROM [abr].[CONOPS_ABR_OPERATOR_HAS_LATE_START_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'      
CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_HAS_LATE_START_V]       
AS      
