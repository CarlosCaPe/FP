CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_SUPPORT_EQMT_LIST_V] AS




-- SELECT * FROM [abr].[CONOPS_ABR_OPERATOR_SUPPORT_EQMT_LIST_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [ABR].[CONOPS_ABR_OPERATOR_SUPPORT_EQMT_LIST_V]
AS
