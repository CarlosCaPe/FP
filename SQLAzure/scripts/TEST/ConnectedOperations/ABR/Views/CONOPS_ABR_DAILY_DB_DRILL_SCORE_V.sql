CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DB_DRILL_SCORE_V] AS



  
--select * from [abr].[CONOPS_ABR_DAILY_DB_DRILL_SCORE_V] WITH (NOLOCK) where shiftflag = 'prev'  
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DB_DRILL_SCORE_V]  
AS  
