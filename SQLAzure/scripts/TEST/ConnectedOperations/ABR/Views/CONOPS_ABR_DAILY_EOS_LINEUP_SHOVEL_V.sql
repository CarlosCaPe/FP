CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_LINEUP_SHOVEL_V] AS
...
-- SELECT * FROM [abr].[CONOPS_ABR_DAILY_EOS_LINEUP_SHOVEL_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_LINEUP_SHOVEL_V] 
AS
