CREATE VIEW [ABR].[CONOPS_ABR_SHIFT_OVERVIEW_V] AS




--select * from [ABR].[CONOPS_ABR_SHIFT_OVERVIEW_V] where shiftid = '230221001'
CREATE VIEW [ABR].[CONOPS_ABR_SHIFT_OVERVIEW_V]
AS
