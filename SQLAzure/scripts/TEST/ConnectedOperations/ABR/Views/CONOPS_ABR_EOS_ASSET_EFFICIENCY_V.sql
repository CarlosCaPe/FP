CREATE VIEW [ABR].[CONOPS_ABR_EOS_ASSET_EFFICIENCY_V] AS




--SELECT * FROM [abr].[CONOPS_ABR_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [ABR].[CONOPS_ABR_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [ABR].[CONOPS_ABR_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [ABR].[CONOPS_ABR_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [ABR].[CONOPS_ABR_DRILL_ASSET_EFFICIENCY_V]
)
