CREATE VIEW [ABR].[CONOPS_ABR_TONS_LINE_GRAPH_V] AS


--select * from [ABR].[CONOPS_ABR_TONS_LINE_GRAPH_V]
CREATE VIEW [ABR].[CONOPS_ABR_TONS_LINE_GRAPH_V]
AS
...
SELECT
    ...
    SUM(TotalMaterialDeliveredToCrusher) OVER (PARTITION BY shiftid ORDER BY dumping_tim