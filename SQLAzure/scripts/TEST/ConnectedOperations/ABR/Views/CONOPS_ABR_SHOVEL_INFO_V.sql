CREATE VIEW [ABR].[CONOPS_ABR_SHOVEL_INFO_V] AS


-- SELECT * FROM [abr].[CONOPS_ABR_SHOVEL_INFO_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'    
CREATE VIEW [ABR].[CONOPS_ABR_SHOVEL_INFO_V]     
AS    
