CREATE VIEW [ABR].[CONOPS_ABR_WORST_HAUL_ROUTE_V] AS



-- SELECT * FROM [abr].[CONOPS_ABR_WORST_HAUL_ROUTE_V] WITH (NOLOCK)
CREATE VIEW [ABR].[CONOPS_ABR_WORST_HAUL_ROUTE_V] 
AS
