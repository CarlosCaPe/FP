CREATE VIEW [ABR].[CONOPS_ABR_HOURLY_DRILL_ASSET_EFFICIENCY_V] AS




--select * from [abr].[CONOPS_ABR_HOURLY_DRILL_ASSET_EFFICIENCY_V] WITH (NOLOCK)
CREATE VIEW [ABR].[CONOPS_ABR_HOURLY_DRILL_ASSET_EFFICIENCY_V]
AS
