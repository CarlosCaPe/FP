CREATE VIEW [ABR].[CONOPS_ABR_EOS_TONS_CRUSHED_GRADES_V] AS



--SELECT * FROM [abr].[CONOPS_ABR_EOS_TONS_CRUSHED_GRADES_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [ABR].[CONOPS_ABR_EOS_TONS_CRUSHED_GRADES_V]  
AS  
