CREATE VIEW [ABR].[CONOPS_ABR_DRILL_DETAIL_PER_HOUR_V] AS


  
-- SELECT * FROM [abr].[CONOPS_ABR_DRILL_DETAIL_PER_HOUR_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' ORDER BY [DRILL_ID]  
CREATE VIEW [ABR].[CONOPS_ABR_DRILL_DETAIL_PER_HOUR_V]  
AS  
