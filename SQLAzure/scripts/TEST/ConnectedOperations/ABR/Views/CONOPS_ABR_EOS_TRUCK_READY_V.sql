CREATE VIEW [ABR].[CONOPS_ABR_EOS_TRUCK_READY_V] AS


--SELECT * FROM [abr].[CONOPS_ABR_EOS_TRUCK_READY_V] WHERE shiftflag = 'curr' order by datetime  
CREATE VIEW [ABR].[CONOPS_ABR_EOS_TRUCK_READY_V]  
AS  
