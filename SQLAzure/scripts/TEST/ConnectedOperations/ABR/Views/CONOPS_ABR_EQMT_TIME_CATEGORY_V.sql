CREATE VIEW [ABR].[CONOPS_ABR_EQMT_TIME_CATEGORY_V] AS


--select * from [ABR].[CONOPS_ABR_EQMT_TIME_CATEGORY_V] WITH(NOLOCK)
CREATE VIEW [ABR].[CONOPS_ABR_EQMT_TIME_CATEGORY_V] 
AS
