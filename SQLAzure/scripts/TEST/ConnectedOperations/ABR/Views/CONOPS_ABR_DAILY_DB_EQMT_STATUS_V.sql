CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DB_EQMT_STATUS_V] AS


 
--SELECT * FROM [abr].[CONOPS_ABR_DAILY_DB_EQMT_STATUS_V] WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DB_EQMT_STATUS_V]    
AS    
