...
/******************************************************************  
* PROCEDURE	: mill.[MetcalfRegrindCycloneForm_Header_Get]
* PURPOSE	: 
* NOTES		: 
* CREATED	: sxavier
* SAMPLE	: 
	1. EXEC [mill].[MetcalfRegrindCycloneForm_Header_Get] 'MOR', 'NEXT'

* MODIFIED DATE     AUTHOR			DESCRIPTION  
*------------------------------------------------------------------  
* {19 Dec 2024}		{sxavier}		{Initial Created}
*******************************************************************/ 
CREATE PROCEDURE [mill].[MetcalfRegrindCycloneForm_Header_Get]
(
	@SiteCode VARCHAR(3),
	@ShiftCode VARCHAR(4)
)
	...
	Rounds AS (
		...
		FROM (
			SELECT TOP 1
				...
				1 AS IsRound0
			FROM
				mill.METCALF_REGRIND_CYCLONE_FORM_V A
			WHERE
