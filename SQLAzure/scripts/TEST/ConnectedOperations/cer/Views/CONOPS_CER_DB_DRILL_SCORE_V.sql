CREATE VIEW [cer].[CONOPS_CER_DB_DRILL_SCORE_V] AS




--select * from [cer].[CONOPS_CER_DB_DRILL_SCORE_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [cer].[CONOPS_CER_DB_DRILL_SCORE_V]
AS
	...
	FROM [cer].[CONOPS_CER_SHIFT_INFO