CREATE VIEW [cer].[CONOPS_CER_EOS_TONS_CRUSHED_GRADES_V] AS
...
--SELECT * FROM [cer].[CONOPS_CER_EOS_TONS_CRUSHED_GRADES_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [cer].[CONOPS_CER_EOS_TONS_CRUSHED_GRADES_V]  
AS  
