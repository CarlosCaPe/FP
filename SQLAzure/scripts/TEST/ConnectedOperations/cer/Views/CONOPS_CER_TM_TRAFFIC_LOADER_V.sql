CREATE VIEW [cer].[CONOPS_CER_TM_TRAFFIC_LOADER_V] AS
  
    
    
    
    
--SELECT * FROM [cer].[CONOPS_CER_TM_TRAFFIC_LOADER_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [cer].[CONOPS_CER_TM_TRAFFIC_LOADER_V]      
AS      
