CREATE VIEW [cer].[CONOPS_CER_OPERATOR_SHOVEL_LOGIN_V] AS



-- SELECT * FROM [cer].[CONOPS_CER_OPERATOR_SHOVEL_LOGIN_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [cer].[CONOPS_CER_OPERATOR_SHOVEL_LOGIN_V] 
AS
