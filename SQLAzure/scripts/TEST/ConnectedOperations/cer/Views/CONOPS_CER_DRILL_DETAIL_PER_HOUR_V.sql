CREATE VIEW [cer].[CONOPS_CER_DRILL_DETAIL_PER_HOUR_V] AS
  
    
-- SELECT * FROM [cer].[CONOPS_CER_DRILL_DETAIL_PER_HOUR_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' ORDER BY [DRILL_ID]    
CREATE VIEW [cer].[CONOPS_CER_DRILL_DETAIL_PER_HOUR_V]    
AS    
