CREATE VIEW [cer].[CONOPS_CER_EOS_DRILLED_HOLES_V] AS



--SELECT * FROM [CER].[CONOPS_CER_EOS_DRILLED_HOLES_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [CER].[CONOPS_CER_EOS_DRILLED_HOLES_V]
AS
