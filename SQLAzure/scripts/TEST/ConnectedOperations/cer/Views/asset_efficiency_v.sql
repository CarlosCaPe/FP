CREATE VIEW [cer].[asset_efficiency_v] AS



--SELECT * FROM [cer].[asset_efficiency_v]  WITH (NOLOCK)
CREATE VIEW [cer].[asset_efficiency_v]
AS      
...
EqmtHist AS (
    ...
    WHERE [HOS].UNIT IN (1,2,14,43)
	OR [HOS].EQMT IN ('HIDRO', 'C1', 'C21', 'C22') --Add Crusher
), 
