...
FROM dbo.DI_JOB_CONTROL_ENTRY_TS_BASE WITH(NOLOCK)
WHERE JOB_NAME IN ('job_conops_equipment_hourly_status_TYR', 'job_conops_asset_efficiency_TYR', 
'job_conops_drill_utilization_TYR', 'job_conops_delta_c', 'job_conops_ios_stockpile_levels', 
