CREATE VIEW [TYR].[CONOPS_TYR_HOURLY_DRILL_ASSET_EFFICIENCY_V] AS




--select * from [tyr].[CONOPS_TYR_HOURLY_DRILL_ASSET_EFFICIENCY_V] WITH (NOLOCK)
CREATE VIEW [TYR].[CONOPS_TYR_HOURLY_DRILL_ASSET_EFFICIENCY_V]
AS
