CREATE VIEW [TYR].[CONOPS_TYR_SHOVEL_INFO_V] AS

  
    
    
    
-- SELECT * FROM [tyr].[CONOPS_TYR_SHOVEL_INFO_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'    
CREATE VIEW [TYR].[CONOPS_TYR_SHOVEL_INFO_V]     
AS    
