CREATE VIEW [TYR].[CONOPS_TYR_DRILL_DETAIL_PER_HOUR_V] AS



-- SELECT * FROM [tyr].[CONOPS_TYR_DRILL_DETAIL_PER_HOUR_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' ORDER BY [DRILL_ID]  
CREATE VIEW [TYR].[CONOPS_TYR_DRILL_DETAIL_PER_HOUR_V]  
AS  
