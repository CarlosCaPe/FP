CREATE VIEW [TYR].[CONOPS_TYR_EOS_SHIFT_INFO_V] AS



--select * from [tyr].[CONOPS_TYR_EOS_SHIFT_INFO_V] order by shiftflag  
  
CREATE VIEW [TYR].[CONOPS_TYR_EOS_SHIFT_INFO_V]   
AS  
