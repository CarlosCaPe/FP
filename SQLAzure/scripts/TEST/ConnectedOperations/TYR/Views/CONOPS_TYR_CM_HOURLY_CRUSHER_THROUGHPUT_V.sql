CREATE VIEW [TYR].[CONOPS_TYR_CM_HOURLY_CRUSHER_THROUGHPUT_V] AS



-- SELECT * FROM [tyr].[CONOPS_TYR_CM_HOURLY_CRUSHER_THROUGHPUT_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [TYR].[CONOPS_TYR_CM_HOURLY_CRUSHER_THROUGHPUT_V]  
AS  
