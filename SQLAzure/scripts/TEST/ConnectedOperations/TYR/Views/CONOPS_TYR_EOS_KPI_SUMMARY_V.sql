CREATE VIEW [TYR].[CONOPS_TYR_EOS_KPI_SUMMARY_V] AS




-- SELECT * FROM [tyr].[CONOPS_TYR_EOS_KPI_SUMMARY_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'PREV'    
CREATE VIEW [TYR].[CONOPS_TYR_EOS_KPI_SUMMARY_V]    
AS    
