CREATE VIEW [TYR].[CONOPS_TYR_EOS_ASSET_EFFICIENCY_V] AS




--SELECT * FROM [tyr].[CONOPS_TYR_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [TYR].[CONOPS_TYR_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [TYR].[CONOPS_TYR_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [TYR].[CONOPS_TYR_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [TYR].[CONOPS_TYR_DRILL_ASSET_EFFICIENCY_V]
)
