CREATE VIEW [TYR].[CONOPS_TYR_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] AS


--select * from [tyr].[CONOPS_TYR_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V] order by shiftseq  
CREATE VIEW [TYR].[CONOPS_TYR_EQMT_TRUCK_HOURLY_TOTALMATERIALDELIVERED_V]  
AS  
