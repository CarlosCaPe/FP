CREATE VIEW [TYR].[CONOPS_TYR_EQMT_SHOVEL_HOURLY_DELTAC_V] AS





--select * from [tyr].[CONOPS_TYR_EQMT_SHOVEL_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = 's08'
CREATE VIEW [TYR].[CONOPS_TYR_EQMT_SHOVEL_HOURLY_DELTAC_V]
AS
