CREATE VIEW [TYR].[CONOPS_TYR_EOS_LINEUP_EQUIPMENT_V] AS




-- SELECT * FROM [tyr].[CONOPS_TYR_EOS_LINEUP_EQUIPMENT_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [TYR].[CONOPS_TYR_EOS_LINEUP_EQUIPMENT_V] 
AS
...
FROM [tyr].[CONOPS_TYR_EOS_LINEUP_SHOVEL_V] 
...
FROM [tyr].[CONOPS_TYR_EOS_LINEUP_TRUCK_V]
GROUP BY siteflag, shiftflag,shiftid
...
FROM [tyr].[CONOPS_TYR_EOS_LINEUP_DRILL_V]
GROUP BY siteflag, shiftflag, shiftid
...
FROM [tyr].[CONOPS_TYR_EOS_LINEUP_EQMT_OTHER_V]
