CREATE VIEW [TYR].[CONOPS_TYR_EOS_DRILLED_HOLES_V] AS




--SELECT * FROM [tyr].[CONOPS_TYR_EOS_DRILLED_HOLES_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [TYR].[CONOPS_TYR_EOS_DRILLED_HOLES_V]
AS
...
(
	...
	FROM [tyr].[CONOPS_TYR_DB_DRILL_PLAN_V] (NOLOCK)
