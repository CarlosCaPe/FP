CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_ASSET_EFFICIENCY_V] AS




--SELECT * FROM [tyr].[CONOPS_TYR_DAILY_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'  
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_ASSET_EFFICIENCY_V]  
AS  
...
FROM [TYR].[CONOPS_TYR_DAILY_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [TYR].[CONOPS_TYR_DAILY_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [TYR].[CONOPS_TYR_DAILY_DRILL_ASSET_EFFICIENCY_V]
)
...
FROM(  
 ...
 LEFT JOIN [tyr].[CONOPS_TYR_EQMT_ASSET_EFFICIENCY_TARGET_V] tg  
