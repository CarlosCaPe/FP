CREATE VIEW [TYR].[CONOPS_TYR_EOS_IOS_STOCKPILE_HOURLY_V] AS




--SELECT * FROM [tyr].[CONOPS_TYR_EOS_IOS_STOCKPILE_HOURLY_V] WHERE shiftflag = 'PREV'
CREATE VIEW [TYR].[CONOPS_TYR_EOS_IOS_STOCKPILE_HOURLY_V]
AS
...
LEFT JOIN [tyr].[CONOPS_TYR_SHIFT_INFO_V] s WITH (NOLOCK)  
