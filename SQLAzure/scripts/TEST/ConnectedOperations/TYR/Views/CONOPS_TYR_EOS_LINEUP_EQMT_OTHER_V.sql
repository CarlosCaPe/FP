CREATE VIEW [TYR].[CONOPS_TYR_EOS_LINEUP_EQMT_OTHER_V] AS




-- SELECT * FROM [tyr].[CONOPS_TYR_EOS_LINEUP_EQMT_OTHER_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'  ORDER BY shiftflag, siteflag, SupportEquipment
CREATE VIEW [TYR].[CONOPS_TYR_EOS_LINEUP_EQMT_OTHER_V]
AS
