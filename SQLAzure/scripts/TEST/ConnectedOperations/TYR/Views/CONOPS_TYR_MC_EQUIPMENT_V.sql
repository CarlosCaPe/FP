CREATE VIEW [TYR].[CONOPS_TYR_MC_EQUIPMENT_V] AS


/******************************************************************    
* PROCEDURE : [tyr].[CONOPS_TYR_MC_EQUIPMENT_V]  
* PURPOSE :   
* NOTES  :   
* CREATED : lwasini, 12 Jan 2024
* SAMPLE :   
 1. SELECT * FROM [tyr].[CONOPS_TYR_MC_EQUIPMENT_V]  
...
CREATE VIEW [TYR].[CONOPS_TYR_MC_EQUIPMENT_V]  
AS  
...
FROM [tyr].[pit_truck] WITH (NOLOCK)  
...
SELECT  
 ...
 FieldId AS EquipmentId  
FROM [tyr].[pit_excav] WITH (NOLOCK)  
...
SELECT DISTINCT  
 ...
 FieldId AS EquipmentId  
FROM [tyr].[SHIFT_LOC] WITH (NOLOCK)  
...
SELECT  
 ...
 FieldId AS EquipmentId  
FROM [tyr].[pit_auxeqmt] WITH (NOLOCK)  
