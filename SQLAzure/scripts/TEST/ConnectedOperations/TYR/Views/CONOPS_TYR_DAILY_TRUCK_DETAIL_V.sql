CREATE VIEW [TYR].[CONOPS_TYR_DAILY_TRUCK_DETAIL_V] AS



-- SELECT * FROM [tyr].[CONOPS_TYR_DAILY_TRUCK_DETAIL_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_TRUCK_DETAIL_V] 
AS
...
LEFT JOIN (
	...
	LEFT JOIN [TYR].[pit_loc] [des] WITH (NOLOCK)
