CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_LINEUP_DRILL_V] AS


  
--select * from [tyr].[CONOPS_TYR_DAILY_EOS_LINEUP_DRILL_V] WHERE shiftflag = 'curr'    
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_LINEUP_DRILL_V]    
AS    
