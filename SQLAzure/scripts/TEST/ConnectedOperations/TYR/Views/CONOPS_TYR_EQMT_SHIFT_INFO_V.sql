CREATE VIEW [TYR].[CONOPS_TYR_EQMT_SHIFT_INFO_V] AS

  
  
--select * from [tyr].[CONOPS_TYR_EQMT_SHIFT_INFO_V] order by shiftflag  
  
CREATE VIEW [TYR].[CONOPS_TYR_EQMT_SHIFT_INFO_V]   
AS  
...
ShiftDuration   
FROM [tyr].[shift_info] WITH (nolock)) b  
