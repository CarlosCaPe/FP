CREATE VIEW [TYR].[CONOPS_TYR_SHIFT_OVERVIEW_V] AS




-- SELECT * FROM [tyr].[CONOPS_TYR_SHIFT_OVERVIEW_V] where shiftid = '230807002' group by shiftid
CREATE VIEW [TYR].[CONOPS_TYR_SHIFT_OVERVIEW_V]
AS
