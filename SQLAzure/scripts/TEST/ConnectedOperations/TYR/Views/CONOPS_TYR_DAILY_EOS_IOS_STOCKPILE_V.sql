CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_IOS_STOCKPILE_V] AS


--SELECT * FROM [tyr].[CONOPS_TYR_DAILY_EOS_IOS_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_IOS_STOCKPILE_V]      
AS      
