CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_KPI_SUMMARY_HOURLY_AVG_DURATION_V] AS


  
-- SELECT * FROM [tyr].[CONOPS_TYR_DAILY_EOS_KPI_SUMMARY_HOURLY_AVG_DURATION_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_KPI_SUMMARY_HOURLY_AVG_DURATION_V]    
AS    
...
StatusEvent AS (  
 ...
 FROM (  
  ...
  FROM [tyr].[CONOPS_TYR_EOS_SHIFT_INFO_V] [si] WITH (NOLOCK)  
