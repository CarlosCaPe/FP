CREATE VIEW [Arch].[CONOPS_ARCH_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V] AS


CREATE VIEW [Arch].[CONOPS_ARCH_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]
AS
