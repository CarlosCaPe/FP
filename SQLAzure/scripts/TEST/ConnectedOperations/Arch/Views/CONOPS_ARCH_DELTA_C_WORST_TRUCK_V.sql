CREATE VIEW [Arch].[CONOPS_ARCH_DELTA_C_WORST_TRUCK_V] AS


CREATE VIEW [Arch].[CONOPS_ARCH_DELTA_C_WORST_TRUCK_V]
AS
...
group by site_code,truck,deltac_ts,shiftdate,shift_code) b
