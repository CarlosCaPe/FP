CREATE VIEW [Arch].[CONOPS_ARCH_SP_DELTA_C_AVG_V] AS



CREATE VIEW [Arch].[CONOPS_ARCH_SP_DELTA_C_AVG_V]
AS
...
GROUP BY site_code,shiftdate,shift_code,excav,soper,soperid) a
