CREATE VIEW [Arch].[CONOPS_ARCH_DELTA_C_WORST_SHOVEL_V] AS


CREATE VIEW [Arch].[CONOPS_ARCH_DELTA_C_WORST_SHOVEL_V]
AS
...
group by site_code,excav,deltac_ts,shiftdate,shift_code) b
