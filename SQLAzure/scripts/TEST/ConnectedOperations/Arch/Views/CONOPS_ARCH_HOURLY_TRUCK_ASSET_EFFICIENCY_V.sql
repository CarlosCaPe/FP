CREATE VIEW [Arch].[CONOPS_ARCH_HOURLY_TRUCK_ASSET_EFFICIENCY_V] AS


CREATE VIEW [Arch].[CONOPS_ARCH_HOURLY_TRUCK_ASSET_EFFICIENCY_V]
AS
...
on [truckAE].SHIFTINDEX = [shift].ShiftIndex AND [truckAE].[siteflag] = [shift].[siteflag]
