CREATE VIEW [MOR].[CONOPS_MOR_DAILY_EOS_CRUSHER_STATS_V] AS



--SELECT * FROM [mor].[CONOPS_MOR_DAILY_EOS_CRUSHER_STATS_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [mor].[CONOPS_MOR_DAILY_EOS_CRUSHER_STATS_V]
AS
