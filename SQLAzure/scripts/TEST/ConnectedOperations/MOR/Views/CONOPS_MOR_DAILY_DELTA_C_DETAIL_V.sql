CREATE VIEW [MOR].[CONOPS_MOR_DAILY_DELTA_C_DETAIL_V] AS



--select * from [MOR].[CONOPS_MOR_DAILY_DELTA_C_DETAIL_V] 
CREATE VIEW [MOR].[CONOPS_MOR_DAILY_DELTA_C_DETAIL_V] 
AS
...
LEFT JOIN Targets d
	ON FORMAT(a.ShiftStartDateTime, 'yyyy-MM') = FORMAT(d.DateEffective, 'yyyy-MM')
