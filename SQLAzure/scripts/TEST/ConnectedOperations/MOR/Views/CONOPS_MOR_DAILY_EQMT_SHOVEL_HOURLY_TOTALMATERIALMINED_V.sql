CREATE VIEW [MOR].[CONOPS_MOR_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS
...
--select * from [mor].[CONOPS_MOR_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq    
CREATE VIEW [mor].[CONOPS_MOR_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]    
AS    
