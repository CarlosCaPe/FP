CREATE VIEW [MOR].[CONOPS_MOR_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] AS
  
  
--select * from [mor].[CONOPS_MOR_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]  
CREATE VIEW [mor].[CONOPS_MOR_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]   
AS  
