CREATE VIEW [MOR].[CONOPS_MOR_EOS_LINEUP_EQUIPMENT_V] AS


-- SELECT * FROM [mor].[CONOPS_MOR_EOS_LINEUP_EQUIPMENT_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [mor].[CONOPS_MOR_EOS_LINEUP_EQUIPMENT_V] 
AS
...
FROM [mor].[CONOPS_MOR_EOS_LINEUP_SHOVEL_V] 
...
FROM [mor].[CONOPS_MOR_EOS_LINEUP_TRUCK_V]
GROUP BY siteflag, shiftflag,shiftid
...
FROM [mor].[CONOPS_MOR_EOS_LINEUP_DRILL_V]
GROUP BY siteflag, shiftflag, shiftid
...
FROM [mor].[CONOPS_MOR_EOS_LINEUP_EQMT_OTHER_V]
