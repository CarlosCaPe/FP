CREATE VIEW [MOR].[CONOPS_MOR_DAILY_SHOVEL_SHIFT_TARGET_V] AS


  
  
  
--select * from [mor].[CONOPS_MOR_DAILY_SHOVEL_SHIFT_TARGET_V] where shiftflag = 'curr'  
CREATE VIEW [mor].[CONOPS_MOR_DAILY_SHOVEL_SHIFT_TARGET_V]  
AS  
...
FROM 
    [mor].[CONOPS_MOR_EOS_SHIFT_INFO_V] a
LEFT JOIN 
