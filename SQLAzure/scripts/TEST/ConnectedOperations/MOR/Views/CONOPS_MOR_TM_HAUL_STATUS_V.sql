CREATE VIEW [MOR].[CONOPS_MOR_TM_HAUL_STATUS_V] AS





-- SELECT * FROM [mor].[CONOPS_MOR_TM_HAUL_STATUS_V] WITH (NOLOCK)
CREATE VIEW [mor].[CONOPS_MOR_TM_HAUL_STATUS_V] 
AS
	...
	LEFT JOIN [mor].[CONOPS_MOR_DELTA_C_DETAIL_V] [dt]
