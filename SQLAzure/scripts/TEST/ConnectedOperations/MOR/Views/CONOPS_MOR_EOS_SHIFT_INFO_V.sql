CREATE VIEW [MOR].[CONOPS_MOR_EOS_SHIFT_INFO_V] AS
...
--select * from [mor].[CONOPS_MOR_EOS_SHIFT_INFO_V] order by shiftflag  
  
CREATE VIEW [mor].[CONOPS_MOR_EOS_SHIFT_INFO_V]   
AS  
