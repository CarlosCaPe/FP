CREATE VIEW [MOR].[CONOPS_MOR_DAILY_DRILL_ASSET_EFFICIENCY_V] AS





--select * from [mor].[CONOPS_MOR_DAILY_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [mor].[CONOPS_MOR_DAILY_DRILL_ASSET_EFFICIENCY_V] 
AS
...
(
	...
	from [MOR].[DRILL_ASSET_EFFICIENCY_V] [ae] (NOLOCK)
	RIGHT JOIN [MOR].[CONOPS_MOR_EOS_SHIFT_INFO_V] [shift] WITH (NOLOCK)
