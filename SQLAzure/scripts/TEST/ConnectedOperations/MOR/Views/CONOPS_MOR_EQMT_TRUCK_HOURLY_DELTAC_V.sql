CREATE VIEW [MOR].[CONOPS_MOR_EQMT_TRUCK_HOURLY_DELTAC_V] AS



--select * from [mor].[CONOPS_MOR_EQMT_TRUCK_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = '708'
CREATE VIEW [mor].[CONOPS_MOR_EQMT_TRUCK_HOURLY_DELTAC_V]
AS
