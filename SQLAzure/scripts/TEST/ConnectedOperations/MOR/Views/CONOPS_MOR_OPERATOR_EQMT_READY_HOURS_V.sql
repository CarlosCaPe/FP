CREATE VIEW [MOR].[CONOPS_MOR_OPERATOR_EQMT_READY_HOURS_V] AS



--select * from [MOR].[CONOPS_MOR_OPERATOR_EQMT_READY_HOURS_V]
CREATE VIEW [MOR].[CONOPS_MOR_OPERATOR_EQMT_READY_HOURS_V]
AS
