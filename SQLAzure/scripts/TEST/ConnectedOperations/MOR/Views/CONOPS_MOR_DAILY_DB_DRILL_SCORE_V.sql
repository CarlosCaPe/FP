CREATE VIEW [MOR].[CONOPS_MOR_DAILY_DB_DRILL_SCORE_V] AS
  
  
  
  
--select * from [mor].[CONOPS_MOR_DAILY_DB_DRILL_SCORE_V] WITH (NOLOCK) where shiftflag = 'prev'  
CREATE VIEW [mor].[CONOPS_MOR_DAILY_DB_DRILL_SCORE_V]  
AS  
