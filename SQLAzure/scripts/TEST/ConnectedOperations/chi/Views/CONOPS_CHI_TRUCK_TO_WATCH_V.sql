CREATE VIEW [chi].[CONOPS_CHI_TRUCK_TO_WATCH_V] AS




-- SELECT * FROM [chi].[CONOPS_CHI_TRUCK_TO_WATCH_V] WITH (NOLOCK) WHERE [TruckID] = 'T501'
CREATE VIEW [chi].[CONOPS_CHI_TRUCK_TO_WATCH_V]
AS
...
LEFT JOIN [chi].[CONOPS_CHI_TRUCK_SHIFT_OVERVIEW_V] [tm]
