CREATE VIEW [chi].[CONOPS_CHI_DRILL_DETAIL_PER_HOUR_V] AS
  
    
    
    
-- SELECT * FROM [chi].[CONOPS_CHI_DRILL_DETAIL_PER_HOUR_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' ORDER BY [DRILL_ID]    
CREATE VIEW [chi].[CONOPS_CHI_DRILL_DETAIL_PER_HOUR_V]    
AS    
