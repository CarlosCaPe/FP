CREATE VIEW [chi].[CONOPS_CHI_CRUSHER_STATUS_DETAIL_V] AS




--SELECT * FROM [CHI].[CONOPS_CHI_CRUSHER_STATUS_DETAIL_V]
CREATE VIEW [CHI].[CONOPS_CHI_CRUSHER_STATUS_DETAIL_V]
AS
