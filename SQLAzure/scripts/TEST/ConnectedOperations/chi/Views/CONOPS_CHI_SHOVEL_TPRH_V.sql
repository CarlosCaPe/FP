CREATE VIEW [chi].[CONOPS_CHI_SHOVEL_TPRH_V] AS

--select * from [chi].[CONOPS_CHI_SHOVEL_TPRH_V] where shiftflag = 'curr'
CREATE VIEW [chi].[CONOPS_CHI_SHOVEL_TPRH_V] 
AS
...
SELECT 
	...
	COUNT(*) AS LoadCount
FROM CHI.SHIFT_LOAD_DETAIL_V (NOLOCK)
