CREATE VIEW [chi].[CONOPS_CHI_TRUCK_POPUP_V] AS




-- SELECT * FROM [chi].[CONOPS_CHI_TRUCK_POPUP_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'  
CREATE VIEW [chi].[CONOPS_CHI_TRUCK_POPUP_V]   
AS  
...
LEFT JOIN [chi].[CONOPS_CHI_TP_AVG_PAYLOAD_V] [payload] WITH (NOLOCK) 
