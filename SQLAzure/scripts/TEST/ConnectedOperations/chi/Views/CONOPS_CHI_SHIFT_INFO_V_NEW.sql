CREATE VIEW [chi].[CONOPS_CHI_SHIFT_INFO_V_NEW] AS
...
--SELECT * FROM [CHI].[CONOPS_CHI_SHIFT_INFO_V_NEW]  
  
CREATE VIEW [CHI].[CONOPS_CHI_SHIFT_INFO_V_NEW] WITH SCHEMABINDING   
AS  
