CREATE VIEW [chi].[CONOPS_CHI_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS
...
--select * from [chi].[CONOPS_CHI_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq    
CREATE VIEW [chi].[CONOPS_CHI_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]    
AS    
