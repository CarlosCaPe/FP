CREATE VIEW [chi].[CONOPS_CHI_EOS_IOS_STOCKPILE_V] AS
  

--SELECT * FROM [chi].[CONOPS_CHI_EOS_IOS_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [chi].[CONOPS_CHI_EOS_IOS_STOCKPILE_V]    
AS    
