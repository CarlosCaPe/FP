CREATE VIEW [chi].[CONOPS_CHI_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V] AS

  
--select * from [chi].[CONOPS_CHI_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
CREATE VIEW [chi].[CONOPS_CHI_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
AS  
