CREATE VIEW [chi].[CONOPS_CHI_DAILY_EOS_TOTAL_MATERIAL_V] AS
...
--select * from [chi].[CONOPS_CHI_DAILY_EOS_TOTAL_MATERIAL_V]  
CREATE VIEW [chi].[CONOPS_CHI_DAILY_EOS_TOTAL_MATERIAL_V]  
AS  
