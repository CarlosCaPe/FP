CREATE VIEW [chi].[CONOPS_CHI_EOS_DRILLED_HOLES_V] AS



--SELECT * FROM [CHI].[CONOPS_CHI_EOS_DRILLED_HOLES_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [CHI].[CONOPS_CHI_EOS_DRILLED_HOLES_V]
AS
