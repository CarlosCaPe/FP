CREATE VIEW [chi].[CONOPS_CHI_EOS_ASSET_EFFICIENCY_V] AS
...
--SELECT * FROM [CHI].[CONOPS_CHI_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [chi].[CONOPS_CHI_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [CHI].[CONOPS_CHI_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [CHI].[CONOPS_CHI_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [CHI].[CONOPS_CHI_DRILL_ASSET_EFFICIENCY_V]
)
