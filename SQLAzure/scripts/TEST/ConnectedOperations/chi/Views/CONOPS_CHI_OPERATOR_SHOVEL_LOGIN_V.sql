CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_SHOVEL_LOGIN_V] AS



-- SELECT * FROM [chi].[CONOPS_CHI_OPERATOR_SHOVEL_LOGIN_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_SHOVEL_LOGIN_V] 
AS
