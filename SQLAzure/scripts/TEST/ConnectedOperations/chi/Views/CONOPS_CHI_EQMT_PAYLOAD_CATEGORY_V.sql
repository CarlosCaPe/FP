CREATE VIEW [chi].[CONOPS_CHI_EQMT_PAYLOAD_CATEGORY_V] AS
  
  
-- SELECT * FROM [chi].[CONOPS_CHI_EQMT_PAYLOAD_CATEGORY_V] WHERE shiftindex = '38822'  
CREATE VIEW [chi].[CONOPS_CHI_EQMT_PAYLOAD_CATEGORY_V]  
AS  
...
shiftindex,  
ShovelId,  
CASE WHEN eqmttype = 'CAT793BUL' AND measureton BETWEEN 150 AND 244 THEN 'UnderLoaded'  
WHEN eqmttype = 'CAT793BUL' AND measureton BETWEEN 245 AND 257 THEN 'BelowTarget'  
WHEN eqmttype = 'CAT793BUL' AND measureton BETWEEN 258 AND 285 THEN 'OnTarget'  
WHEN eqmttype = 'CAT793BUL' AND measureton BETWEEN 286 AND 299 THEN 'AboveTarget'  
WHEN eqmttype = 'CAT793BUL' AND measureton BETWEEN 300 AND 400 THEN 'OverLoaded'  
  
WHEN eqmttype = 'CAT793CUL' AND measureton BETWEEN 150 AND 244 THEN 'UnderLoaded'  
WHEN eqmttype = 'CAT793CUL' AND measureton BETWEEN 245 AND 257 THEN 'BelowTarget'  
WHEN eqmttype = 'CAT793CUL' AND measureton BETWEEN 258 AND 285 THEN 'OnTarget'  
WHEN eqmttype = 'CAT793CUL' AND measureton BETWEEN 286 AND 299 THEN 'AboveTarget'  
WHEN eqmttype = 'CAT793CUL' AND measureton BETWEEN 300 AND 400 THEN 'OverLoaded'  
