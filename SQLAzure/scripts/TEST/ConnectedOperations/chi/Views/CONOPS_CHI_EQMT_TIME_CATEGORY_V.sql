CREATE VIEW [chi].[CONOPS_CHI_EQMT_TIME_CATEGORY_V] AS


--select * from [chi].[CONOPS_CHI_EQMT_TIME_CATEGORY_V] WITH(NOLOCK)
CREATE VIEW [chi].[CONOPS_CHI_EQMT_TIME_CATEGORY_V] 
AS
