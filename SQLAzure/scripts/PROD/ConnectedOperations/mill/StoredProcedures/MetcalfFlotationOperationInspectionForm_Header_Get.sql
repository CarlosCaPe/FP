...
/******************************************************************  
* PROCEDURE	: mill.[MetcalfFlotationOperationInspectionForm_Header_Get]
* PURPOSE	: 
* NOTES		: 
* CREATED	: sxavier
* SAMPLE	: 
	1. EXEC [mill].[MetcalfFlotationOperationInspectionForm_Header_Get] 'MOR', 'PREV'

* MODIFIED DATE     AUTHOR			DESCRIPTION  
*------------------------------------------------------------------  
* {11 Dec 2024}		{sxavier}		{Initial Created}
*******************************************************************/ 
CREATE PROCEDURE [mill].[MetcalfFlotationOperationInspectionForm_Header_Get]
(
	@SiteCode VARCHAR(3),
	@ShiftCode VARCHAR(4)
)
	...
	Rounds AS (
		...
		FROM (
			SELECT TOP 1
				...
				1 AS IsRound0
			FROM
				mill.METCALF_FLOTATION_OPERATION_INSPECTION_FORM_V A
			WHERE
