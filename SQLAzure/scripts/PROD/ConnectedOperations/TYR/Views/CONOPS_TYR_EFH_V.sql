CREATE VIEW [TYR].[CONOPS_TYR_EFH_V] AS
...
--SELECT * FROM [tyr].[CONOPS_TYR_EFH_V] where shiftflag = 'curr'  
CREATE VIEW [TYR].[CONOPS_TYR_EFH_V]  
AS  
...
RIGHT JOIN [TYR].[CONOPS_TYR_SHIFT_INFO_V] b
