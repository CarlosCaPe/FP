CREATE VIEW [TYR].[CONOPS_TYR_OPERATOR_SHOVEL_LIST_V] AS





-- SELECT * FROM [tyr].[CONOPS_TYR_OPERATOR_SHOVEL_LIST_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [TYR].[CONOPS_TYR_OPERATOR_SHOVEL_LIST_V]
AS
