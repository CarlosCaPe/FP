CREATE VIEW [TYR].[CONOPS_TYR_OPERATOR_TRUCK_DETAIL_DELTA_C_V] AS



-- SELECT * FROM [tyr].[CONOPS_TYR_OPERATOR_TRUCK_DETAIL_DELTA_C_V] WITH (NOLOCK) WHERE shiftflag = 'PREV'  
CREATE VIEW [TYR].[CONOPS_TYR_OPERATOR_TRUCK_DETAIL_DELTA_C_V]   
AS  
...
0 HTOSTarget,
CASE WHEN ([shift].ShiftDuration/3600.00) = 0 OR [Availability] IS NULL THEN 0
...
LEFT JOIN [tyr].[CONOPS_TYR_TRUCK_POPUP_V] [pop]
