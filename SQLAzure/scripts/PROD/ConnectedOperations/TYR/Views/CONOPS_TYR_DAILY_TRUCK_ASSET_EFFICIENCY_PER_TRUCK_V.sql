CREATE VIEW [TYR].[CONOPS_TYR_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] AS



  
  
--select * from [tyr].[CONOPS_TYR_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]  
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]   
AS  
