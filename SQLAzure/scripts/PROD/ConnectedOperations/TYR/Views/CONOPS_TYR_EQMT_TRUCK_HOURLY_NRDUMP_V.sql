CREATE VIEW [TYR].[CONOPS_TYR_EQMT_TRUCK_HOURLY_NRDUMP_V] AS

--SELECT * FROM [tyr].[CONOPS_TYR_EQMT_TRUCK_HOURLY_NRDUMP_V] WHERE shiftflag = 'prev' and equipment = 'C101'

CREATE VIEW [TYR].[CONOPS_TYR_EQMT_TRUCK_HOURLY_NRDUMP_V]
AS
...
SELECT
	...
	DUMPTIME_HOS AS HOS
FROM TYR.SHIFT_DUMP_DETAIL_V WITH (NOLOCK)
