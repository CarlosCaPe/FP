CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_CRUSHER_STATS_V] AS


--SELECT * FROM [tyr].[CONOPS_TYR_DAILY_EOS_CRUSHER_STATS_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [tyr].[CONOPS_TYR_DAILY_EOS_CRUSHER_STATS_V]    
AS    
