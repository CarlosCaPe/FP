CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_TONS_MINED_V] AS

--SELECT * FROM [tyr].[CONOPS_TYR_DAILY_EOS_TONS_MINED_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_TONS_MINED_V]
AS
...
FROM(
	...
	FROM [TYR].[CONOPS_TYR_DAILY_EOS_TOTAL_MATERIAL_V] ov
	LEFT JOIN [TYR].[CONOPS_TYR_SHIFT_BASE_TARGET_V] t
