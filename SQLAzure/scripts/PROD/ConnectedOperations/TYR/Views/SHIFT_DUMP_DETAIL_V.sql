CREATE VIEW [TYR].[SHIFT_DUMP_DETAIL_V] AS

--SELECT * FROM TYR.SHIFT_DUMP_DETAIL_V
CREATE VIEW [TYR].[SHIFT_DUMP_DETAIL_V]
AS
...
SELECT
	...
	FieldMeasuretime,
	FieldWeightst
FROM TYR.SHIFT_DUMP WITH (NOLOCK)
)
