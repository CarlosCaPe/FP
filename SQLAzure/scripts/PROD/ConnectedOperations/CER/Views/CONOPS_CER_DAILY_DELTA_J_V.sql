CREATE VIEW [CER].[CONOPS_CER_DAILY_DELTA_J_V] AS
...
--select * from [cer].[CONOPS_CER_DAILY_DELTA_J_V]       
CREATE VIEW [cer].[CONOPS_CER_DAILY_DELTA_J_V]       
AS      
...
TimeInHour,      
Shiftseq      
FROM [cer].[CONOPS_CER_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]      
...
shiftid,      
shiftTarget      
from [cer].[CONOPS_CER_SHIFT_TARGET_V]),      
