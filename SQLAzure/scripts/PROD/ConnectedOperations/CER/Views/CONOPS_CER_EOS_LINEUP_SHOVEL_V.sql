CREATE VIEW [CER].[CONOPS_CER_EOS_LINEUP_SHOVEL_V] AS




-- SELECT * FROM [cer].[CONOPS_CER_EOS_LINEUP_SHOVEL_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [cer].[CONOPS_CER_EOS_LINEUP_SHOVEL_V] 
AS
