CREATE VIEW [CER].[CONOPS_CER_EOS_HAULAGE_V] AS
...
--SELECT * FROM [CER].[CONOPS_CER_EOS_HAULAGE_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [cer].[CONOPS_CER_EOS_HAULAGE_V]
AS
...
FROM(
	...
	FROM [CER].[CONOPS_CER_DELTA_C_DETAIL_V] [dc]
