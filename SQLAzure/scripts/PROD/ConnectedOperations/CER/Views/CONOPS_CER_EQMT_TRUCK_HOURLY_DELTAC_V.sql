CREATE VIEW [CER].[CONOPS_CER_EQMT_TRUCK_HOURLY_DELTAC_V] AS



--select * from [cer].[CONOPS_CER_EQMT_TRUCK_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = '708'
CREATE VIEW [cer].[CONOPS_CER_EQMT_TRUCK_HOURLY_DELTAC_V]
AS
