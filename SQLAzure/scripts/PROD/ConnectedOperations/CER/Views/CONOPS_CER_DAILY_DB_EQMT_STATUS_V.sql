CREATE VIEW [CER].[CONOPS_CER_DAILY_DB_EQMT_STATUS_V] AS
  
  
  
    
    
--SELECT * FROM [CER].[CONOPS_CER_DAILY_DB_EQMT_STATUS_V] WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [CER].[CONOPS_CER_DAILY_DB_EQMT_STATUS_V]    
AS    
...
LEFT JOIN (    
   SELECT SHIFTINDEX,    
             ...
             REASON,    
             [STATUS]    
      FROM [CER].[DRILL_ASSET_EFFICIENCY_V] (NOLOCK)    
