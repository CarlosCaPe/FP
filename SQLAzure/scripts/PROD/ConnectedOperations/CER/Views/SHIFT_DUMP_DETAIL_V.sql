CREATE VIEW [CER].[SHIFT_DUMP_DETAIL_V] AS

--SELECT * FROM CER.SHIFT_DUMP_DETAIL_V
CREATE VIEW [CER].[SHIFT_DUMP_DETAIL_V]
AS
...
SELECT
	...
	FieldMeasuretime,
	FieldWeightst
FROM CER.SHIFT_DUMP WITH (NOLOCK)
)
