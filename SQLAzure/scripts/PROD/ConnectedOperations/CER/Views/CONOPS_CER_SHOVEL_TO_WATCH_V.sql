CREATE VIEW [CER].[CONOPS_CER_SHOVEL_TO_WATCH_V] AS
  
  
  
  
--select * from [cer].[CONOPS_CER_SHOVEL_TO_WATCH_V] where shiftflag = 'curr'  
CREATE VIEW [cer].[CONOPS_CER_SHOVEL_TO_WATCH_V]  
AS  
