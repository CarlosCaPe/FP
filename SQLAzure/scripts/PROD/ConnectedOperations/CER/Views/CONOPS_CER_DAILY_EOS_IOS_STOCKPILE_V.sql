CREATE VIEW [CER].[CONOPS_CER_DAILY_EOS_IOS_STOCKPILE_V] AS


  
    
  
--SELECT * FROM [cer].[CONOPS_CER_DAILY_EOS_IOS_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [cer].[CONOPS_CER_DAILY_EOS_IOS_STOCKPILE_V]      
AS      
