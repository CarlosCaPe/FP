CREATE VIEW [CER].[CONOPS_CER_OPERATOR_TRUCK_LIST_V] AS



-- SELECT * FROM [cer].[CONOPS_CER_OPERATOR_TRUCK_LIST_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'   
CREATE VIEW [cer].[CONOPS_CER_OPERATOR_TRUCK_LIST_V]   
AS  
