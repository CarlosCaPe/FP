CREATE VIEW [CER].[CONOPS_CER_HOURLY_TOTALMATERIALMINED_V] AS





--select * from [cer].[CONOPS_CER_HOURLY_TOTALMATERIALMINED_V] order by shiftseq      
CREATE VIEW [cer].[CONOPS_CER_HOURLY_TOTALMATERIALMINED_V]      
AS
