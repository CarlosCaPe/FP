CREATE VIEW [CER].[CONOPS_CER_DAILY_EOS_IOS_STOCKPILE_HOURLY_V] AS
...
--SELECT * FROM [CER].[CONOPS_CER_DAILY_EOS_IOS_STOCKPILE_HOURLY_V] WHERE shiftflag = 'PREV'  
CREATE VIEW [cer].[CONOPS_CER_DAILY_EOS_IOS_STOCKPILE_HOURLY_V]  
AS  
...
LEFT JOIN [CER].[CONOPS_CER_EOS_SHIFT_INFO_V] s WITH (NOLOCK)    
