CREATE VIEW [CER].[CONOPS_CER_DB_DRILL_TO_WATCH_V] AS
...
--select * from [cer].[CONOPS_CER_DB_DRILL_TO_WATCH_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [cer].[CONOPS_CER_DB_DRILL_TO_WATCH_V]
AS
