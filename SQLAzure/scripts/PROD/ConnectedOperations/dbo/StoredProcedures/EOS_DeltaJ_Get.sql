...
* SAMPLE	: 
	1. EXEC dbo.EOS_DeltaJ_Get 'CURR', 'BAG', 0
...
BEGIN TRY
	...
	BEGIN
		...
		SELECT
			...
			ShovelAvailabilityTarget AS UseOfAvailabilityTarget,
		...
		CROSS JOIN BAG.CONOPS_BAG_EQMT_ASSET_EFFICIENCY_TARGET_V c
		WHERE b.eqmtunit = 2
		AND a.shiftflag = @SHIFT
		GROUP BY TimeinHour, ShovelAvailabilityTarget, EFHTarget;
		END
