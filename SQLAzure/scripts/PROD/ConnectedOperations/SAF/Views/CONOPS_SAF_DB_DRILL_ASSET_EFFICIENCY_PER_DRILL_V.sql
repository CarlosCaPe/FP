CREATE VIEW [SAF].[CONOPS_SAF_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V] AS


  
  
--select * from [saf].[CONOPS_SAF_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
CREATE VIEW [saf].[CONOPS_SAF_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
AS  
