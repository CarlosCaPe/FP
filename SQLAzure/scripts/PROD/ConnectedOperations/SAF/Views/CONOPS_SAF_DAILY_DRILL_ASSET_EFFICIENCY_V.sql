CREATE VIEW [SAF].[CONOPS_SAF_DAILY_DRILL_ASSET_EFFICIENCY_V] AS
...
--select * from [saf].[CONOPS_SAF_DAILY_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [saf].[CONOPS_SAF_DAILY_DRILL_ASSET_EFFICIENCY_V] 
AS
...
(
	...
	from [SAF].[DRILL_ASSET_EFFICIENCY_V] [ae] (NOLOCK)
	RIGHT JOIN [SAF].[CONOPS_SAF_EOS_SHIFT_INFO_V] [shift] WITH (NOLOCK)
