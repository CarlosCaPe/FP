CREATE VIEW [SAF].[CONOPS_SAF_DAILY_EOS_DRILLED_HOLES_V] AS
  
  
  
--SELECT * FROM [SAF].[CONOPS_SAF_DAILY_EOS_DRILLED_HOLES_V] WHERE SHIFTFLAG = 'PREV'  
CREATE VIEW [SAF].[CONOPS_SAF_DAILY_EOS_DRILLED_HOLES_V]  
AS  
...
(  
 ...
 FROM [SAF].[CONOPS_SAF_DAILY_DB_DRILL_PLAN_V] (NOLOCK)  
