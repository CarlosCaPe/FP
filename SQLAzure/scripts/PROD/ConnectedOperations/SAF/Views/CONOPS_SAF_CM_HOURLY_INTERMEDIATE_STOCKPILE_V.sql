CREATE VIEW [SAF].[CONOPS_SAF_CM_HOURLY_INTERMEDIATE_STOCKPILE_V] AS
...
--SELECT * FROM [saf].[CONOPS_SAF_CM_HOURLY_INTERMEDIATE_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [saf].[CONOPS_SAF_CM_HOURLY_INTERMEDIATE_STOCKPILE_V]
AS    
