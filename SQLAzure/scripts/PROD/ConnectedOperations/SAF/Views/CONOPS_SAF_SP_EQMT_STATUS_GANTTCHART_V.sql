CREATE VIEW [SAF].[CONOPS_SAF_SP_EQMT_STATUS_GANTTCHART_V] AS




--select * from [saf].[CONOPS_SAF_SP_EQMT_STATUS_GANTTCHART_V] where shiftflag = 'prev'
CREATE VIEW [saf].[CONOPS_SAF_SP_EQMT_STATUS_GANTTCHART_V]
AS
...
eqmt,
tprh 
FROM [saf].[CONOPS_SAF_SHOVEL_TPRH_V] WITH (NOLOCK)
WHERE site_code = 'SAF')
