CREATE VIEW [SAF].[CONOPS_SAF_DAILY_EOS_CRUSHER_NON_UTILIZED_REASON_V] AS

--SELECT * FROM [SAF].[CONOPS_SAF_DAILY_EOS_CRUSHER_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [SAF].[CONOPS_SAF_DAILY_EOS_CRUSHER_NON_UTILIZED_REASON_V]  
AS  
