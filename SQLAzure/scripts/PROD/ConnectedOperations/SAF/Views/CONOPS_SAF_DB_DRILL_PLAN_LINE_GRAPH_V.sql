CREATE VIEW [SAF].[CONOPS_SAF_DB_DRILL_PLAN_LINE_GRAPH_V] AS
...
--SELECT * FROM [SAF].[CONOPS_SAF_DB_DRILL_PLAN_LINE_GRAPH_V] WHERE shiftflag = 'PREV'
CREATE VIEW [SAF].[CONOPS_SAF_DB_DRILL_PLAN_LINE_GRAPH_V]
AS
