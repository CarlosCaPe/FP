CREATE VIEW [SAF].[CONOPS_SAF_DAILY_DB_DRILL_SCORE_V] AS
  
  
  
  
--select * from [saf].[CONOPS_SAF_DAILY_DB_DRILL_SCORE_V] WITH (NOLOCK) where shiftflag = 'prev'  
CREATE VIEW [saf].[CONOPS_SAF_DAILY_DB_DRILL_SCORE_V]  
AS  
