CREATE VIEW [SAF].[CONOPS_SAF_OPERATOR_EQMT_READY_HOURS_V] AS



--select * from [SAF].[CONOPS_SAF_OPERATOR_EQMT_READY_HOURS_V]
CREATE VIEW [SAF].[CONOPS_SAF_OPERATOR_EQMT_READY_HOURS_V]
AS
