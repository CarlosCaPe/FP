CREATE VIEW [CLI].[CONOPS_CLI_OPERATOR_HAS_LATE_START_V] AS

  
    
-- SELECT * FROM [cli].[CONOPS_CLI_OPERATOR_HAS_LATE_START_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'    
CREATE VIEW [cli].[CONOPS_CLI_OPERATOR_HAS_LATE_START_V]     
AS    
...
SELECT [shift].shiftflag,    
    ...
    ELSE concat(lookups.[value],RIGHT('0000000000' + [OperatorId], 10),'.jpg') END as OperatorImageURL,    
    OperatorName,    
    [FirstLoginDateTime],    
