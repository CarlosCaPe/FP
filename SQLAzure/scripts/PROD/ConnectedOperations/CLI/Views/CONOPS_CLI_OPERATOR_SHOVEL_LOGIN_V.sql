CREATE VIEW [CLI].[CONOPS_CLI_OPERATOR_SHOVEL_LOGIN_V] AS




-- SELECT * FROM [cli].[CONOPS_CLI_OPERATOR_SHOVEL_LOGIN_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [cli].[CONOPS_CLI_OPERATOR_SHOVEL_LOGIN_V] 
AS
