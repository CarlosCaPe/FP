CREATE VIEW [CLI].[CONOPS_CLI_DAILY_ASSET_EFFICIENCY_V] AS
...
--select * from [cli].[CONOPS_CLI_DAILY_ASSET_EFFICIENCY_V]
CREATE VIEW [cli].[CONOPS_CLI_DAILY_ASSET_EFFICIENCY_V] 
AS
