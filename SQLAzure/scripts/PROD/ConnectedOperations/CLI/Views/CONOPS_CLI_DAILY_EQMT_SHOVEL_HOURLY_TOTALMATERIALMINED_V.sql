CREATE VIEW [CLI].[CONOPS_CLI_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS
...
--select * from [cli].[CONOPS_CLI_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq    
CREATE VIEW [cli].[CONOPS_CLI_DAILY_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]    
AS    
