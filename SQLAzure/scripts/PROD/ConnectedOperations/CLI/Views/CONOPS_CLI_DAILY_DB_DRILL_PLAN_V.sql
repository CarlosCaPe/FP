CREATE VIEW [CLI].[CONOPS_CLI_DAILY_DB_DRILL_PLAN_V] AS
  
  
  
  
--select * from [cli].[CONOPS_CLI_DAILY_DB_DRILL_PLAN_V] where shiftflag = 'prev'  
CREATE VIEW [cli].[CONOPS_CLI_DAILY_DB_DRILL_PLAN_V]  
AS  
 ...
 WITH DrillKPI AS (  
        ...
        WHERE [ds].[SITE_CODE] = 'CLI' AND DRILL_ID IS NOT NULL  
