CREATE VIEW [CLI].[CONOPS_CLI_EOS_LINEUP_EQUIPMENT_V] AS


-- SELECT * FROM [cli].[CONOPS_CLI_EOS_LINEUP_EQUIPMENT_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [cli].[CONOPS_CLI_EOS_LINEUP_EQUIPMENT_V] 
AS
...
FROM [cli].[CONOPS_CLI_EOS_LINEUP_SHOVEL_V] 
...
FROM [cli].[CONOPS_CLI_EOS_LINEUP_TRUCK_V]
GROUP BY siteflag, shiftflag,shiftid
...
FROM [cli].[CONOPS_CLI_EOS_LINEUP_DRILL_V]
GROUP BY siteflag, shiftflag, shiftid
...
FROM [cli].[CONOPS_CLI_EOS_LINEUP_EQMT_OTHER_V]
