CREATE VIEW [CLI].[CONOPS_CLI_EQMT_TRUCK_HOURLY_DELTAC_V] AS



--select * from [cli].[CONOPS_CLI_EQMT_TRUCK_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = '708'
CREATE VIEW [cli].[CONOPS_CLI_EQMT_TRUCK_HOURLY_DELTAC_V]
AS
