CREATE VIEW [CLI].[CONOPS_CLI_EOS_HAULAGE_V] AS
...
--SELECT * FROM [CLI].[CONOPS_CLI_EOS_HAULAGE_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [cli].[CONOPS_CLI_EOS_HAULAGE_V]
AS
...
FROM(
	...
	FROM [CLI].[CONOPS_CLI_DELTA_C_DETAIL_V] [dc]
