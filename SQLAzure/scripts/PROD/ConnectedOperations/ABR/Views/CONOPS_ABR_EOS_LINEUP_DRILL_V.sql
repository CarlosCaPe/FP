CREATE VIEW [ABR].[CONOPS_ABR_EOS_LINEUP_DRILL_V] AS



  
--select * from [abr].[CONOPS_ABR_EOS_LINEUP_DRILL_V] WHERE shiftflag = 'curr'  
CREATE VIEW [ABR].[CONOPS_ABR_EOS_LINEUP_DRILL_V]  
AS  
