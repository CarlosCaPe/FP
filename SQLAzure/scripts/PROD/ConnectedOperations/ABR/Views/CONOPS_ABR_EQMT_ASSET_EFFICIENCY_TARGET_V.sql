CREATE VIEW [ABR].[CONOPS_ABR_EQMT_ASSET_EFFICIENCY_TARGET_V] AS
...
--select * from [abr].[CONOPS_ABR_EQMT_ASSET_EFFICIENCY_TARGET_V]
CREATE VIEW [ABR].[CONOPS_ABR_EQMT_ASSET_EFFICIENCY_TARGET_V]
AS
/*
WITH AeTarget AS(
SELECT TOP 1
...
FROM [abr].[plan_values_prod_sum] ps WITH (NOLOCK)
