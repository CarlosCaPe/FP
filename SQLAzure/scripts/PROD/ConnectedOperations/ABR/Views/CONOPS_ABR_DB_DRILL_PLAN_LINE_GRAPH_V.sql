CREATE VIEW [ABR].[CONOPS_ABR_DB_DRILL_PLAN_LINE_GRAPH_V] AS




--SELECT * FROM [abr].[CONOPS_ABR_DB_DRILL_PLAN_LINE_GRAPH_V] WHERE shiftflag = 'PREV'
CREATE VIEW [ABR].[CONOPS_ABR_DB_DRILL_PLAN_LINE_GRAPH_V]
AS
...
ON a.shiftindex = b.shiftindex AND b.SITE_CODE = 'ELA'),
