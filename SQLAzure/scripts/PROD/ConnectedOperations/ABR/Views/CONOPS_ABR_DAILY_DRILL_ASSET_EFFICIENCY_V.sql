CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DRILL_ASSET_EFFICIENCY_V] AS
...
--select * from [ABR].[CONOPS_ABR_DAILY_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DRILL_ASSET_EFFICIENCY_V] 
AS
...
(
	...
	from [ABR].[DRILL_ASSET_EFFICIENCY_V] [ae] (NOLOCK)
	RIGHT JOIN [ABR].[CONOPS_ABR_EOS_SHIFT_INFO_V] [shift] WITH (NOLOCK)
