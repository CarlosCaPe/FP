CREATE VIEW [ABR].[CONOPS_ABR_TM_TRAFFIC_STOCKPILE_V] AS



  
--SELECT * FROM [abr].[CONOPS_ABR_TM_TRAFFIC_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [ABR].[CONOPS_ABR_TM_TRAFFIC_STOCKPILE_V]      
AS      
 ...
 WITH STOCKPILE AS (    
  ...
  LEFT JOIN [abr].ENUM enumUnit  WITH (NOLOCK)    
