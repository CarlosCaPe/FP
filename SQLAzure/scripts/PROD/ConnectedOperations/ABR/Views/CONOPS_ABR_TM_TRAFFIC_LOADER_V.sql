CREATE VIEW [ABR].[CONOPS_ABR_TM_TRAFFIC_LOADER_V] AS



  
--SELECT * FROM [abr].[CONOPS_ABR_TM_TRAFFIC_LOADER_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [ABR].[CONOPS_ABR_TM_TRAFFIC_LOADER_V]      
AS      
