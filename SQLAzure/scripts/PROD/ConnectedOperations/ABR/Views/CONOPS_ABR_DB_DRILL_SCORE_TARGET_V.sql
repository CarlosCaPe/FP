CREATE VIEW [ABR].[CONOPS_ABR_DB_DRILL_SCORE_TARGET_V] AS




--select * from [abr].[CONOPS_ABR_DB_DRILL_SCORE_TARGET_V]where shiftflag = 'curr'
CREATE VIEW [ABR].[CONOPS_ABR_DB_DRILL_SCORE_TARGET_V]
AS
/*
...
FROM (
    ...
    FROM [abr].[plan_values_monthly_drilling] (NOLOCK)
) [target]*/
