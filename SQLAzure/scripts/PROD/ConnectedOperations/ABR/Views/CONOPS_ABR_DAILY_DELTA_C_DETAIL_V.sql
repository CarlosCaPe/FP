CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DELTA_C_DETAIL_V] AS
...
--select * from [abr].[CONOPS_ABR_DAILY_DELTA_C_DETAIL_V] 
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_DELTA_C_DETAIL_V] 
AS
