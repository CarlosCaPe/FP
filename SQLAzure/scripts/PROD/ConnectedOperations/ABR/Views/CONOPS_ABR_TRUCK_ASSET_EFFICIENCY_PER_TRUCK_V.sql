CREATE VIEW [ABR].[CONOPS_ABR_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] AS


--select * from [abr].[CONOPS_ABR_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]  
CREATE VIEW [ABR].[CONOPS_ABR_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]   
AS  
