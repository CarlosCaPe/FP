CREATE VIEW [ABR].[SHIFT_DUMP_DETAIL_V] AS

--SELECT * FROM ABR.SHIFT_DUMP_DETAIL_V
CREATE VIEW [ABR].[SHIFT_DUMP_DETAIL_V]
AS
...
SELECT
	...
	FieldMeasuretime,
	FieldWeightst
FROM ABR.SHIFT_DUMP WITH (NOLOCK)
)
