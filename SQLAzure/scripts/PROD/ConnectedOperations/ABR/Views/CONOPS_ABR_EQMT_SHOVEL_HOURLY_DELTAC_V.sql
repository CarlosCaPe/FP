CREATE VIEW [ABR].[CONOPS_ABR_EQMT_SHOVEL_HOURLY_DELTAC_V] AS



--select * from [abr].[CONOPS_ABR_EQMT_SHOVEL_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = 's08'
CREATE VIEW [ABR].[CONOPS_ABR_EQMT_SHOVEL_HOURLY_DELTAC_V]
AS
