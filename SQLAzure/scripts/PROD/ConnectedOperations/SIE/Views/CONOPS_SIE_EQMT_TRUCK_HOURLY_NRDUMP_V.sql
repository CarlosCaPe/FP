CREATE VIEW [SIE].[CONOPS_SIE_EQMT_TRUCK_HOURLY_NRDUMP_V] AS

--SELECT * FROM [sie].[CONOPS_SIE_EQMT_TRUCK_HOURLY_NRDUMP_V] WHERE shiftflag = 'prev' and equipment = 'C101'
CREATE VIEW [sie].[CONOPS_SIE_EQMT_TRUCK_HOURLY_NRDUMP_V]
AS
...
SELECT
	...
	DUMPTIME_HOS AS HOS
FROM SIE.SHIFT_DUMP_DETAIL_V WITH (NOLOCK)
