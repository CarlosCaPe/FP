CREATE VIEW [SIE].[CONOPS_SIE_DELTA_C_COMPONENT_V] AS





--SELECT * FROM SIE.CONOPS_SIE_DELTA_C_COMPONENT_V WHERE SHIFTFLAG = 'CURR' ORDER BY MinsOverExpected DESC
CREATE VIEW SIE.CONOPS_SIE_DELTA_C_COMPONENT_V
AS
...
LEFT JOIN SIE.CONOPS_SIE_SHIFT_INFO_V si
