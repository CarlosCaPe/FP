CREATE VIEW [SIE].[CONOPS_SIE_EOS_SHIFT_INFO_V] AS


  
  
--select * from [sie].[CONOPS_SIE_EOS_SHIFT_INFO_V] order by shiftflag  
  
CREATE VIEW [sie].[CONOPS_SIE_EOS_SHIFT_INFO_V]   
AS  
