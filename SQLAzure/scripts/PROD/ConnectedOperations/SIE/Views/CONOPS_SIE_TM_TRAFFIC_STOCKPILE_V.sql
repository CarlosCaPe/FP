CREATE VIEW [SIE].[CONOPS_SIE_TM_TRAFFIC_STOCKPILE_V] AS
...
--SELECT * FROM [sie].[CONOPS_SIE_TM_TRAFFIC_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [sie].[CONOPS_SIE_TM_TRAFFIC_STOCKPILE_V]      
AS      
 ...
 WITH STOCKPILE AS (    
  ...
  LEFT JOIN [sie].[PIT_LOC_C] loc WITH (NOLOCK)    
  ...
  LEFT JOIN [sie].ENUM e WITH (NOLOCK)    
