CREATE VIEW [SIE].[CONOPS_SIE_HOURLY_DRILL_ASSET_EFFICIENCY_V] AS



--select * from [sie].[CONOPS_SIE_HOURLY_DRILL_ASSET_EFFICIENCY_V] WITH (NOLOCK)
CREATE VIEW [sie].[CONOPS_SIE_HOURLY_DRILL_ASSET_EFFICIENCY_V]
AS
