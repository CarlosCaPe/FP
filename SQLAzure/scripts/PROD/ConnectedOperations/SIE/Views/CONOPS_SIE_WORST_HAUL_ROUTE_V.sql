CREATE VIEW [SIE].[CONOPS_SIE_WORST_HAUL_ROUTE_V] AS




-- SELECT * FROM [sie].[CONOPS_SIE_WORST_HAUL_ROUTE_V] WITH (NOLOCK)
CREATE VIEW [SIE].[CONOPS_SIE_WORST_HAUL_ROUTE_V] 
AS
