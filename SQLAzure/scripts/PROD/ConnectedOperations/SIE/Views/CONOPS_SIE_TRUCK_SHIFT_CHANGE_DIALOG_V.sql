CREATE VIEW [SIE].[CONOPS_SIE_TRUCK_SHIFT_CHANGE_DIALOG_V] AS




-- SELECT * FROM [sie].[CONOPS_SIE_TRUCK_SHIFT_CHANGE_DIALOG_V]
CREATE VIEW [SIE].[CONOPS_SIE_TRUCK_SHIFT_CHANGE_DIALOG_V] 
AS
...
FROM (
	...
	LEFT JOIN [SIE].[CONOPS_SIE_TRUCK_DETAIL_V] [TruckDetail] WITH (NOLOCK)
