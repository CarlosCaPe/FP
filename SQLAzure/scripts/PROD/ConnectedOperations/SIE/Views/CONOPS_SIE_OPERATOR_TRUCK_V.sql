CREATE VIEW [SIE].[CONOPS_SIE_OPERATOR_TRUCK_V] AS



-- SELECT * FROM [sie].[CONOPS_SIE_OPERATOR_TRUCK_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
...
LEFT JOIN [SIE].[CONOPS_SIE_OPERATOR_EQMT_READY_HOURS_V] [rh]
