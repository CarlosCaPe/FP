CREATE VIEW [SIE].[CONOPS_SIE_OPERATOR_DRILL_LOGIN_V] AS



-- SELECT * FROM [SIE].[CONOPS_SIE_OPERATOR_DRILL_LOGIN_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [sie].[CONOPS_SIE_OPERATOR_DRILL_LOGIN_V] 
AS
