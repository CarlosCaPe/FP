CREATE VIEW [SIE].[CONOPS_SIE_TP_EQMT_STATUS_V] AS




--select * from [sie].[CONOPS_SIE_TP_EQMT_STATUS_V] where shiftflag = 'curr'

CREATE VIEW [sie].[CONOPS_SIE_TP_EQMT_STATUS_V] 
AS
...
FROM [sie].[CONOPS_SIE_TP_AVG_PAYLOAD_V] (NOLOCK)
) e
