CREATE VIEW [BAG].[CONOPS_BAG_EOS_CRUSHER_STATS_V] AS



--SELECT * FROM [bag].[CONOPS_BAG_EOS_CRUSHER_STATS_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [bag].[CONOPS_BAG_EOS_CRUSHER_STATS_V]
AS
