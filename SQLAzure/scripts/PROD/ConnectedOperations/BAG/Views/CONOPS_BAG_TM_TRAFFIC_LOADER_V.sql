CREATE VIEW [BAG].[CONOPS_BAG_TM_TRAFFIC_LOADER_V] AS
...
--SELECT * FROM [bag].[CONOPS_BAG_TM_TRAFFIC_LOADER_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [bag].[CONOPS_BAG_TM_TRAFFIC_LOADER_V]      
AS      
