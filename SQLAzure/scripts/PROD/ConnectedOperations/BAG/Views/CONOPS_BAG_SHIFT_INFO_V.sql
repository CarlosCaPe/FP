...
CurrPrevShift AS(
	...
	, [SITE_CODE], [SHIFT_ID], [SHIFT_OID], [SHIFT_NAME], [SHIFT_SUFFIX], [FULL_SHIFT_SUFFIX], [SHIFT_START_DATE], [SHIFT_START_DATE_TIME], [STARTS], [CREW_NAME], [SHIFT_DURATION], [SHIFT_DATE]
	--, *   --Changed from * to Actual Columns Required
...
Last3Shift AS(
	SELECT [SHIFTFLAG], [SITE_CODE], [SHIFT_ID], [SHIFT_OID], [SHIFT_NAME], [SHIFT_SUFFIX], [FULL_SHIFT_SUFFIX], [SHIFT_START_DATE], [SHIFT_START_DATE_TIME], [STARTS], [CREW_NAME], [SHIFT_DURATION], [SHIFT_DATE] 
	--, *   --Changed from * to Actual Columns Required
	FROM CurrPrevShift
	UNION
	SELECT [SHIFTFLAG], [SITE_CODE], [SHIFT_ID], [SHIFT_OID], [SHIFT_NAME], [SHIFT_SUFFIX], [FULL_SHIFT_SUFFIX], [SHIFT_START_DATE], [SHIFT_START_DATE_TIME], [STARTS], [CREW_NAME], [SHIFT_DURATION], [SHIFT_DATE] 
