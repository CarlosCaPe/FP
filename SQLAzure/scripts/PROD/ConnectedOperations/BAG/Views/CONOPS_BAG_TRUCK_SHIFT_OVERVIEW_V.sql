CREATE VIEW [BAG].[CONOPS_BAG_TRUCK_SHIFT_OVERVIEW_V] AS





--select * from [bag].[CONOPS_BAG_TRUCK_SHIFT_OVERVIEW_V] where shiftid = '230221001'
CREATE VIEW [bag].[CONOPS_BAG_TRUCK_SHIFT_OVERVIEW_V]
AS
