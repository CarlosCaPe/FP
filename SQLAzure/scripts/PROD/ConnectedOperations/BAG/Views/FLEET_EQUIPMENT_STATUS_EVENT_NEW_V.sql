CREATE VIEW [BAG].[FLEET_EQUIPMENT_STATUS_EVENT_NEW_V] AS

--SELECT * FROM BAG.FLEET_EQUIPMENT_STATUS_EVENT_NEW_V 
CREATE VIEW BAG.FLEET_EQUIPMENT_STATUS_EVENT_NEW_V 
AS
...
FROM bag.FLEET_EQUIPMENT_DELAY_NEW_V cycledelay
...
LEFT JOIN BAG_MSMODEL.dbo.MACHINE