CREATE VIEW [BAG].[CONOPS_BAG_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] AS

--select * from [bag].[CONOPS_BAG_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V] order by shiftseq
CREATE VIEW [bag].[CONOPS_BAG_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]
AS
