CREATE VIEW [BAG].[CONOPS_BAG_CM_HOURLY_CRUSHER_THROUGHPUT_V] AS





-- SELECT * FROM [bag].[CONOPS_BAG_CM_HOURLY_CRUSHER_THROUGHPUT_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [bag].[CONOPS_BAG_CM_HOURLY_CRUSHER_THROUGHPUT_V]  
AS  
