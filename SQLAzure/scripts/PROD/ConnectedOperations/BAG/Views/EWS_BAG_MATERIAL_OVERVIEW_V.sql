CREATE VIEW [BAG].[EWS_BAG_MATERIAL_OVERVIEW_V] AS


--select * from [bag].[EWS_BAG_MATERIAL_OVERVIEW_V] where shiftflag = 'next'
CREATE VIEW [bag].[EWS_BAG_MATERIAL_OVERVIEW_V]
AS
