CREATE VIEW [CHI].[CONOPS_CHI_DAILY_ASSET_EFFICIENCY_V] AS
...
--select * from [chi].[CONOPS_CHI_DAILY_ASSET_EFFICIENCY_V]
CREATE VIEW [chi].[CONOPS_CHI_DAILY_ASSET_EFFICIENCY_V] 
AS
