CREATE VIEW [CHI].[CONOPS_CHI_DB_EQMT_STATUS_V] AS



  
  
--SELECT * FROM [CHI].[CONOPS_CHI_DB_EQMT_STATUS_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [CHI].[CONOPS_CHI_DB_EQMT_STATUS_V]  
AS  
