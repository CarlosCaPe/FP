CREATE VIEW [CHI].[CONOPS_CHI_DAILY_SP_SHOVEL_ASSET_EFFICIENCY_V] AS
  
  
  
--select * from [dbo].[CONOPS_LH_SP_DELAY_V] where shiftflag = 'prev'  
CREATE VIEW [chi].[CONOPS_CHI_DAILY_SP_SHOVEL_ASSET_EFFICIENCY_V]   
AS  
...
LEFT JOIN [chi].[CONOPS_CHI_DAILY_SHOVEL_INFO_V] b  
