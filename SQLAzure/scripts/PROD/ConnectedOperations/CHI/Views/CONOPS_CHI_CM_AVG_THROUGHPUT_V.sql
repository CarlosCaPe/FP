CREATE VIEW [CHI].[CONOPS_CHI_CM_AVG_THROUGHPUT_V] AS
...
-- SELECT * FROM [chi].[CONOPS_CHI_CM_AVG_THROUGHPUT_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'PREV'    
CREATE VIEW [chi].[CONOPS_CHI_CM_AVG_THROUGHPUT_V]    
AS    
...
FROM (   
 ...
 FROM [chi].[CONOPS_CHI_CM_HOURLY_CRUSHER_THROUGHPUT_V] [hct] WITH (NOLOCK)  
