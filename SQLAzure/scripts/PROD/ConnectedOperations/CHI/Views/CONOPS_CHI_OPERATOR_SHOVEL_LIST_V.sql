CREATE VIEW [CHI].[CONOPS_CHI_OPERATOR_SHOVEL_LIST_V] AS
...
-- SELECT * FROM [CHI].[CONOPS_CHI_OPERATOR_SHOVEL_LIST_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [CHI].[CONOPS_CHI_OPERATOR_SHOVEL_LIST_V]
AS
