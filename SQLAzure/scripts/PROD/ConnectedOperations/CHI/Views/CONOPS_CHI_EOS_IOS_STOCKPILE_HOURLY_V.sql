CREATE VIEW [CHI].[CONOPS_CHI_EOS_IOS_STOCKPILE_HOURLY_V] AS





--SELECT * FROM [CHI].[CONOPS_CHI_EOS_IOS_STOCKPILE_HOURLY_V] WHERE shiftflag = 'PREV'
CREATE VIEW [CHI].[CONOPS_CHI_EOS_IOS_STOCKPILE_HOURLY_V]
AS
...
LEFT JOIN [CHI].[CONOPS_CHI_SHIFT_INFO_V] s WITH (NOLOCK)  
