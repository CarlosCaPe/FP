CREATE VIEW [CHI].[CONOPS_CHI_DAILY_EOS_KPI_SUMMARY_V] AS
...
-- SELECT * FROM [chi].[CONOPS_CHI_DAILY_EOS_KPI_SUMMARY_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [chi].[CONOPS_CHI_DAILY_EOS_KPI_SUMMARY_V]      
AS      
...
FROM [chi].[CONOPS_CHI_DAILY_DELTA_J_V]  
WHERE DeltaJ <> 0  
