CREATE VIEW [CHI].[CONOPS_CHI_TRUCK_DETAIL_V] AS
  
  
  
  
-- SELECT * FROM [chi].[CONOPS_CHI_TRUCK_DETAIL_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'  
CREATE VIEW [chi].[CONOPS_CHI_TRUCK_DETAIL_V]   
AS  
