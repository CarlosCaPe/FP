CREATE VIEW [CHI].[CONOPS_CHI_EOS_CRUSHER_NON_UTILIZED_REASON_V] AS

--SELECT * FROM [CHI].[CONOPS_CHI_EOS_CRUSHER_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [CHI].[CONOPS_CHI_EOS_CRUSHER_NON_UTILIZED_REASON_V]  
AS  
...
INNER JOIN CHI.conops_CHI_shift_info_v si
