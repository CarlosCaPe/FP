CREATE VIEW [CHI].[CONOPS_CHI_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V] AS


  
  
--select * from [chi].[CONOPS_CHI_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]  
CREATE VIEW [chi].[CONOPS_CHI_SHOVEL_ASSET_EFFICIENCY_PER_SHOVEL_V]   
AS  
