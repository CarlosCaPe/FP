CREATE VIEW [CHI].[CONOPS_CHI_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] AS




--select * from [chi].[CONOPS_CHI_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V]
CREATE VIEW [chi].[CONOPS_CHI_TRUCK_ASSET_EFFICIENCY_PER_TRUCK_V] 
AS
