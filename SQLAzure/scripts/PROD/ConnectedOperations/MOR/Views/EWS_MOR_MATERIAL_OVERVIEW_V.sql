CREATE VIEW [MOR].[EWS_MOR_MATERIAL_OVERVIEW_V] AS

--select * from [mor].[EWS_MOR_MATERIAL_OVERVIEW_V] where shiftflag = 'next'
CREATE VIEW [mor].[EWS_MOR_MATERIAL_OVERVIEW_V]
AS
...
RIGHT JOIN TONS tn ON a.shiftid = tn.shiftid 
