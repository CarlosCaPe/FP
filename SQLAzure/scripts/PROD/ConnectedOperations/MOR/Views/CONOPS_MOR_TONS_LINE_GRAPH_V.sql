CREATE VIEW [MOR].[CONOPS_MOR_TONS_LINE_GRAPH_V] AS



--select * from [mor].[CONOPS_MOR_TONS_LINE_GRAPH_V] where shiftflag = 'curr'
CREATE VIEW [mor].[CONOPS_MOR_TONS_LINE_GRAPH_V]
AS
