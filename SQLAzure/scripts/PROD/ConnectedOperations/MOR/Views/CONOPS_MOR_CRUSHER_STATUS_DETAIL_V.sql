CREATE VIEW [MOR].[CONOPS_MOR_CRUSHER_STATUS_DETAIL_V] AS



--SELECT * FROM [mor].[CONOPS_MOR_CRUSHER_STATUS_DETAIL_V]
CREATE VIEW [mor].[CONOPS_MOR_CRUSHER_STATUS_DETAIL_V]
AS
...
SELECT
	...
	CASE PLANT_AREA_NAME
		WHEN 'IN-PIT 2 CRUSHER' THEN 'CRUSHER 2'
		WHEN 'In Pit Crusher 3' THEN 'CRUSHER 3'
	ELSE PLANT_AREA_NAME END AS Crusher,
	CASE SHIFT_INDICATOR
		WHEN 'A' THEN CONCAT(ShiftId, '001')
		WHEN 'C' THEN CONCAT(ShiftId, '002')
