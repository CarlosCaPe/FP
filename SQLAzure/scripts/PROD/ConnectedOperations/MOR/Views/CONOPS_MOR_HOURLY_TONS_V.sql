CREATE VIEW [MOR].[CONOPS_MOR_HOURLY_TONS_V] AS
  
  
CREATE VIEW [mor].[CONOPS_MOR_HOURLY_TONS_V]  
AS  
...
LEFT JOIN [mor].[CONOPS_MOR_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_DUMPTIME_V] c   
...
shiftseq  
FROM CTE a  
LEFT JOIN [mor].[SHIFT_INFO] b WITH (NOLOCK) ON a.shiftid = b.shiftid   
