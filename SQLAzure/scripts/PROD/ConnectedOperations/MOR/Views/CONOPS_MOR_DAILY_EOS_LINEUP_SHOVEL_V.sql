CREATE VIEW [MOR].[CONOPS_MOR_DAILY_EOS_LINEUP_SHOVEL_V] AS



-- SELECT * FROM [mor].[CONOPS_MOR_DAILY_EOS_LINEUP_SHOVEL_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [mor].[CONOPS_MOR_DAILY_EOS_LINEUP_SHOVEL_V] 
AS
