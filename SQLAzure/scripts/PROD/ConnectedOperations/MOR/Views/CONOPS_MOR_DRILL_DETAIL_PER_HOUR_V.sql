CREATE VIEW [MOR].[CONOPS_MOR_DRILL_DETAIL_PER_HOUR_V] AS
  
   
-- SELECT * FROM [mor].[CONOPS_MOR_DRILL_DETAIL_PER_HOUR_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' ORDER BY [DRILL_ID]    
CREATE VIEW [mor].[CONOPS_MOR_DRILL_DETAIL_PER_HOUR_V]    
AS    
