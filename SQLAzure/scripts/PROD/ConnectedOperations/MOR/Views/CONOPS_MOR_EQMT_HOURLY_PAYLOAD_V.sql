CREATE VIEW [MOR].[CONOPS_MOR_EQMT_HOURLY_PAYLOAD_V] AS

--SELECT * FROM [mor].[CONOPS_MOR_EQMT_HOURLY_PAYLOAD_V] WHERE shiftflag = 'prev' and equipment = 'S11'
CREATE VIEW [mor].[CONOPS_MOR_EQMT_HOURLY_PAYLOAD_V]
AS
