CREATE VIEW [MOR].[CONOPS_MOR_DAILY_SP_SHOVEL_ASSET_EFFICIENCY_V] AS
  
  
  
--select * from [dbo].[CONOPS_LH_DAILY_SP_SHOVEL_ASSET_EFFICIENCY_V] WITH (NOLOCK)  
CREATE VIEW [mor].[CONOPS_MOR_DAILY_SP_SHOVEL_ASSET_EFFICIENCY_V]  
AS  
...
LEFT JOIN [mor].[CONOPS_MOR_DAILY_SHOVEL_INFO_V] b  
