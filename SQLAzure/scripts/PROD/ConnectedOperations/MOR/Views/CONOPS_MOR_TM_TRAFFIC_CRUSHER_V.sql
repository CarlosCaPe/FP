CREATE VIEW [MOR].[CONOPS_MOR_TM_TRAFFIC_CRUSHER_V] AS
...
--SELECT * FROM [mor].[CONOPS_MOR_TM_TRAFFIC_CRUSHER_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'      
CREATE VIEW [mor].[CONOPS_MOR_TM_TRAFFIC_CRUSHER_V]      
AS      
