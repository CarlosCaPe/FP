CREATE VIEW [MOR].[CONOPS_MOR_EOS_TRUCK_READY_V] AS
  
  
  
--SELECT * FROM [mor].[CONOPS_MOR_EOS_TRUCK_READY_V] WHERE shiftflag = 'curr' order by datetime  
CREATE VIEW [mor].[CONOPS_MOR_EOS_TRUCK_READY_V]  
AS  
