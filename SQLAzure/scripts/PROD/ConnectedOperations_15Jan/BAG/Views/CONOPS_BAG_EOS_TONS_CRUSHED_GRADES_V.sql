CREATE VIEW [BAG].[CONOPS_BAG_EOS_TONS_CRUSHED_GRADES_V] AS



--SELECT * FROM [bag].[CONOPS_BAG_EOS_TONS_CRUSHED_GRADES_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [bag].[CONOPS_BAG_EOS_TONS_CRUSHED_GRADES_V]  
AS  
