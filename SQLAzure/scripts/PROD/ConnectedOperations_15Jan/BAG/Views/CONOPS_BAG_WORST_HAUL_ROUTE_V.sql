CREATE VIEW [BAG].[CONOPS_BAG_WORST_HAUL_ROUTE_V] AS




-- SELECT * FROM [bag].[CONOPS_BAG_WORST_HAUL_ROUTE_V] WITH (NOLOCK)
CREATE VIEW [bag].[CONOPS_BAG_WORST_HAUL_ROUTE_V] 
AS
