CREATE VIEW [BAG].[CONOPS_BAG_DAILY_SHOVEL_SHIFT_TARGET_V] AS
  
  
  
--select * from [bag].[CONOPS_BAG_DAILY_SHOVEL_SHIFT_TARGET_V] where shiftflag = 'curr'  
CREATE VIEW [bag].[CONOPS_BAG_DAILY_SHOVEL_SHIFT_TARGET_V]  
AS  
