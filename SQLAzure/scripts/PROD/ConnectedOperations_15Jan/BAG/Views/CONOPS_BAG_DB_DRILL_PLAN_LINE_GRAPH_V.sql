CREATE VIEW [BAG].[CONOPS_BAG_DB_DRILL_PLAN_LINE_GRAPH_V] AS
...
--SELECT * FROM [bag].[CONOPS_BAG_DB_DRILL_PLAN_LINE_GRAPH_V] WHERE shiftflag = 'PREV'
CREATE VIEW [bag].[CONOPS_BAG_DB_DRILL_PLAN_LINE_GRAPH_V]
AS
