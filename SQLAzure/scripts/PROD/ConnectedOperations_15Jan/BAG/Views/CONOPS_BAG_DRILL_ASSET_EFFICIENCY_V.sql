CREATE VIEW [BAG].[CONOPS_BAG_DRILL_ASSET_EFFICIENCY_V] AS
...
--select * from [bag].[CONOPS_BAG_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [bag].[CONOPS_BAG_DRILL_ASSET_EFFICIENCY_V] 
AS
