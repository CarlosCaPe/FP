CREATE VIEW [BAG].[CONOPS_BAG_DAILY_HOURLY_TRUCK_ASSET_EFFICIENCY_V] AS




--select * from [bag].[CONOPS_BAG_DAILY_HOURLY_TRUCK_ASSET_EFFICIENCY_V] WITH (NOLOCK)
CREATE VIEW [bag].[CONOPS_BAG_DAILY_HOURLY_TRUCK_ASSET_EFFICIENCY_V] 
AS
