CREATE VIEW [BAG].[CONOPS_BAG_DAILY_EOS_LINEUP_EQUIPMENT_V] AS
  
  
  
-- SELECT * FROM [bag].[CONOPS_BAG_DAILY_EOS_LINEUP_EQUIPMENT_V]  WHERE [shiftflag] = 'CURR'  
CREATE VIEW [bag].[CONOPS_BAG_DAILY_EOS_LINEUP_EQUIPMENT_V]   
AS  
...
FROM [bag].[CONOPS_BAG_DAILY_EOS_LINEUP_SHOVEL_V]   
...
FROM [bag].[CONOPS_BAG_EOS_SHIFT_INFO_V]  
...
FROM [bag].[CONOPS_BAG_DAILY_EOS_LINEUP_TRUCK_V]  
GROUP BY siteflag, shiftflag,shiftid  
...
FROM [bag].[CONOPS_BAG_DAILY_EOS_LINEUP_DRILL_V]  
GROUP BY siteflag, shiftflag, shiftid  
...
FROM [bag].[CONOPS_BAG_DAILY_EOS_LINEUP_EQMT_OTHER_V]  
