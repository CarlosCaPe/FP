CREATE VIEW [BAG].[CONOPS_BAG_OPERATOR_SHOVEL_LIST_V] AS
...
-- SELECT * FROM [BAG].[CONOPS_BAG_OPERATOR_SHOVEL_LIST_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [bag].[CONOPS_BAG_OPERATOR_SHOVEL_LIST_V]
AS
