CREATE VIEW [BAG].[CONOPS_BAG_DB_DRILL_SCORE_CARD_V] AS





--select * from [bag].[CONOPS_BAG_DB_DRILL_SCORE_CARD_V] WITH (NOLOCK) where shiftflag = 'prev'
CREATE VIEW [bag].[CONOPS_BAG_DB_DRILL_SCORE_CARD_V]
AS
