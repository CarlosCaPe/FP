...
/******************************************************************  
* PROCEDURE	: mill.[MetcalfHrcLimePlantInspectionForm_Header_Get]
* PURPOSE	: 
* NOTES		: 
* CREATED	: sxavier
* SAMPLE	: 
	1. EXEC [mill].[MetcalfHrcLimePlantInspectionForm_Header_Get] 'MOR', 'PREV'

* MODIFIED DATE     AUTHOR			DESCRIPTION  
*------------------------------------------------------------------  
* {11 Dec 2024}		{sxavier}		{Initial Created}
*******************************************************************/ 
CREATE PROCEDURE [mill].[MetcalfHrcLimePlantInspectionForm_Header_Get]
(
	@SiteCode VARCHAR(3),
	@ShiftCode VARCHAR(4)
)
