CREATE VIEW [CHI].[CONOPS_CHI_EOS_LINEUP_EQUIPMENT_V] AS


-- SELECT * FROM [chi].[CONOPS_CHI_EOS_LINEUP_EQUIPMENT_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [chi].[CONOPS_CHI_EOS_LINEUP_EQUIPMENT_V] 
AS
...
FROM [chi].[CONOPS_CHI_EOS_LINEUP_SHOVEL_V] 
...
FROM [chi].[CONOPS_CHI_EOS_LINEUP_TRUCK_V]
GROUP BY siteflag, shiftflag,shiftid
...
FROM [chi].[CONOPS_CHI_EOS_LINEUP_DRILL_V]
GROUP BY siteflag, shiftflag, shiftid
...
FROM [chi].[CONOPS_CHI_EOS_LINEUP_EQMT_OTHER_V]
