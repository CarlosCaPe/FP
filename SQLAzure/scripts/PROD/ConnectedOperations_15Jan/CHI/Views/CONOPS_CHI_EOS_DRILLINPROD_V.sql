CREATE VIEW [CHI].[CONOPS_CHI_EOS_DRILLINPROD_V] AS


--select * from [dbo].[CONOPS_CHI_EOS_DRILLINPROD_V] where shiftflag = 'prev'
CREATE VIEW [chi].[CONOPS_CHI_EOS_DRILLINPROD_V]
AS
...
FROM [chi].[CONOPS_CHI_HOURLY_DRILL_ASSET_EFFICIENCY_V] a
