CREATE VIEW [CHI].[CONOPS_CHI_DAILY_EOS_TONS_CRUSHED_GRADES_V] AS
  
  
--SELECT * FROM [chi].[CONOPS_CHI_DAILY_EOS_TONS_CRUSHED_GRADES_V] WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [chi].[CONOPS_CHI_DAILY_EOS_TONS_CRUSHED_GRADES_V]    
AS    
