CREATE VIEW [CHI].[CONOPS_CHI_EQMT_TRUCK_HOURLY_DELTAC_V] AS



--select * from [chi].[CONOPS_CHI_EQMT_TRUCK_HOURLY_DELTAC_V] where shiftflag = 'prev' and equipment = '708'
CREATE VIEW [chi].[CONOPS_CHI_EQMT_TRUCK_HOURLY_DELTAC_V]
AS
