CREATE VIEW [CHI].[CONOPS_CHI_DAILY_SHOVEL_INFO_V] AS
  
  
  
  
-- SELECT * FROM [chi].[CONOPS_CHI_DAILY_SHOVEL_INFO_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'  
CREATE VIEW [chi].[CONOPS_CHI_DAILY_SHOVEL_INFO_V]   
AS  
