CREATE VIEW [CHI].[CONOPS_CHI_EOS_HAULAGE_V] AS
...
--SELECT * FROM [CHI].[CONOPS_CHI_EOS_HAULAGE_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [chi].[CONOPS_CHI_EOS_HAULAGE_V]
AS
...
FROM(
	...
	FROM [CHI].[CONOPS_CHI_DELTA_C_DETAIL_V] [dc]
