CREATE VIEW [CHI].[CONOPS_CHI_DAILY_EOS_DRILLED_HOLES_V] AS
  
  
  
--SELECT * FROM [CHI].[CONOPS_CHI_DAILY_EOS_DRILLED_HOLES_V] WHERE SHIFTFLAG = 'PREV'  
CREATE VIEW [CHI].[CONOPS_CHI_DAILY_EOS_DRILLED_HOLES_V]  
AS  
...
(  
 ...
 FROM [CHI].[CONOPS_CHI_DAILY_DB_DRILL_PLAN_V] (NOLOCK)  
