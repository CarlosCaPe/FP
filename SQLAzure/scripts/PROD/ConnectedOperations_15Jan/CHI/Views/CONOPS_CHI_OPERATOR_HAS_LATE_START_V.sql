CREATE VIEW [CHI].[CONOPS_CHI_OPERATOR_HAS_LATE_START_V] AS

  
   
-- SELECT * FROM [chi].[CONOPS_CHI_OPERATOR_HAS_LATE_START_V] WITH (NOLOCK) WHERE Shiftflag = 'CURR'    
CREATE VIEW [chi].[CONOPS_CHI_OPERATOR_HAS_LATE_START_V]     
AS    
...
SELECT DISTINCT oper.shiftindex
    ...
    FROM CHI.CONOPS_CHI_SHIFT_INFO_V (nolock) AS eroot
