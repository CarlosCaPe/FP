CREATE VIEW [CHI].[CONOPS_CHI_DAILY_EOS_LINEUP_TRUCK_V] AS




-- SELECT * FROM [chi].[CONOPS_CHI_DAILY_EOS_LINEUP_TRUCK_V]  WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [chi].[CONOPS_CHI_DAILY_EOS_LINEUP_TRUCK_V] 
AS
