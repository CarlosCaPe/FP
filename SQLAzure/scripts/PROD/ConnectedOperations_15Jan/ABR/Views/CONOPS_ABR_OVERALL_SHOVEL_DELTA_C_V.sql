...
LEFT JOIN [DBO].delta_c b WITH (NOLOCK) ON a.shiftindex = b.shiftindex AND b.site_code = 'ELA'    
...
LEFT JOIN [abr].[CONOPS_ABR_DELTA_C_TARGET_V]  e ON a.shiftid = e.shiftid  
