CREATE VIEW [ABR].[CONOPS_ABR_EOS_DRILL_READY_V] AS



--SELECT * FROM [abr].[CONOPS_ABR_EOS_DRILL_READY_V] WHERE shiftflag = 'curr' order by datetime
CREATE VIEW [ABR].[CONOPS_ABR_EOS_DRILL_READY_V]
AS
...
drill_id as eqmt,
StartDateTime
FROM [abr].drill_asset_efficiency_v
WHERE reasonidx = 200),
