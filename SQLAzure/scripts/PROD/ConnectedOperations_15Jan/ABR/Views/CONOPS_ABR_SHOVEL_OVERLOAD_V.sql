CREATE VIEW [ABR].[CONOPS_ABR_SHOVEL_OVERLOAD_V] AS





--SELECT * FROM [abr].[CONOPS_ABR_SHOVEL_OVERLOAD_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [ABR].[CONOPS_ABR_SHOVEL_OVERLOAD_V]  
AS  
...
LEFT JOIN [abr].shift_eqmt s WITH (NOLOCK)
...
LEFT JOIN [abr].[CONOPS_ABR_TRUCK_DETAIL_V] td WITH (NOLOCK)
