CREATE VIEW [ABR].[CONOPS_ABR_DAILY_SHOVEL_INFO_V] AS




-- SELECT * FROM [ABR].[CONOPS_ABR_DAILY_SHOVEL_INFO_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_SHOVEL_INFO_V] 
AS
