CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_TONS_MINED_V] AS

--SELECT * FROM [abr].[CONOPS_ABR_DAILY_EOS_TONS_MINED_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_TONS_MINED_V]
AS
...
FROM(
	...
	FROM [ABR].[CONOPS_ABR_DAILY_EOS_TOTAL_MATERIAL_V] ov
	LEFT JOIN [ABR].[CONOPS_ABR_SHIFT_BASE_TARGET_V] t
