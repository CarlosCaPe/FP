CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_LINEUP_EQUIPMENT_V] AS




-- SELECT * FROM [abr].[CONOPS_ABR_DAILY_EOS_LINEUP_EQUIPMENT_V]  WHERE [shiftflag] = 'CURR'  
CREATE VIEW [ABR].[CONOPS_ABR_DAILY_EOS_LINEUP_EQUIPMENT_V]   
AS  
...
FROM [abr].[CONOPS_ABR_DAILY_EOS_LINEUP_SHOVEL_V]   
...
FROM [abr].[CONOPS_ABR_EOS_SHIFT_INFO_V]  
...
FROM [abr].[CONOPS_ABR_DAILY_EOS_LINEUP_TRUCK_V]  
GROUP BY siteflag, shiftflag,shiftid  
...
FROM [abr].[CONOPS_ABR_DAILY_EOS_LINEUP_DRILL_V]  
GROUP BY siteflag, shiftflag, shiftid  
...
FROM [abr].[CONOPS_ABR_DAILY_EOS_LINEUP_EQMT_OTHER_V]  
