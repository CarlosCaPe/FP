CREATE VIEW [ABR].[CONOPS_ABR_EOS_IOS_STOCKPILE_HOURLY_V] AS





--SELECT * FROM [abr].[CONOPS_ABR_EOS_IOS_STOCKPILE_HOURLY_V] WHERE shiftflag = 'PREV'
CREATE VIEW [ABR].[CONOPS_ABR_EOS_IOS_STOCKPILE_HOURLY_V]
AS
