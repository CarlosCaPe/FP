...
CAC_HOURLY AS (
    SELECT 
        ...
        END AS HourEnd
    FROM [BAG_MSHIST].[dbo].[CYCLEACTIVITYCOMPONENT] t WITH (NOLOCK)
...
Delaystatus AS (
    ...
    LEFT JOIN [BAG_MSMODEL].[dbo].[DELAYCATEGORY] DCA WITH (NOLOCK)
...
SELECT 
    ...
    CASE 
        ...
        WHEN DS.NAME = 'Unscheduled Down' THEN 1
        WHEN DS.NAME = 'Operational D