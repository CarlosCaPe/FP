...
/******************************************************************        
* PROCEDURE : BAG2.[UPSERT_CONOPS_DELAY]      
* PURPOSE : UPSERT [UPSERT_CONOPS_DELAY]      
* NOTES     :       
* CREATED : MFAHMI      
* SAMPLE    : EXEC BAG2.[UPSERT_CONOPS_DELAY] 'BAG2'       
* MODIFIED DATE  AUTHOR    DESCRIPTION        
*------------------------------------------------------------------        
* {19 MAR 2023}  {MFAHMI}   {INITIAL CREATED}        
*******************************************************************/        
CREATE  PROCEDURE [bag2].[UPSERT_CONOPS_DELAY]       
(      
@G_SITE VARCHAR(5)      
)      
AS      
