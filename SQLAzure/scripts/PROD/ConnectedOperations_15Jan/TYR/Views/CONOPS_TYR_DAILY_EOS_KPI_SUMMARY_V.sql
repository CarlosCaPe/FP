CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_KPI_SUMMARY_V] AS
...
-- SELECT * FROM [tyr].[CONOPS_TYR_DAILY_EOS_KPI_SUMMARY_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'PREV'      
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_KPI_SUMMARY_V]      
AS      
...
FROM [tyr].[CONOPS_TYR_DAILY_DELTA_J_V]  
WHERE DeltaJ <> 0  
