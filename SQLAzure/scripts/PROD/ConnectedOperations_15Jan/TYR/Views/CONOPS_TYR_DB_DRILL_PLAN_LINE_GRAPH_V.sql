CREATE VIEW [TYR].[CONOPS_TYR_DB_DRILL_PLAN_LINE_GRAPH_V] AS




--SELECT * FROM [tyr].[CONOPS_TYR_DB_DRILL_PLAN_LINE_GRAPH_V] WHERE shiftflag = 'PREV'
CREATE VIEW [TYR].[CONOPS_TYR_DB_DRILL_PLAN_LINE_GRAPH_V]
AS
