CREATE VIEW [TYR].[CONOPS_TYR_EOS_CRUSHER_NON_UTILIZED_REASON_V] AS

--SELECT * FROM [tyr].[CONOPS_TYR_EOS_CRUSHER_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [TYR].[CONOPS_TYR_EOS_CRUSHER_NON_UTILIZED_REASON_V]  
AS  
...
INNER JOIN TYR.conops_TYR_shift_info_v si
