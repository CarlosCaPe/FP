CREATE VIEW [TYR].[CONOPS_TYR_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V] AS



  
--select * from [tyr].[CONOPS_TYR_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
AS  
...
WITH TimesDetails AS (  
 ...
 FROM(  
  ...
  FROM [tyr].[DRILL_UTILIZATION] [HOS] WITH (NOLOCK)  
