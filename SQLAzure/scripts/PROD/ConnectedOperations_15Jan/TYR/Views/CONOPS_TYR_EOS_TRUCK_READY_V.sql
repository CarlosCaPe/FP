CREATE VIEW [TYR].[CONOPS_TYR_EOS_TRUCK_READY_V] AS



  
--SELECT * FROM [tyr].[CONOPS_TYR_EOS_TRUCK_READY_V] WHERE shiftflag = 'curr' order by datetime  
CREATE VIEW [TYR].[CONOPS_TYR_EOS_TRUCK_READY_V]  
AS  
