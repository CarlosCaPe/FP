CREATE VIEW [TYR].[CONOPS_TYR_EQMT_ALARM_TRUCK_DOWN_V] AS




-- SELECT * FROM [tyr].[CONOPS_TYR_EQMT_ALARM_TRUCKL_DOWN_V] WITH (NOLOCK) WHERE shiftflag = 'CURR'
CREATE VIEW [TYR].[CONOPS_TYR_EQMT_ALARM_TRUCK_DOWN_V]
AS
