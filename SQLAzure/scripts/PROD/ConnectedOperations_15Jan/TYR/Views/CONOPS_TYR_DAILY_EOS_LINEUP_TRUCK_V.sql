CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_LINEUP_TRUCK_V] AS



-- SELECT * FROM [tyr].[CONOPS_TYR_DAILY_EOS_LINEUP_TRUCK_V]  WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [TYR].[CONOPS_TYR_DAILY_EOS_LINEUP_TRUCK_V] 
AS
