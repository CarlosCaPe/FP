CREATE VIEW [TYR].[CONOPS_TYR_TP_EQMT_STATUS_V] AS


  
--select * from [tyr].[CONOPS_TYR_TP_EQMT_STATUS_V] where shiftflag = 'curr'  
  
CREATE VIEW [TYR].[CONOPS_TYR_TP_EQMT_STATUS_V]   
AS  
...
FROM [tyr].[CONOPS_TYR_TP_AVG_PAYLOAD_V] (NOLOCK)  
) e  
