CREATE VIEW [TYR].[CONOPS_TYR_DB_DRILL_PLAN_V] AS



--select * from [tyr].[CONOPS_TYR_DB_DRILL_PLAN_V] where shiftflag = 'prev'
CREATE VIEW [TYR].[CONOPS_TYR_DB_DRILL_PLAN_V]
AS
