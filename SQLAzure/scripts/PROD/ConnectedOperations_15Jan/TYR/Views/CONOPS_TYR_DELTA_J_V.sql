CREATE VIEW [TYR].[CONOPS_TYR_DELTA_J_V] AS



  
    
--select * from [tyr].[CONOPS_TYR_DELTA_J_V]     
CREATE VIEW [TYR].[CONOPS_TYR_DELTA_J_V]     
AS    
...
TimeInHour,    
Shiftseq    
FROM [tyr].[CONOPS_TYR_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]    
