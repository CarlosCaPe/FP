CREATE VIEW [SIE].[CONOPS_SIE_EOS_DRILLINPROD_V] AS


--select * from [dbo].[CONOPS_SIE_EOS_DRILLINPROD_V] where shiftflag = 'prev'
CREATE VIEW [sie].[CONOPS_SIE_EOS_DRILLINPROD_V]
AS
...
FROM [sie].[CONOPS_SIE_HOURLY_DRILL_ASSET_EFFICIENCY_V] a
