CREATE VIEW [SIE].[CONOPS_SIE_TM_TRAFFIC_SHOVEL_V] AS
...
--SELECT * FROM [sie].[CONOPS_SIE_TM_TRAFFIC_SHOVEL_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'        
CREATE VIEW [sie].[CONOPS_SIE_TM_TRAFFIC_SHOVEL_V]        
AS        
