CREATE VIEW [SIE].[CONOPS_SIE_EOS_LINEUP_EQUIPMENT_V] AS


-- SELECT * FROM [sie].[CONOPS_SIE_EOS_LINEUP_EQUIPMENT_V]  WHERE [shiftflag] = 'CURR'
CREATE VIEW [sie].[CONOPS_SIE_EOS_LINEUP_EQUIPMENT_V] 
AS
...
FROM [sie].[CONOPS_SIE_EOS_LINEUP_SHOVEL_V] 
...
FROM [sie].[CONOPS_SIE_EOS_LINEUP_TRUCK_V]
GROUP BY siteflag, shiftflag,shiftid
...
FROM [sie].[CONOPS_SIE_EOS_LINEUP_DRILL_V]
GROUP BY siteflag, shiftflag, shiftid
...
FROM [sie].[CONOPS_SIE_EOS_LINEUP_EQMT_OTHER_V]
