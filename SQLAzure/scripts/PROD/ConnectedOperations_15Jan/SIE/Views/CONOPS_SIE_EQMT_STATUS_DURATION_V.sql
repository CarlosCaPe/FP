CREATE VIEW [SIE].[CONOPS_SIE_EQMT_STATUS_DURATION_V] AS



-- SELECT * FROM [SIE].[CONOPS_SIE_EQMT_STATUS_DURATION_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [SIE].[CONOPS_SIE_EQMT_STATUS_DURATION_V] 
AS
...
LEFT JOIN [SIE].[CONOPS_SIE_AUTONOMOUS_TRUCK_V] aut
