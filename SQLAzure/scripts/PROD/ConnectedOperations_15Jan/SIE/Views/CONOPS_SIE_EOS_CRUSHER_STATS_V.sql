CREATE VIEW [SIE].[CONOPS_SIE_EOS_CRUSHER_STATS_V] AS



--SELECT * FROM [sie].[CONOPS_SIE_EOS_CRUSHER_STATS_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [sie].[CONOPS_SIE_EOS_CRUSHER_STATS_V]
AS
