CREATE VIEW [SIE].[CONOPS_SIE_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V] AS




--select * from [sie].[CONOPS_SIE_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]
CREATE VIEW [sie].[CONOPS_SIE_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]
AS
