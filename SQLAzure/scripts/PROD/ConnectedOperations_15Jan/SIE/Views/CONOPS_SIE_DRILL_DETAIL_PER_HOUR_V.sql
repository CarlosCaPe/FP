CREATE VIEW [SIE].[CONOPS_SIE_DRILL_DETAIL_PER_HOUR_V] AS
  
    
    
    
-- SELECT * FROM [sie].[CONOPS_SIE_DRILL_DETAIL_PER_HOUR_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' ORDER BY [DRILL_ID]    
CREATE VIEW [sie].[CONOPS_SIE_DRILL_DETAIL_PER_HOUR_V]    
AS    
