CREATE VIEW [SIE].[CONOPS_SIE_OPERATOR_SHOVEL_LIST_V] AS
...
-- SELECT * FROM [SIE].[CONOPS_SIE_OPERATOR_SHOVEL_LIST_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [SIE].[CONOPS_SIE_OPERATOR_SHOVEL_LIST_V]
AS
