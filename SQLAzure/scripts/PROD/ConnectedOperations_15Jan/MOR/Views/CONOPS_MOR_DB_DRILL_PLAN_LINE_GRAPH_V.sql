CREATE VIEW [MOR].[CONOPS_MOR_DB_DRILL_PLAN_LINE_GRAPH_V] AS
...
--SELECT * FROM [MOR].[CONOPS_MOR_DB_DRILL_PLAN_LINE_GRAPH_V] WHERE shiftflag = 'PREV'
CREATE VIEW [MOR].[CONOPS_MOR_DB_DRILL_PLAN_LINE_GRAPH_V]
AS
...
REPLACE(b.DRILL_ID, ' ','') AS DRILL_ID,
b.[DRILL_HOLE],
