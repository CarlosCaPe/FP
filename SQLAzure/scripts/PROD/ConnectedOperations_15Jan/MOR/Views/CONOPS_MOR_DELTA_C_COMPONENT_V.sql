CREATE VIEW [MOR].[CONOPS_MOR_DELTA_C_COMPONENT_V] AS
...
--SELECT * FROM MOR.CONOPS_MOR_DELTA_C_COMPONENT_V WHERE SHIFTFLAG = 'CURR' ORDER BY MinsOverExpected DESC
CREATE VIEW MOR.CONOPS_MOR_DELTA_C_COMPONENT_V
AS
...
LEFT JOIN MOR.CONOPS_MOR_SHIFT_INFO_V si
