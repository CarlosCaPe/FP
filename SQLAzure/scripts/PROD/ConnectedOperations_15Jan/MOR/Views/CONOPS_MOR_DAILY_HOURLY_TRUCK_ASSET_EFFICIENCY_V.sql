CREATE VIEW [MOR].[CONOPS_MOR_DAILY_HOURLY_TRUCK_ASSET_EFFICIENCY_V] AS




--select * from [mor].[CONOPS_MOR_DAILY_HOURLY_TRUCK_ASSET_EFFICIENCY_V] WITH (NOLOCK)
CREATE VIEW [mor].[CONOPS_MOR_DAILY_HOURLY_TRUCK_ASSET_EFFICIENCY_V] 
AS
