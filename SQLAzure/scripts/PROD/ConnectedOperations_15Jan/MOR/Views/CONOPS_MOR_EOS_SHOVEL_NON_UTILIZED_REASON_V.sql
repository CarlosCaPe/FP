CREATE VIEW [MOR].[CONOPS_MOR_EOS_SHOVEL_NON_UTILIZED_REASON_V] AS

--SELECT * FROM [MOR].[CONOPS_MOR_EOS_SHOVEL_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [MOR].[CONOPS_MOR_EOS_SHOVEL_NON_UTILIZED_REASON_V]
AS
...
INNER JOIN MOR.CONOPS_MOR_SHIFT_INFO_V s WITH (NOLOCK)
