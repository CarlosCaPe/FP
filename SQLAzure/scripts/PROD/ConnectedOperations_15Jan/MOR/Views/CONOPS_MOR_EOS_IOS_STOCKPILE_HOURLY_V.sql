CREATE VIEW [MOR].[CONOPS_MOR_EOS_IOS_STOCKPILE_HOURLY_V] AS





--SELECT * FROM [MOR].[CONOPS_MOR_EOS_IOS_STOCKPILE_HOURLY_V] WHERE shiftflag = 'PREV'
CREATE VIEW [MOR].[CONOPS_MOR_EOS_IOS_STOCKPILE_HOURLY_V]
AS
