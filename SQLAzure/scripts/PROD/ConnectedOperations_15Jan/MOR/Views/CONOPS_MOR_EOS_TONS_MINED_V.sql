CREATE VIEW [MOR].[CONOPS_MOR_EOS_TONS_MINED_V] AS
...
--SELECT * FROM [MOR].[CONOPS_MOR_EOS_TONS_MINED_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [mor].[CONOPS_MOR_EOS_TONS_MINED_V]
AS
...
FROM(
	...
	FROM [MOR].[CONOPS_MOR_EOS_TOTAL_MATERIAL_V] ov
