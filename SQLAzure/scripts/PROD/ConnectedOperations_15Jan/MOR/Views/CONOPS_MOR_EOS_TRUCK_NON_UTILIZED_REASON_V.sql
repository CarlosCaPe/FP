CREATE VIEW [MOR].[CONOPS_MOR_EOS_TRUCK_NON_UTILIZED_REASON_V] AS

--SELECT * FROM [MOR].[CONOPS_MOR_EOS_TRUCK_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'
CREATE VIEW [MOR].[CONOPS_MOR_EOS_TRUCK_NON_UTILIZED_REASON_V]
AS
