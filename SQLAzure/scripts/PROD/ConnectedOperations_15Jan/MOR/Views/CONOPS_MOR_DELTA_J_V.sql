CREATE VIEW [MOR].[CONOPS_MOR_DELTA_J_V] AS
...
CREATE VIEW [mor].[CONOPS_MOR_DELTA_J_V]         
AS        
...
TimeInHour,        
Shiftseq        
FROM [mor].[CONOPS_MOR_EQMT_SHOVEL_HOURLY_TOTALMATERIALMINED_V]        
...
shiftid,        
shiftTarget        
from [mor].[CONOPS_MOR_SHIFT_TARGET_V]),        
