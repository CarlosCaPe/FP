CREATE VIEW [MOR].[CONOPS_MOR_EOS_TONS_CRUSHED_GRADES_V] AS



--SELECT * FROM [mor].[CONOPS_MOR_EOS_TONS_CRUSHED_GRADES_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [mor].[CONOPS_MOR_EOS_TONS_CRUSHED_GRADES_V]  
AS  
