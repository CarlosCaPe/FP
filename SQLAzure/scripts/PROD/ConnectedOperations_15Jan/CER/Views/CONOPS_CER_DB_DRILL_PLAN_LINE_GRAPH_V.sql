CREATE VIEW [CER].[CONOPS_CER_DB_DRILL_PLAN_LINE_GRAPH_V] AS
...
--SELECT * FROM [CER].[CONOPS_CER_DB_DRILL_PLAN_LINE_GRAPH_V] WHERE shiftflag = 'PREV'
CREATE VIEW [CER].[CONOPS_CER_DB_DRILL_PLAN_LINE_GRAPH_V]
AS
