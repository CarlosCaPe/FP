CREATE VIEW [CER].[CONOPS_CER_DELTA_C_COMPONENT_V] AS





--SELECT * FROM CER.CONOPS_CER_DELTA_C_COMPONENT_V WHERE SHIFTFLAG = 'CURR' ORDER BY MinsOverExpected DESC
CREATE VIEW CER.CONOPS_CER_DELTA_C_COMPONENT_V
AS
...
LEFT JOIN CER.CONOPS_CER_SHIFT_INFO_V si
	ON dc.shiftindex = si.shiftindex
WHERE dc.SITE_CODE = 'CER'
