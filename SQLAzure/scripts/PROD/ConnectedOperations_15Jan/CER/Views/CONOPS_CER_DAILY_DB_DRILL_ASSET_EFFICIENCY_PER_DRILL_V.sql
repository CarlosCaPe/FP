CREATE VIEW [CER].[CONOPS_CER_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V] AS
  
  
  
  
--select * from [cer].[CONOPS_CER_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
CREATE VIEW [cer].[CONOPS_CER_DAILY_DB_DRILL_ASSET_EFFICIENCY_PER_DRILL_V]  
AS  
