CREATE VIEW [CER].[CONOPS_CER_DAILY_ASSET_EFFICIENCY_V] AS
...
--select * from [cer].[CONOPS_CER_DAILY_ASSET_EFFICIENCY_V]
CREATE VIEW [cer].[CONOPS_CER_DAILY_ASSET_EFFICIENCY_V]
AS
