CREATE VIEW [CER].[CONOPS_CER_DAILY_EOS_DRILLED_HOLES_V] AS
  
  
  
--SELECT * FROM [CER].[CONOPS_CER_DAILY_EOS_DRILLED_HOLES_V] WHERE SHIFTFLAG = 'PREV'  
CREATE VIEW [CER].[CONOPS_CER_DAILY_EOS_DRILLED_HOLES_V]  
AS  
...
(  
 ...
 FROM [CER].[CONOPS_CER_DAILY_DB_DRILL_PLAN_V] (NOLOCK)  
