CREATE VIEW [CER].[CONOPS_CER_DAILY_TRUCK_DETAIL_V] AS
  
  
  
  
  
-- SELECT * FROM [cer].[CONOPS_CER_DAILY_TRUCK_DETAIL_V] WITH (NOLOCK) WHERE [shiftflag] = 'CURR' ORDER BY TruckID  
CREATE VIEW [cer].[CONOPS_CER_DAILY_TRUCK_DETAIL_V]  
AS  
