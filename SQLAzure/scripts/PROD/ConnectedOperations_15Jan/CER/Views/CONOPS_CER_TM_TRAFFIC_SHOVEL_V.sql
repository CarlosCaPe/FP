CREATE VIEW [CER].[CONOPS_CER_TM_TRAFFIC_SHOVEL_V] AS
  
    
--SELECT * FROM [cer].[CONOPS_CER_TM_TRAFFIC_SHOVEL_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'        
CREATE VIEW [cer].[CONOPS_CER_TM_TRAFFIC_SHOVEL_V]        
AS        
