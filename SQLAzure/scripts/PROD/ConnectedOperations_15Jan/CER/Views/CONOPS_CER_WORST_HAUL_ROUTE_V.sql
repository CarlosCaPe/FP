CREATE VIEW [CER].[CONOPS_CER_WORST_HAUL_ROUTE_V] AS



-- SELECT * FROM [cer].[CONOPS_CER_WORST_HAUL_ROUTE_V] WITH (NOLOCK)
CREATE VIEW [cer].[CONOPS_CER_WORST_HAUL_ROUTE_V]
AS
