CREATE VIEW [CER].[CONOPS_CER_EFH_V] AS

--SELECT * FROM [CER].[CONOPS_CER_EFH_V] where shiftflag = 'curr'
CREATE VIEW [cer].[CONOPS_CER_EFH_V]
AS
...
RIGHT JOIN [CER].[CONOPS_CER_SHIFT_INFO_V] b
