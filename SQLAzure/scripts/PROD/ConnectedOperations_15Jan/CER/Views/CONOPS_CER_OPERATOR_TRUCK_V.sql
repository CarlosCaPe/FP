CREATE VIEW [CER].[CONOPS_CER_OPERATOR_TRUCK_V] AS
...
CREATE VIEW [cer].[CONOPS_CER_OPERATOR_TRUCK_V] 
AS
...
LEFT JOIN [CER].[CONOPS_CER_OPERATOR_EQMT_READY_HOURS_V] [rh]
