CREATE VIEW [SAF].[CONOPS_SAF_OPERATOR_DRILL_LOGIN_V] AS





-- SELECT * FROM [SAF].[CONOPS_SAF_OPERATOR_DRILL_LOGIN_V] WITH (NOLOCK) WHERE Shiftflag = 'PREV'
CREATE VIEW [saf].[CONOPS_SAF_OPERATOR_DRILL_LOGIN_V] 
AS
