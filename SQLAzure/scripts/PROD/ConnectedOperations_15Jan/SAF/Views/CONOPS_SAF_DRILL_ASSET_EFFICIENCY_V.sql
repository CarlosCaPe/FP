CREATE VIEW [SAF].[CONOPS_SAF_DRILL_ASSET_EFFICIENCY_V] AS
...
--select * from [saf].[CONOPS_SAF_DRILL_ASSET_EFFICIENCY_V]
CREATE VIEW [saf].[CONOPS_SAF_DRILL_ASSET_EFFICIENCY_V] 
AS
