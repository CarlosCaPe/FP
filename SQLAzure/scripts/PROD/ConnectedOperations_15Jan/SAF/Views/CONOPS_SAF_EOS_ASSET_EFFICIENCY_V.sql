CREATE VIEW [SAF].[CONOPS_SAF_EOS_ASSET_EFFICIENCY_V] AS
...
--SELECT * FROM [SAF].[CONOPS_SAF_EOS_ASSET_EFFICIENCY_V] WHERE SHIFTFLAG = 'PREV'
CREATE VIEW [saf].[CONOPS_SAF_EOS_ASSET_EFFICIENCY_V]
AS
...
FROM [SAF].[CONOPS_SAF_TRUCK_ASSET_EFFICIENCY_V]
),
...
FROM [SAF].[CONOPS_SAF_SHOVEL_ASSET_EFFICIENCY_V]
),
...
FROM [SAF].[CONOPS_SAF_DRILL_ASSET_EFFICIENCY_V]
)
