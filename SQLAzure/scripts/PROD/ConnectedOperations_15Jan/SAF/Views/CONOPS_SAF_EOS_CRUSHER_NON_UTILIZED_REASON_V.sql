CREATE VIEW [SAF].[CONOPS_SAF_EOS_CRUSHER_NON_UTILIZED_REASON_V] AS

--SELECT * FROM [SAF].[CONOPS_SAF_EOS_CRUSHER_NON_UTILIZED_REASON_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [SAF].[CONOPS_SAF_EOS_CRUSHER_NON_UTILIZED_REASON_V]  
AS  
...
INNER JOIN SAF.conops_SAF_shift_info_v si
