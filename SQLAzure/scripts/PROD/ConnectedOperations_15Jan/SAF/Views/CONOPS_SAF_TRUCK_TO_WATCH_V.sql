CREATE VIEW [SAF].[CONOPS_SAF_TRUCK_TO_WATCH_V] AS




-- SELECT * FROM [saf].[CONOPS_SAF_TRUCK_TO_WATCH_V] WITH (NOLOCK) WHERE [TruckID] = 'T501'
CREATE VIEW [saf].[CONOPS_SAF_TRUCK_TO_WATCH_V]
AS
...
SELECT [t].shiftflag,
	   ...
	   [tm].TotalMineralsMined AS TotalMaterialMoved,
...
LEFT JOIN [saf].[CONOPS_SAF_TRUCK_SHIFT_OVERVIEW_V] [tm]
