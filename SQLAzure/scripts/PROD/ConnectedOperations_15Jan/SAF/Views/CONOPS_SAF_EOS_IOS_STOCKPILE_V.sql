CREATE VIEW [SAF].[CONOPS_SAF_EOS_IOS_STOCKPILE_V] AS
  
  
  
  
--SELECT * FROM [saf].[CONOPS_SAF_EOS_IOS_STOCKPILE_V] WITH (NOLOCK) WHERE SHIFTFLAG = 'CURR'    
CREATE VIEW [saf].[CONOPS_SAF_EOS_IOS_STOCKPILE_V]    
AS    
