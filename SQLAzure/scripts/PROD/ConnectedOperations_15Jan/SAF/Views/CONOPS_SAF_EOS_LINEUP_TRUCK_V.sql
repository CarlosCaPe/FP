CREATE VIEW [SAF].[CONOPS_SAF_EOS_LINEUP_TRUCK_V] AS
...
-- SELECT * FROM [saf].[CONOPS_SAF_EOS_LINEUP_TRUCK_V]  WITH (NOLOCK) WHERE [shiftflag] = 'CURR'
CREATE VIEW [saf].[CONOPS_SAF_EOS_LINEUP_TRUCK_V] 
AS
