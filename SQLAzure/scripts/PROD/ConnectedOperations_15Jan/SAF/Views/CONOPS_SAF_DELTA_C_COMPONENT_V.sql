CREATE VIEW [SAF].[CONOPS_SAF_DELTA_C_COMPONENT_V] AS





--SELECT * FROM SAF.CONOPS_SAF_DELTA_C_COMPONENT_V WHERE SHIFTFLAG = 'CURR' ORDER BY MinsOverExpected DESC
CREATE VIEW SAF.CONOPS_SAF_DELTA_C_COMPONENT_V
AS
...
LEFT JOIN SAF.CONOPS_SAF_SHIFT_INFO_V si
