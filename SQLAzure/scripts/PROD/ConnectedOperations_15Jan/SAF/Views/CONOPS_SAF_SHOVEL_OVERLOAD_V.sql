CREATE VIEW [SAF].[CONOPS_SAF_SHOVEL_OVERLOAD_V] AS
...
--SELECT * FROM [SAF].[CONOPS_SAF_SHOVEL_OVERLOAD_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [SAF].[CONOPS_SAF_SHOVEL_OVERLOAD_V]  
AS  
...
LEFT JOIN [SAF].[CONOPS_SAF_TRUCK_DETAIL_V] td WITH (NOLOCK)
