CREATE VIEW [CLI].[CONOPS_CLI_CRUSHER_STATUS_DETAIL_V] AS




--SELECT * FROM [CLI].[CONOPS_CLI_CRUSHER_STATUS_DETAIL_V]
CREATE VIEW [CLI].[CONOPS_CLI_CRUSHER_STATUS_DETAIL_V]
AS
...
SELECT
	...
	CASE PLANT_AREA_NAME
		WHEN 'Primary Crushing' THEN 'CRUSHER 1'
