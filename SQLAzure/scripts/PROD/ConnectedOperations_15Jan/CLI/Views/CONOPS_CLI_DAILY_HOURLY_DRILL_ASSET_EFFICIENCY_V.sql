CREATE VIEW [CLI].[CONOPS_CLI_DAILY_HOURLY_DRILL_ASSET_EFFICIENCY_V] AS
...
--select * from [cli].[CONOPS_CLI_DAILY_HOURLY_DRILL_ASSET_EFFICIENCY_V] WITH (NOLOCK)  
CREATE VIEW [cli].[CONOPS_CLI_DAILY_HOURLY_DRILL_ASSET_EFFICIENCY_V]  
AS  
