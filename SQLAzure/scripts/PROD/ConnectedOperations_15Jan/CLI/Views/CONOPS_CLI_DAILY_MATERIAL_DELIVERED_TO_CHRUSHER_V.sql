CREATE VIEW [CLI].[CONOPS_CLI_DAILY_MATERIAL_DELIVERED_TO_CHRUSHER_V] AS
...
--select * from [cli].[CONOPS_CLI_DAILY_MATERIAL_DELIVERED_TO_CHRUSHER_V] WITH (NOLOCK)  
CREATE VIEW [cli].[CONOPS_CLI_DAILY_MATERIAL_DELIVERED_TO_CHRUSHER_V]   
AS  
...
CrLocShift AS (  
    ...
    FROM [cli].[CONOPS_CLI_EOS_SHIFT_INFO_V] a WITH (NOLOCK)  
)  
