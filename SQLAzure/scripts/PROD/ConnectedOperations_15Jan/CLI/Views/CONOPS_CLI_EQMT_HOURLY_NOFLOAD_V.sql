CREATE VIEW [CLI].[CONOPS_CLI_EQMT_HOURLY_NOFLOAD_V] AS

--SELECT * FROM [cli].[CONOPS_CLI_EQMT_HOURLY_NOFLOAD_V] WHERE shiftflag = 'prev'
CREATE VIEW [cli].[CONOPS_CLI_EQMT_HOURLY_NOFLOAD_V]
AS
