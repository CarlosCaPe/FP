CREATE VIEW [CLI].[CONOPS_CLI_EOS_IOS_STOCKPILE_HOURLY_V] AS





--SELECT * FROM [CLI].[CONOPS_CLI_EOS_IOS_STOCKPILE_HOURLY_V] WHERE shiftflag = 'PREV'
CREATE VIEW [CLI].[CONOPS_CLI_EOS_IOS_STOCKPILE_HOURLY_V]
AS
...
LEFT JOIN [CLI].[CONOPS_CLI_SHIFT_INFO_V] s WITH (NOLOCK)  
