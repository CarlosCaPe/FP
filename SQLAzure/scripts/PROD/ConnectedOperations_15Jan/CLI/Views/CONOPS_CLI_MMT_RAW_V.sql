CREATE VIEW [CLI].[CONOPS_CLI_MMT_RAW_V] AS
...
--SELECT * FROM [cli].[CONOPS_CLI_MMT_RAW_V] WHERE SHIFTFLAG = 'CURR'  
CREATE VIEW [cli].[CONOPS_CLI_MMT_RAW_V]  
AS  
