CREATE VIEW [CLI].[CONOPS_CLI_DAILY_SHOVEL_INFO_V] AS
  
  
  
  
-- SELECT * FROM [cli].[CONOPS_CLI_DAILY_SHOVEL_INFO_V] WITH (NOLOCK)  
CREATE VIEW [cli].[CONOPS_CLI_DAILY_SHOVEL_INFO_V]   
AS  
