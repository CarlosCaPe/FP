CREATE VIEW [CLI].[CONOPS_CLI_EQMT_TIME_CATEGORY_V] AS


--select * from [CLI].[CONOPS_CLI_EQMT_TIME_CATEGORY_V] WITH(NOLOCK)
CREATE VIEW [CLI].[CONOPS_CLI_EQMT_TIME_CATEGORY_V] 
AS
